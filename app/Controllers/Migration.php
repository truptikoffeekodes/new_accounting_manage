...
class Migration extends BaseController
{
     ...
     */
    public $database_name = "KLA2022ZFDH";
        ...
        if ($type != '') {
            ...
            if ($type == 'sales_item') {
                ...
                $sql = array(
                    ...
                    "ALTER TABLE `sales_item` ADD `is_update_hsn` INT(1) NOT NULL DEFAULT '0' AFTER `is_update_taxiblity`"
                );
            }
            ...
            if ($type == 'sales_acparticu') {
                ...
                $sql = array(
                    "ALTER TABLE `sales_ACparticu` ADD `discount` DECIMAL(19,2) NOT NULL AFTER `is_delete`, ADD `added_amt` DECIMAL(19,2) NOT NULL AFTER `discount`, ADD `sub_total` DECIMAL(19,2) NOT NULL AFTER `added_amt`",
                    "ALTER TABLE `sales_ACparticu` ADD `is_update_subtotal` INT(1) NOT NULL DEFAULT '0' AFTER `sub_total`"
                );
            }
            ...
            if ($type == 'purchase_particu') {
                ...
                $sql = array(
                    ...
                    "ALTER TABLE `purchase_particu` ADD `is_update_subtotal` INT(1) NOT NULL DEFAULT '0' AFTER `is_delete`"
                );
            }
    ...
    public function test()
    {
        ...
        $sql = array(
            "INSERT INTO `cron` (`id`, `data`, `created_at`) VALUES (NULL, '$data', '$created_at')"
        );
