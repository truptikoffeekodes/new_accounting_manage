                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label class="form-label">Pan No.: <span class="tx-danger">*</span></label>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="form-label">Notes.: <span class="tx-danger">*</span></label>
                                    </div>
                                    <div class="col-md-12 form-group">
                                        <label class="form-label">Tin No.: <span class="tx-danger">*</span></label>
                                    </div>
                                    <div class="col-md-12 form-group">
                                        <label class="form-label">GST Tin No.: <span class="tx-danger">*</span></label>
                                    </div>

                                    <div class="col-lg-12 form-group">
                                        <label class="form-label">Receive From Code: <span
                                                class="tx-danger">*</span></label>
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="receive_from_code" id=""
                                                onchange="validate_autocomplete(this,'')" value="" required>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    <a data-toggle="modal" href="<?= url('master/') ?>"
                            ...
                            <div class="col-lg-7 form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-10 form-group">
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="class" id=""
                                                onchange="validate_autocomplete(this,'')" value="" required>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    <a data-toggle="modal" href="<?= url('master/') ?>"
                                    ...
                                    <div class="col-md-2 form-group">
                                        <label class="form-label">Issue For: <span class="tx-danger">*</span></label>
                                    </div>
                                    <div class="col-md-10 form-group">
                                        <select class="form-control select2" name="issue_for" required>
                                            ...
                                            <option value="Exclude Multiple">Exclude Multiple</option>
