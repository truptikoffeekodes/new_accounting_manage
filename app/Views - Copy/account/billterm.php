...
<?= $this->section('content') ?>
 ...
 <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5"> Bill Terms </h2>
            <ol class="breadcrumb">
        ...
        <div class="btn btn-list">
            <a href="<?=url('account/add_billterm')?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>
        </div>
</div>
<div class="row">
        <div class="col-lg-12">
                ...
                <div class="card-header card-header-divider">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="billterm" data-module="account" data-filter_data=''>
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Code</th>
