...
<div class="page-header">
    <div>
        <h2 class="main-content-title ">Reporting</h2>
        <ol class="breadcrumb">
    ...
    <div class="btn btn-list">
        <a data-toggle="modal" href="<?=url('Trading/add_closing')?>" data-target="#fm_model" data-title="Add Closing"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="closing" data-module="Trading" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Closing Bal</th>
