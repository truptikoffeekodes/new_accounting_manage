...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a data-toggle="modal" data-target="#fm_model" data-title="Add Screen Series" data-pk="32"
            href="<?=url('master/add_screenseries')?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Add New</a>
    </div>
</div>
<!-- End Page Header -->
<div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="screenseries" data-module="master" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
