...
<?= $this->section('content') ?>
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title ">TDS Rate</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">TDS Rate</li>
            </ol>
        </div>
        <div class="btn btn-list">
            <<a data-toggle="modal" href="<?=url('Master/add_tds')?>" data-target="#fm_model" data-title="Add New TDS Rate" class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>            
        </div>
    </div>
    <!-- End Page Header -->
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="tds" data-module="Master" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Section</th>
