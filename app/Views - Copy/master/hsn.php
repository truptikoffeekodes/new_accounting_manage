...
<?= $this->section('content') ?>
 ...
 <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5"> HSN </h2>
            <ol class="breadcrumb">
        ...
        <a data-toggle="modal" href="<?= url('Master/add_hsn') ?>" data-target="#fm_model" data-title="Add New HSN " class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>
        </div>
    </div>
    <!-- End Page Header -->
    <div class="row">
                ...
                <div class="card-header card-header-divider">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="hsn" data-module="master" data-filter_data=''>
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>HSN Code</th>
                                        <th>Description</th>
                                        <th>Rate (%)</th>
                                        <th>Related Export / Import HSN Code</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
