...
<div class="page-header">
    <div>
        <h2 class="main-content-title ">Vechicle</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Vechicle</a></li>
            <li class="breadcrumb-item active" aria-current="page">Add Vechicle</li>
        </ol>
    </div>
    <div class="btn btn-list">
        <a data-toggle="modal" href="<?=url('Master/add_vehicle')?>" data-target="#fm_model" data-title="Add vehicle "
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="vehicle" data-module="Master" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Code</th>
