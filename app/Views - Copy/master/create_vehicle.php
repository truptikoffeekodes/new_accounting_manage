    ...
    <div class="col-lg-12">
        <form action="<?= url('Master/add_vehicle') ?>" class="ajax-form-submit" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input class="form-control" name="name" value="<?=@$vehicle['name']?>" onkeypress="function code_generate(this.value)" placeholder="Enter Code" required="" type="text">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="note" value="<?=@$vehicle['note']?>" placeholder="Enter Notes" required="" type="text">
            </div>
            <div class="row pt-3">
                <div class="col-sm-6">
                    <p class="text-left">
