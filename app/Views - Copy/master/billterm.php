...
<?= $this->section('content') ?>
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title ">Bill Term</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Bill Term</li>
            </ol>
        </div>
        <div class="btn btn-list">
            <<a data-toggle="modal" href="<?=url('Master/add_billterm')?>" data-target="#fm_model" data-title="Add New Bill Term" class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>            
        </div>
    </div>
    <!-- End Page Header -->
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="billterm" data-module="Master" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
