...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a href="<?= url('purchase/add_general_pur') ?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i>
            Add New</a>
    </div>
</div>
<!-- End Page Header -->
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="general_purchase" data-module="purchase" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Voucher Type</th>
