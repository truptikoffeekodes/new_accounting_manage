...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Mill Issue Sr No :</span> <?= @$challan['sr_no'] ? $challan['sr_no'] : $current_id; ?></h2>    
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
                    ...
                    <form action="<?= url('Milling/add_millSend') ?>" class="ajax-form-submit" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="row col-md-6 form-group">
                                <label class="form-label col-md-3">Supplier  No: <span class="tx-danger">*</span></label>
                            ...
                            <div class="row col-md-6 form-group">
                                <label class="form-label col-md-4">Challan Date: <span class="tx-danger">*</span></label>
                                <div class="col-md-8 form-group">
                                        <input class="form-control dateMask" placeholder="MM/DD/YYYY" type="text"
                                            name="challan_date" value="<?=@$challan['challan_date'] ? user_date($challan['challan_date']) : user_date(date('y-m-d'))?>">
                                    </div>
                            </div>
                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label class="form-label">Mill AC: <span
                            ...
                            <div class="col-lg-7 form-group">
                                <div class="row">
                                    ...
                                    ?>
                                    <div class="col-md-4 form-group">
                                        <input class="form-control dateMask lr_date" placeholder="DD/MM/YYYY" type="text"
                                            ...
                                            foreach($item as $row){
                                                ...
                                                <tr class="<?=$row['pid']?>">
                                                    ...
                                                    <?php if(isset($row['from_challan'])){ ?>
                                                     <input type="hidden" name="all_greyTakaTb_ids[]" value="<?=$row['all_greyTakaTb_ids']?>">
                                                    <?php } ?>
                                                    <td><?=$row['name']?>
                                                    </td>
                                                    <td><?=$row['hsn']?>
                                                    ...
                                                    <td><input class="form-control input-sm" value="<?=isset($row['from_challan']) ? '' :$row['price']?>"
                                                    ...
                                                    <td><input class="form-control input-sm" value="<?=isset($row['from_challan']) ? '' : $row['pcs']?>"
                                                            name="taka[]" readonly onchange="calculate()"
                                                            onkeypress="return isDesimalNumberKey(event)" required=""
                                                            type="text"><a data-toggle="modal" type="button" id="add_taka" href="<?=$url?>" data-target="#fm_model" data-title="View Taka" ><i class="far fa-edit"></i></a>
                                                    </td>
                                                    
                                                    <td>
                                                        <input class="form-control input-sm" type="text" name="meter[]" value="<?=isset($row['from_challan']) ? '' : @$row['meter']?>"
    ...
    $('#get_challan').on('select2:select', function(e) {
        ...
        for (i = 0; i < item.length; i++) {
            ...
            if(item[i].pcs != 0 && mtr != 0){
                ...
                tds += '<td><input id="rate" class="form-control input-sm" value="" name="price[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" value="0" required="" type="text"></td>';

                tds +=
                    '<td><input class="form-control input-sm" id="taka" name="taka[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" required type="text"><a data-toggle="modal" type="button" id="add_taka" href="<?=url("Milling/Add_millingtaka/")?>'+ item[i].pid +'/' + suggesion.id  + '" data-target="#fm_model" data-title="Edit Taka" class=""><i class="far fa-edit"></i></a><p style="text-align:center;color:red;margin:0;padding:0;">' + item[i].pcs + '</p></td>';
                
                tds +=
                    '<td><input class="form-control input-sm" type="text" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" id="meter" name="meter[]" required ><p style="text-align:center;color:red;">' + mtr + '</p></td>';
