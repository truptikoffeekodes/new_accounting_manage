        ...
        <form class="ajax-form-price" method="post">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control" onchange="calc_pending()" placeholder="Enter Value"
                ...
                <div class="col-lg-4 form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control" onchange="calc_pending()" readonly placeholder="Enter Value" id="rec_job"
                ...
                <div class="col-lg-4 form-group">
                    <label class="form-label">Send For Jobwork: <span class="tx-danger">*</span></label>
                    <div class="input-group">
                        <input class="form-control" placeholder="Enter Value" onkeyup="calc_pending()" name="send_job[]"
                ...
                <div class="col-lg-4 form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control" readonly onchange="calc_pending()" placeholder="Enter Value"
                            name="rec_job[]" type="text" required value="<?=$rec_mtr[$i];?>">
                    </div>
                </div>
...
$("#addinput").click(function() {
    ...
    var input =
        "<div class='col-lg-4 form-group'><label class='form-label'>Send For Jobwork: <span class='tx-danger'>*</span></label><div class='input-group'><input class='form-control' placeholder='Enter Value' onchange='calc_pending()' name='send_job[]' type='text' value=''></div></div>";
    
    input +=
        "<div class='col-lg-4 form-group'><label class='form-label'>Received From Jobwork:</label><div class='input-group'><input class='form-control' onchange='calc_pending()' placeholder='Enter Value' name='rec_job[]' readonly type='text' value=''></div></div>";

    input +=
        "<div class='col-lg-4 form-group'><label class='form-label'>Pending Jobwork:<span class='tx-danger'>*</span></label><div class='input-group'><input class='form-control' placeholder='Enter Value' name='pending_job[]' readonly type='text'></div></div>";
