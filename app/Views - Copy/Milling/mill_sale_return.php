...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a href="<?= url('Milling/add_Mill_SaleReturn') ?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Add New</a>
    </div>
</div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="mill_SaleReturn" data-module="Milling" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>SR No</th>
