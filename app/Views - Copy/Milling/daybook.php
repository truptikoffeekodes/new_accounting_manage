...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <<a data-toggle="modal" href="<?=url('Milling/CreatDayBook')?>" data-target="#fm_model" data-title="Add New Daybook"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="DaybookList" data-module="Milling" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
