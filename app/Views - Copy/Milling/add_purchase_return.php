                    ...
                    <form action="<?= url('Milling/Add_retGrayFinish') ?>" class="ajax-form-submit" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="row col-md-6 form-group">
                                <label class="form-label col-md-3">Buyer Invoice No: <span
                                        class="tx-danger">*</span></label>
                                <select class="form-control col-md-9" id="get_invoice" name='weaver_invoice'>
                            ...
                            <div class="row col-md-6 form-group">
                                <label class="form-label col-md-3">Purchase Type: <span
                                        class="tx-danger">*</span></label>
                                <input class="form-control col-md-9 purchase_type" type="text" name="purchase_type"
                            ...
                            <div class="row col-md-6 form-group">
                                <label class="form-label col-md-3">Buyer Challan No :<span
                                        class="tx-danger">*</span></label>
                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label class="form-label">Buyer Party Name: <span
                                                class="tx-danger">*</span></label>
                                    </div>
                                    <div class="col-md-8 form-group">
...
$(document).ready(function() {
    ...
    $('#get_invoice').on('select2:select', function(e) {
        ...
        $('.weaver_challan').val(suggesion.challan.challan_no);
