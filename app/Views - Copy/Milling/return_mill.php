...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a href="<?= url('Milling/Add_returnMill') ?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i>
            Add New</a>
    </div>
</div>
<!-- End Page Header -->
            ...
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget mill_ret" id="table_list_data"
                            data-id="return_mill" data-module="Milling" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>SR No</th>
                                    <th>Issue Mill SR NO.</th>
                                    <th>Buyer Challan No.</th>
