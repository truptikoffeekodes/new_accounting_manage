                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="mill_stock" data-module="Milling" data-filter_data=''>
...
function datatable_load(filter_val) {
    ...
    $("#table_list_data").DataTable({
        ...
        "footerCallback": function(row, data, start, end, display) {
            ...
            var purchase_qty = api
                    .column(2)
                    .data()
                    .reduce(function(a, b) {
                        return intVal(a) + intVal(b);
                    }, 0);
                var purchase_total = api
                    .column(3)
                    .data()
                    .reduce(function(a, b) {
                        return intVal(a) + intVal(b);
            ...
            $('#pur_qty').html(purchase_qty.toFixed(2));
            $('#pur_total').html(purchase_total.toFixed(2));
            $('#sale_qty').html(sale_qty.toFixed(2));
            $('#sale_total').html(sale_total.toFixed(2));
            $('#diff_qty_total').html(dif_qty_total.toFixed(2));
            $('#diff_total').html(dif_total.toFixed(2));
            $('#finish_cut').html(finish_cut.toFixed(2));
            $('#finish_mtr').html(finish_mtr.toFixed(2));
        }
    });
