...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Jobwork Issue Sr No :</span><?= @$job['id'] ? @$job['id'] : @   $current_id; ?></h2>    
    </div>
                ...
                <div class="card-body">
                    <form action="<?= url('Milling/Add_jobwork') ?>" class="ajax-form-submit" method="POST"
                        ...
                        <div class="row">
                            ...
                            <input class="form-control col-md-9" type="hidden" name="srno" readonly
                                    value="<?= @$job['id'] ? @$job['id'] : @   $current_id; ?>"
                                    required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <textarea class="form-control " name="delivery_code" value=""
                                            placeholder="Enter Delivery Address" type="text"><?=@$job['delivery_code']?></textarea>
                                    </div>
                            ...
                            <div class="col-lg-7 form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <input class="form-control freight" name="freight" value="<?= @$job['freight']; ?>"
                                ...
                                <table class="table table-bordered mg-b-0 product" id="product">
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        <tr class="<?=$row['pid']?>">
                                            ...
                                            <input type="hidden" name="sendJob_ids[]" value="<?=$row['sedJob_TakaId']?>">
                                            <td><?=$row['name']?> </td>
                                            <td><?=$row['hsn']?> </td>
                                            <td><?=$row['stock']?> </td>
                                            ...
                                            <td><input class="form-control input-sm" value="<?=$row['unit']?>"
                                                    ...
                                                    type="text"><a data-toggle="modal" type="button" id="add_taka" href="<?=url("Milling/Add_SendJobTaka/").$row['pid'].'/'.$row['id']?> "  data-target="#fm_model" data-title="Edit Taka" class="modal-lg"><i class="far fa-edit"></i></a>
                                            </td>
...
$(document).ready(function() {
    ...
    $('#code').on('select2:select', function(e) {
        ...
        if (pids.toString().indexOf(suggestion.data) == -1) {
            ...
            tds += '<td><a class="tx-danger btnDelete" data-id="' + suggestion.id + '" title="0"><i class="fa fa-times tx-danger"></i></a></td>';
            ...
            tds +=  
                '<td><select name="type[]" id="type"  onchange="calculate()">'+ suggestion.uom  +'</select></td>';

            tds +=
                '<td><input class="form-control input-sm"  name="total_taka[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" value="0" required type="text"><a data-toggle="modal" type="button" id="add_taka" href="<?=url("Milling/Add_SendJobTaka/")?>' + suggestion.id + '"  data-target="#fm_model" data-title="Edit Taka" class="modal-lg"><i class="far fa-edit"></i></a></td>';
            ...
            tds +=
                '<td><input class="form-control input-sm"  name="cut[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" value="0" required type="text"></td>';
