...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Mill Received Sr No :</span> <?= @$challan['sr_no'] ? $challan['sr_no'] : $current_id; ?></h2>    
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <input class="form-control" name="lot_no" value="<?=@$challan['lot_no']?>" required placeholder="Lot No"
                                            type="text">
                                    </div>

                                    <div class="col-md-5 form-group">

                                        <label class="ckbox"><input type="checkbox" <?=@$challan['is_lot_complete'] == 1 ?'checked' : '' ?> name="is_LotComplete"><span>Lot
                                ...
                                <table class="table table-bordered mg-b-0 product" border="1" id="product">
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        <tr class="<?=$row['pid']?>">
                                            ...
                                            <input type="hidden" name="MillRecTB_id[]" value="<?=$row['millRecTb_ids']?>">
                                            ...
                                            <td>
                                                <div class="input-group select2_height">
                                                    <select required class="form-control select-sm screen" name="screen[]">
                                            ...
                                            <td><input class="form-control input-sm" id="rec_taka"
                                                    ...
                                                    required type="text"><a data-toggle="modal" type="button" id="add_taka" href="<?=url("Milling/Add_MillRecTaka/").$challan['challan_no'].'/'.$row['pid'].'/'.$challan['id']?>" 
                                                    data-target="#fm_model" data-title="Edit Taka" class="modal-lg"><i class="far fa-edit"></i></a>
                                            </td>
...
$(document).ready(function() {
    ...
    $('#mill_challan').on('select2:select', function(e) {
        ...
        for (i = 0; i < item.length; i++) {
            ...
            tds += '<td><select name="type[]" onchange="calculate()">' + item[i].uom_opt + '</select></td>';
            ...
            tds +=
                '<td><input class="form-control input-sm"  value="" name="rec_taka[]" onchange="calculate()"  type="text"><a data-toggle="modal" type="button" id="add_taka" href="<?=url("Milling/Add_MillRecTaka/")?>' + item[i].voucher_id + '/' + item[i].pid +
                '" data-target="#fm_model" data-title="Edit Taka" class="modal-lg"><i class="far fa-edit"></i></a></td>';

            tds +=
                '<td><input class="form-control input-sm" type="text" value="" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="rec_meter[]" ></td>';
