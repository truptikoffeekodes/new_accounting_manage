...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Gray/Finish Invoice Sr No :</span> <?= @$challan['sr_no'] ? $challan['sr_no'] : $current_id; ?></h2>    
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
                    ...
                    <form action="<?= url('Milling/add_grey') ?>" class="ajax-form-submit" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="row col-md-6 form-group">
                                <label class="form-label col-md-3">Buyer Challan No: <span class="tx-danger">*</span></label>
                            ...
                            <div class="row col-md-6 form-group">
                                <label class="form-label col-md-3">Buyer Invoice No :<span class="tx-danger">*</span></label>
                                <input class="form-control col-md-9" placeholder="Enter Invoice No"  required onkeypress="return isNumberKey(event)" type="text" value="<?= @$challan['inv_no'];?>" name="inv_no">
                            </div>
                            ...
                            <div class="row col-md-6 form-group">
                                <label class="form-label col-md-3">Invoice Date: <span class="tx-danger">*</span></label>
                                <input class="form-control col-md-9 dateMask" required placeholder="DD-MM-YYYY" type="text" id="inv_date"
                                    name="inv_date"
                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <select class="form-control transport_mode" id="transport_mode" name="trasport_mode">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label class="form-label">Buyer A/C Party: <span
                                    ...
                                    <div class="col-md-8 form-group">
                                        <textarea class="form-control delivery" name="delivery_code" value=""
                                            placeholder="Delivery Address" type="text"><?= @$challan['delivery_code']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-7 form-group">
                                <div class="row">
                                    ...
                                    ?>
                                    <div class="col-md-4 form-group">
                                        <input class="form-control dateMask lr_date" placeholder="MM/DD/YYYY" type="text"
                                    ...
                                    <div class="col-md-4 form-group">
                                        <input class="form-control weight" name="weight" value="<?= @$challan['weight']; ?>"
                                    ...
                                    <div class="col-md-4 form-group">
                                        <input class="form-control freight" name="freight" value="<?= @$challan['freight']; ?>"
                                            ...
                                            foreach($items as $row){
                                                ...
                                                <tr class="<?=$row['pid']?>">
                                                    ...
                                                    <td><input class="form-control input-sm" value="<?=$row['pcs']?>"
                                                            ...
                                                            type="text"></td>
                                                    <td>
                                                        <input class="form-control input-sm" type="text" name="meter[]" value="<?=@$row['meter']?>"
...
$(document).ready(function() {
    ...
    $('#code').on('select2:select', function(e) {
        ...
        if (pids.toString().indexOf(suggestion.data) == -1) {
            ...
            tds += '<td><select name="type[]">' + suggestion.uom + '</select></td>';
            ...
            tds += '<td><input class="form-control input-sm" value="' + suggestion.price.igst +'" name="igst[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" value="0" required="" type="text"></td>';

            tds +=
                '<td><input class="form-control input-sm" id="taka" value="" name="taka[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" value="0" required="" type="text"><a data-toggle="modal" type="button" id="add_taka" href="<?= url("Milling/Add_Taka/");?>' +
                suggestion.id +
                '" data-target="#fm_model" data-title="Add Taka" class=""><i class="far fa-edit"></i></a></td>';

            tds +=
                '<td><input class="form-control input-sm" type="text" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" id="meter" name="meter[]" required readonly></td>';
    ...
    $('#get_challan').on('select2:select', function(e) {
        ...
        var warehouse = '<option selected value="' + suggesion.challan.warehouse + '">' + suggesion.challan
        ...
        var delivery_ac = '<option selected value="' + suggesion.challan.delivery_ac + '">' + suggesion.challan
        ...
        for (i = 0; i < item.length; i++) {
            ...
            tds += '<td><input class="form-control input-sm" value="' + item[i].igst +'" name="igst[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" value="0" readonly required="" type="text"></td>';

            tds +=
                '<td><input class="form-control input-sm" id="taka" value="'+item[i].pcs+'" name="taka[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" required="" readonly type="text"></td>';

            tds +=
                '<td><input class="form-control input-sm" type="text" value="' + item[i].meter + '"onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" id="meter" name="meter[]" required readonly></td>';

            tds +=
                '<td><input class="form-control input-sm" id="cut" value="' + item[i].cut + '" name="cut[]" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" value="0" type="text"></td>';
            tds +=
                '<td><input class="form-control input-sm" id="subt" name="subtotal[]" onchange="calculate()" value="0" required="" type="text" readonly></td>';

            tds +=
                '<td><input class="form-control input-sm"  name="remark[]"  value="' + item[i].extra + '"  type="text" ></td>';
            tds += '</tr>';
