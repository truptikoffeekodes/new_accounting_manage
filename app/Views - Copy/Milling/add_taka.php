...
<div class="row">
    <div class="col-lg-12">
        <form class="ajax-form-taka" method="post" action="<?=url('Milling/insert_taka')?>">
                    ...
                    {   $j = 1;
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="taka_qty[]" onkeypress="return isNumberKey(event)"
                                    ...
                                    value="<?=$grey_taka[$i]['quantity']?>" class="form-control"></td>
...
function afterload() {
    ...
    // var challan_cut = $('input[name="taka_qty[]"]').map(function() {
    //     if(this.value == ''){
    //         return 0;
    //     }
    //     return parseFloat(this.value);
    // }).get();
    // console.log('challan_cut out ' + challan_cut );
