...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Gray/Finish Challan Sr No :</span> <?= @$challan['sr_no'] ? $challan['sr_no'] : $current_id; ?></h2>    
    </div>
    ...
    <div class="col-lg-12">
        <div class="card custom-card">
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <form action="<?= url('Milling/Add_grey_challan') ?>" class="ajax-form-submit" method="POST"
                        id="challanform">
                        <div class="row">
                            ...
                            <div class="row col-md-6 form-group">
                                ...
                                <input class="form-control col-md-9" type="text" name="challan_id"
                            ...
                            <div class="row col-md-6 form-group">
                                <label class="form-label col-md-3">Challan Date: <span
                                        class="tx-danger">*</span></label>
                                <input class="form-control col-md-9 dateMask" placeholder="DD/MM/YYYY" type="text"
                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    ...
                                    <div class="row col-md-8">
                                        ...
                                        <div class="col-lg-6">
                                            <label class="rdiobox"><input name="purchase_type" value="Gray" type="radio"
                                                    <?=@$challan['purchase_type'] == 'Gray' ? 'Checked' : 'checked'?>>
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label class="form-label">Issue From: <span class="tx-danger">*</span></label>
                                    </div>
                                    <div class="col-md-8 form-group">
