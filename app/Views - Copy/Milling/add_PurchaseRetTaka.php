...
<div class="row">
    <div class="col-lg-12">
        <form class="ajax-form-taka" method="post" action="<?=url('Milling/insert_GrayFinish_Rettaka')?>">
                ...
                <table class="table table-bordered mg-b-0">
                    ...
                    if(!empty($grey_taka))
                    {
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="taka_qty[<?=$grey_taka[$i]['taka_no']?>]" readonly onkeypress="return isNumberKey(event)"
                            ...
                            <td style="text-align:center;"><input type="checkbox" class="checkItem" onclick="calc_qty(this)" value="<?=$grey_taka[$i]['taka_no']?>" name="check[]" <?=(@$grey_taka[$i]['is_return']==1)  ? 'checked' : ''?>></td>
