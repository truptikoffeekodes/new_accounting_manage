...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a data-toggle="modal" href="<?= url('sales/add_itemInvoice') ?>" data-target="#fm_model" data-title="Sales Item Invoice"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="item_invoice" data-module="sales" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Party Account</th>
