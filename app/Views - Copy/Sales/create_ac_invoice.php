            ...
            <div class="col-lg-12">
                <div class="card custom-card">
                    <div class="card-header card-header-divider">
                        <div class="card-body">
                            <form action="<?= url('Sales/add_ACinvoice') ?>" class="ajax-form-submit" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <input class="form-control" type="text" name="invoice_no"
                                            value="<?= isset($invoice['invoice_no']) ? $invoice['invoice_no'] : @$current_id; ?>">
                                    </div>
                                    <?php   
                                        $dt = date_create(date('d-m-Y'));
                                        $today = date_format($dt,'d-m-Y');
                                        if(!empty($invoice) && isset($invoice)){
                                            if(@$invoice['invoice_date'] != '0000-00-00'){
                                                $dt = date_create($invoice['invoice_date']);
                                    ...
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <input class="form-control dateMask" name="invoice_date"
                                            value="<?=@$invoice['invocie_date'] ? $date : $today; ?>"
                                    ...
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <input type="hidden" name="tds_per" id="tds_per"
                                            value="<?= @$invoice['tds_per']; ?>">
                                        <input type="hidden" name="tds_limit" id="tds_limit"
                                            value="<?= @$invoice['tds_limit']; ?>">
                                        <input type="hidden" name="acc_state" id="acc_state"
                                            value="<?= @$invoice['acc_state']; ?>">
                                    </div>
                                    <div class="col-md-2 form-group">
                                        <label class="form-label">Voucher Type: <span class="tx-danger">*</span></label>

                                        <label class="rdiobox"><input name="v_type"
                                                <?=@$invoice['v_type'] == "general" ? 'checked' : ''  ?> value="general"
                                                type="radio" onchange="calculate()">
                                            <span>General</span></label>

                                        <label class="rdiobox"><input name="v_type"
                                                <?=@$invoice['v_type'] == "return" ? 'checked' : ''  ?> value="return"
                                                type="radio" onchange="calculate()"> <span>Return</span></label>
                                    </div>
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Enter Supplier Invoice No."
                                            name="supp_inv" id="supp_inv" value="<?= @$invoice['supp_inv']; ?>">
                                    </div>
                                    <div class="col-lg-3 form-group">
                                    ...
                                    <!-- <div class="col-lg-6 form-group">
                                        ...
                                        <select class="form-control" id="particular" name='particular'>
                                            <?php if(@$invoice['particular_name']) { ?>
                                            <option value="<?=@$invoice['particular']?>">
                                                <?=@$invoice['particular_name']?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                    </div> -->
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <div class="input-group-prepend">
                                                                    <select class="select2" name="disc_type"
                                                                        onchange="calculate()">
                                                                        <option
                                                                            <?= @$invoice['disc_type'] == 'Fixed' ? 'Selected' : '' ?>
                                                                            value="Fixed">Fixed Amount</option>
                                                                        <option
                                                                            <?= @$invoice['disc_type'] == '%' ? 'Selected' : '' ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group">
                                                                    <input class="form-control" onchange="calculate()"
                                                                        onkeypress="return isDesimalNumberKey(event)"
                                                                        name="amtx" value="<?= @$invoice['amtx']?>"
                                                                        type="text">
                                                                    <div class="input-group-prepend">
                                                                        <select class="select2" name="amtx_type"
                                                                            onchange="calculate()">
                                                                            <option
                                                                                <?= @$invoice['amtx_type'] == 'Fixed' ? 'Selected' : '' ?>
                                                                                value="Fixed">Fixed Amount</option>
                                                                            <option
                                                                                <?= @$invoice['amtx_type'] == '%' ? 'Selected' : '' ?>
                                                                                value="%">Per(%) Amount</option>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group">
                                                                    <input class="form-control" onchange="calculate()"
                                                                        onkeypress="return isDesimalNumberKey(event)"
                                                                        name="amty" value="<?= @$invoice['amty']?>"
                                                                        type="text">
                                                                    <div class="input-group-prepend">
                                                                        <select class="select2" name="amty_type"
                                                                            onchange="calculate()">
                                                                            <option
                                                                                <?= @$invoice['amty_type'] == 'Fixed' ? 'Selected' : '' ?>
                                                                                value="Fixed">Fixed Amount</option>
                                                                            <option
                                                                                <?= @$invoice['amty_type'] == '%'  ? 'Selected' : '' ?>
                                                                                value="%">Per(%) Amount</option>
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="input-group-prepend">
                                                                        <select class="select2" name="cess_type"
                                                                            onchange="calculate()">
                                                                            <option
                                                                                <?= ( @$invoice['cess_type'] == 'Fixed' ? 'selected' : '' ) ?>
                                                                                value="Fixed">Fixed Amount</option>
                                                                            <option
                                                                                <?= ( @$invoice['cess_type'] == '%' ? 'selected' : '' ) ?>
                                                                                value="%">Per(%) Amount</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
