...
<?= $this->section('content') ?>
 ...
 <!-- Page Header -->
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5"> Creadit Note </h2>
            <ol class="breadcrumb">
        ...
        <div class="btn btn-list">
            <a href="<?=url('Sales/add_cnote')?>"   class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Add New</a>
        </div>
    </div>
<!-- End Page Header -->
<div class="row">
                ...
                <div class="card-header card-header-divider">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="c_note" data-module="Sales" data-filter_data=''>
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Document</th>
