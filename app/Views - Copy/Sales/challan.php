                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <input class="form-control"  type="text" name="challan_no"
                                    value="<?= isset($challan['challan_no']) ? @$challan['challan_no'] : $current_id; ?>">
                            </div>
                            ...
                            if(!empty($challan) && isset($challan)){
                                if(@$challan['challan_date'] != '0000-00-00'){
                                    $dt = date_create($challan['challan_date']);
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <input class="form-control dateMask" placeholder="MM/DD/YYYY" type="text"
                                    ...
                                    value="<?= @$challan['challan_date'] ? $date : $today; ?>">
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10 form-group">
                                        ...
                                        <input class="form-control" name="other"
                                            value="<?=@$challan['other']?>" placeholder ="Enter Other Detail" type="text">
                                        </div>
                                    </div>
                                    <div class="col-md-2 form-group">
