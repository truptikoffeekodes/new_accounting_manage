                    ...
                    <div class="table-responsive">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered table-fw-widget">
                                <tr>
                                    <td>
                                        <span style="size:20px;"><b>Invoice Wise Report</b></span>
                                    </td>
                                </tr>
                                <tr colspan="4">
                                </tr>
                        ...
                        <table class="table table-striped table-hover table-fw-widget Gray_InvoiceWise" id="table_list_data"
                            data-id="Gray_InvoiceWise" data-module="MillingReport" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Invoice No</th>
                                    <th>Date</th>
