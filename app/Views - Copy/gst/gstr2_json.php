...
<!--End Navbar -->
<?php  
$b2b = json_decode($json['b2b']); 
$cdn = json_decode($json['cdn']); 
// echo '<pre>';print_r($cdn);exit; 
    ?>
<div class="row">
    <div class="col-lg-12">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <br>
                                    <b id="start"><?=@$gstr2['start_date']?></b> to
                                    <b id="end"> <?=@$gstr2['end_date']?></b>
