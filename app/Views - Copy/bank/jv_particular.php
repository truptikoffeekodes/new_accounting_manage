...
<?= $this->section('content') ?>
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title ">Particular</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Jv Particular</li>
            </ol>
        </div>
        <div class="btn btn-list">
            <a href="<?=url('bank/add_jvparticular')?>"  data-title="Add JV Particular" class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>            
        </div>
    </div>
    <!-- End Page Header -->
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="jvparticular" data-module="Bank" data-filter_data=''>
                            <thead>
                                <tr>
                                <th>Id</th>
                                    <th>Date</th>
