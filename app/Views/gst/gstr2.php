                            ...
                            <tr>
                                <td>
                                   ...
                                   <div>
                                    ...
                                    <b id="start"><?=user_date($gstr2['start_date']); ?></b> to
                                    <b id="end"><?=user_date($gstr2['end_date']);?></b>
                                   </div>
                                </td>
                            </tr>
                            <tr colspan="4">
                    ...
                    <table class="table table mg-b-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?=url('gst/gstr2_b2b_detail?from='.$gstr2['start_date'].'&to='.$gstr2['end_date'])?>">B2B Invoices - 3,4A</a></td>
                            ...
                            <tr>
                                ...
                                <td><a href="<?=url('gst/gstr2_cr_dr_detail?from='.$gstr2['start_date'].'&to='.$gstr2['end_date'])?>">Credit /Debit Notes Regular - 6C</a></td>
