...
<div class="page-header">
    ...
    <div class="btn btn-list">
        ...
        <a href="<?=url('gst/b2c_large_xls_export?from='.$start_date.'&to='.$end_date.'&type='.@$type)?>"
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <?php if($type == 'sales'){ ?>
            <form method="get" action = "<?=url('Gst/b2c_large_sales_inv_vouchers')?>">
            <?php }else{ ?>
            <form method="get" action = "<?=url('Gst/b2c_large_gnrl_sales_inv_vouchers')?>">
            <?php } ?>
                        ...
                        <div class="card-header" id="headingOne" role="tab">
                            <a aria-controls="collapseOne" aria-expanded="false" data-toggle="collapse"
                                href="#collapseOne" class="collapsed">Total Voucher<label
                                    style="float:right;"><?=($type == 'sales') ? @$sales_b2c_large['count'] : @$gnrl_sale_b2c_large['count']?></label>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id=""
                        ...
                        <tbody>
                            ...
                            <?php 
                            if($type == 'sales'){
                                $result = $sales_b2c_large;
                            }else{
                                $result = $gnrl_sale_b2c_large;
                            }
