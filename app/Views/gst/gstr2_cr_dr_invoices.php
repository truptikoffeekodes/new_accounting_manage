...
<div class="page-header">
    ...
    <div class="btn btn-list">
        ...
        <a href="<?=url('gst/gstr2_dr_cr_invoices_excel_export?from='.$start_date.'&to='.$end_date.'&type='.$type)?>"
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id=""
                        ...
                        <tbody>
                            ...
                            <?php 
                            if($type == 'purchase'){
                                $result = $purchase_ret_cr_dr_reg;
                            }else{
                                $result = $gnrl_ret_cr_dr_reg;
                            }
                            ...
                            <tr>
                                ...
                                <td><a href="<?=url('purchase/add_purchasereturn/'.$row['id'])?>"><?=$row['name']?></a>
                                </td>
                                <?php }else{ ?>
                                <td><a
                                        href="<?=url('purchase/add_general_pur/return/'.$row['id'])?>"><?=$row['name']?></a>
                                </td>
                                <?php } ?>
