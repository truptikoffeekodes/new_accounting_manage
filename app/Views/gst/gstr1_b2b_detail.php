...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action = "<?=url('Gst/b2b_detail')?>">
                ...
                <div class="table-responsive">
                    <table class="table table mg-b-0">
                        ...
                        <tbody>
                            <tr>
                                <th>1</th>
                                <td><a href="<?=url('gst/b2b_sales_inv_vouchers?from='.$start_date.'&to='.$end_date)?>">Sales Invoice</a></td>
                                <td><?=@$sale['count']?></td>
                                ...
                                <td><?=number_format(@$sale['cess'],2)?></td>
                                <td><?=number_format(@$sale['igst'] + $sale['cess'] + $sale['sgst'] + $sale['cgst'],2)?>
                                </td>
                                <td><?=number_format(@$sale['net_amount'],2)?>
                                </td>
                            </tr>
                            <tr>
                                <th>2</th>
                                <td><a href="<?=url('gst/b2b_gnrl_sales_inv_vouchers?from='.$start_date.'&to='.$end_date)?>">General Sales Invoice</a></td>
                                <td><?=@$gnrl_sale['count']?></td>
                                <td><?=number_format(@$gnrl_sale['taxable_amount'],2)?></td>
                                <td><?=number_format(@$gnrl_sale['igst'],2)?></td>
                                <td><?=number_format(@$gnrl_sale['cgst'],2)?></td>
                                <td><?=number_format(@$gnrl_sale['sgst'],2)?></td>
                                <td><?=number_format(@$gnrl_sale['cess'],2)?></td>
                                <td><?=number_format(@$gnrl_sale['igst'] + $gnrl_sale['cess'] + $gnrl_sale['sgst'] + $gnrl_sale['cgst'],2)?>
                                </td>
                                <td><?=number_format(@$gnrl_sale['net_amount'],2)?>
                                </td>
                            </tr>
                        ...
                        <tfooter>
                                <th>Total</th>
                                <th></th>
                                <th><?=@$sale['count'] + @$gnrl_sale['count']?></th>
                                
                                <th><?=number_format(@$sale['taxable_amount'] + @$gnrl_sale['taxable_amount'],2)?></th>
