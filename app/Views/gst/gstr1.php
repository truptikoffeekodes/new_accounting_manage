...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a href="<?=url('gst/gstr1_export?from='.@$gstr1['start_date'].'&to='.@$gstr1['end_date'])?>"  class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Export</a>
        <a href="<?=url('gst/gstr1_xls_export?from='.@$gstr1['start_date'].'&to='.@$gstr1['end_date'])?>"  class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Excel Export</a>
                        ...
                        <div aria-labelledby="headingOne" class="collapse" id="collapseOne" role="tabpanel" style="">
                            <div class="card-body">
                                <ul class="list-group">
                                    ...
                                    <div id="headFour" role="tab">
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                           
                                            <a href="<?=url('Gst/Hsn_summary?from='.@$gstr1['start_date'].'&to='.@$gstr1['end_date'])?>">HSN Summary</a>
                                        </li>
                                    </div>
                                </ul>
                            </div>
                ...
                <div class="table-responsive">
                    <table class="table table mg-b-0">
                        ...
                        <tbody>
                            <tr>
                                <th>1</th>
                                <td><a href="<?=url('gst/b2b_detail?from='.@$gstr1['start_date'].'&to='.@$gstr1['end_date'])?>">B2B Invoices -4A,4B,4C,6B,6C</a></td>
                                <td><?=@$gstr1['b2b']['data'] ? count($gstr1['b2b']['data']) : ''?></td>
                                <td><?=number_format(@$gstr1['b2b']['taxable_amount'],2)?></td>
                                <td><?=number_format(@$gstr1['b2b']['igst'],2)?></td>
                                <td><?=number_format(@$gstr1['b2b']['cgst'],2)?></td>
                                <td><?=number_format(@$gstr1['b2b']['sgst'],2)?></td>
                                <td><?=number_format(@$gstr1['b2b']['cess'],2)?></td>
                                <td><?=number_format(@$gstr1['b2b']['igst'] + @$gstr1['b2b']['cess'] + @$gstr1['b2b']['sgst'] + @$gstr1['b2b']['cgst'],2)?>
                                </td>
                                <td><?=number_format(@$gstr1['b2b']['igst'] + @$gstr1['b2b']['taxable_amount'] + @$gstr1['b2b']['cgst'] + @$gstr1['b2b']['sgst'] + @$gstr1['b2b']['cess'])?>
                                </td>
                            </tr>
                            <tr>
                                <th>2</th>
                                <td><a href="<?=url('gst/b2c_large_detail?from='.@$gstr1['start_date'].'&to='.@$gstr1['end_date'])?>">B2C(Large) Invoices -5A,5B</a></td>
                                <td><?=@$gstr1['b2cLarge']['data'] ? count(@$gstr1['b2cLarge']['data']) : '0 '?></td>
                                <td><?=number_format(@$gstr1['b2cLarge']['taxable_amount'],2)?></td>
                                <td><?=number_format(@$gstr1['b2cLarge']['igst'],2)?></td>
                                <td><?=number_format(@$gstr1['b2cLarge']['cgst'],2)?></td>
                                <td><?=number_format(@$gstr1['b2cLarge']['sgst'],2)?></td>
                                <td><?=number_format(@$gstr1['b2cLarge']['cess'],2)?></td>
                                <td><?=number_format(@$gstr1['b2cLarge']['igst'] + @$gstr1['b2cLarge']['cess'] + @$gstr1['b2cLarge']['sgst'] + @$gstr1['b2cLarge']['cgst'],2)?>
                                </td>
                                <td><?=number_format(@$gstr1['b2cLarge']['igst'] + @$gstr1['b2cLarge']['taxable_amount'] + @$gstr1['b2cLarge']['cgst'] + @$gstr1['b2cLarge']['sgst'] + @$gstr1['b2cLarge']['cess'],2)?>
                                </td>
                            </tr>
                            <tr>
                                <th>3</th>
                                <td><a href="<?=url('gst/b2c_small_detail?from='.@$gstr1['start_date'].'&to='.@$gstr1['end_date'])?>">B2C(Small) Invoices -7</a></td>
                                <?php 
                                $sales_total_count = @$gstr1['b2cSmall']['data'] ? count(@$gstr1['b2cSmall']['data']) : 0 ;
                                $total_count = @$gstr1['cr_drUnReg']['return_count'] + @$sales_total_count;
                                ?>
                                <td><?=@$gstr1['b2cSmall']['data'] ? count(@$gstr1['b2cSmall']['data']) : 0 ?></td>
                                <td><?=number_format(@$gstr1['state_wise_b2c']['taxable'],2)?></td>
                                <td><?=number_format(@$gstr1['state_wise_b2c']['tot_igst'],2)?></td>
                                <td><?=number_format(@$gstr1['state_wise_b2c']['tot_cgst'],2)?></td>
                                <td><?=number_format(@$gstr1['state_wise_b2c']['tot_sgst'],2)?></td>
                                <td><?=number_format(@$gstr1['b2cSmall']['cess'],2)?></td>
                                <td><?=number_format(@$gstr1['state_wise_b2c']['tot_igst'] + @$gstr1['b2cSmall']['cess'] + @$gstr1['state_wise_b2c']['tot_sgst'] + @$gstr1['state_wise_b2c']['tot_cgst'],2)?></td>
                                <td><?=number_format(@$gstr1['state_wise_b2c']['net_amount'],2)?>
                                </td>
                            </tr>
                            <?php
                                ...
                                $cr_dr_unregRtax = @$gstr1['cr_drUnReg']['igst'] + @$gstr1['cr_drUnReg']['cess'] + @$gstr1['cr_drUnReg']['sgst'] + @$gstr1['cr_drUnReg']['cgst'];
                                $cr_dr_unregRInv = @$gstr1['cr_drUnReg']['igst'] + @$gstr1['cr_drUnReg']['taxable_amount'] + @$gstr1['cr_drUnReg']['cgst'] + @$gstr1['cr_drUnReg']['sgst'] + @$gstr1['cr_drUnReg']['cess'];
                            ?>
                            <tr>
                                <th>4</th>
                                <td><a href="<?=url('gst/cr_dr_reg_detail?from='.@$gstr1['start_date'].'&to='.@$gstr1['end_date'])?>">Credit/Debit Notes(Registered) -9B</a></td>
                            ...
                            <tr>
                                <th>5</th>
                                <?php 
                                $taxable_amount = @$gstr1['cr_drUnReg']['taxable_amount'] ? @$gstr1['cr_drUnReg']['taxable_amount'] : 0;
                                $taxable_return_amount = @$gstr1['cr_drUnReg']['taxable_return_amount'] ? @$gstr1['cr_drUnReg']['taxable_return_amount'] : 0;
                                ...
                                <!-- <td><?=@$taxable_amount + @$taxable_return_amount?></td> -->
                                <!-- <td><?=@$gstr1['cr_drUnReg']['igst'] ? '(-)'.@$gstr1['cr_drUnReg']['igst'] : 0?></td> -->
                                <!-- <td><?=@$gstr1['cr_drUnReg']['cgst'] ? '(-)'.@$gstr1['cr_drUnReg']['cgst'] : 0?></td> -->
                                <!-- <td><?=@$gstr1['cr_drUnReg']['sgst'] ? '(-)'.@$gstr1['cr_drUnReg']['sgst'] : 0?></td> -->
                                <!-- <td><?=@$gstr1['cr_drUnReg']['cess'] ? '(-)'.@$gstr1['cr_drUnReg']['cess'] : 0?></td> -->
                                <!-- <td><?=@$cr_dr_unregRtax ? '(-)'.$cr_dr_unregRtax : 0?></td> -->
                                <!-- <td><?=@$cr_dr_unregRInv ? '(-)'.@$cr_dr_unregRInv : 0 ?></td> -->
                            </tr>
                            ...
                            <tr>
                                <th>9</th>
                                <td><a href="<?=url('gst/nill_detail?from='.@$gstr1['start_date'].'&to='.@$gstr1['end_date'])?>">Nil Rated Invoices -8A,8B,8C,8D</a></td>
                                <td><?=@$gstr1['nill']['data'] ? count(@$gstr1['nill']['data']) : 0  ?></td>
                                <td><?=number_format(@$gstr1['nill']['taxable_amount'],2)?></td>
                                <td><?=number_format(@$gstr1['nill']['igst'],2)?></td>
                                <td><?=number_format(@$gstr1['nill']['cgst'],2)?></td>
                                <td><?=number_format(@$gstr1['nill']['sgst'],2)?></td>
                                <td><?=number_format(@$gstr1['nill']['cess'],2)?></td>
                                <td><?=number_format(@$gstr1['nill']['cess'] ,2)?>
                                </td>
                                <td><?=number_format(@$gstr1['nill']['taxable_amount'] + @$gstr1['b2b']['cess'])?>
                                </td>

                            </tr>
                            <?php
                                $calculated_taxable =  @$gstr1['b2b']['taxable_amount'] + @$gstr1['b2cLarge']['taxable_amount'] + @$gstr1['state_wise_b2c']['taxable'] + @$gstr1['nill']['taxable_amount'] - @$gstr1['cr_drReg']['taxable_amount'];
                                $calculated_igst = @$gstr1['b2b']['igst'] + @$gstr1['b2cLarge']['igst'] + @$gstr1['state_wise_b2c']['tot_igst'] + @$gstr1['nill']['igst'] - @$gstr1['cr_drReg']['igst'];
                                $calculated_sgst = @$gstr1['b2b']['cgst'] + @$gstr1['b2cLarge']['cgst'] + @$gstr1['state_wise_b2c']['tot_cgst'] + @$gstr1['nill']['cgst'] - @$gstr1['cr_drReg']['cgst'];
                                $calculated_cgst = @$gstr1['b2b']['sgst'] + @$gstr1['b2cLarge']['sgst'] + @$gstr1['state_wise_b2c']['tot_sgst'] + @$gstr1['nill']['sgst'] - @$gstr1['cr_drReg']['sgst'];

                            ?>

                            <tr>
                                <th>10</th>
                                <td>B2B + B2C + NILL - CDNR - CDNUR </td>
                                <td></td>
                                <td><b><?=number_format($calculated_taxable,2)?></b></td>
                                <td><b><?=number_format($calculated_igst,2) ?></b></td>
                                <td><b><?=number_format($calculated_cgst,2) ?></b></td>
                                <td><b><?=number_format($calculated_sgst,2) ?></b></td>
                                <td><b>0</b></td>
                                <td><b><?= number_format(($calculated_igst + $calculated_sgst + $calculated_cgst),2) ?></b></td>
                                <td><b><?=number_format(($calculated_taxable + $calculated_igst + $calculated_sgst + $calculated_cgst),2)?></b></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
