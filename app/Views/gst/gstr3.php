...
<div class="page-header">
    ...
    <div class="btn btn-list">
        ...
        <a href="<?=url('gst/gstr3_xls_export?from='.$from.'&to='.$to)?>" class="btn ripple btn-primary"><i
                class="fe fe-external-link"></i> Excel Export</a>
    </div>
</div>
<!--Start Navbar -->
                                ...
                                <ul class="list-group">
                                    ...
                                    <div aria-labelledby="headOne" class="collapse" id="collaOne" role="tabpanel"
                                        ...
                                        <ul class="list-group">
                                            <li
                                                ...
                                                <span
                                                    class="badge badge-primary badge-pill"><?=@$gstr3['sales']?></span>
                                            </li>
                                            <li
                                                class="list-group-item d-flex justify-content-between align-items-center">
                                                <a href="#" style="color:black;" onclick="goto_url('creditnote')"> Sale
                                                    Return </a>
                                                <span
                                    ...
                                    <div id="headTwo" role="tab">
                                        <a aria-controls="collaTwo" aria-expanded="false" data-toggle="collapse"
                                            ...
                                            <li
                                                ...
                                                <span
                                                    class="badge badge-primary badge-pill"><?=(@$gstr3['non_hsn']['data'] ? count($gstr3['non_hsn']['data']) : 0) + (@$gstr3['hsn']['data'] ? count($gstr3['hsn']['data']) : 0 )?></span>
                                            </li>
                                        </a>
                                    </div>
                                    ...
                                    <div aria-labelledby="headTwo" class="collapse" id="collaTwo" role="tabpanel"
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li
                                                class="list-group-item d-flex justify-content-between align-items-center">
                                                <a href="#" style="color:black;"> Incomplete Information in HSN/SAC
                                                    Summary </a><span
                    ...
                    <table class="table table mg-b-0">
                        ...
                        <tbody>
                            <tr class="main1" id="main1" onclick="return main(this)">
                                <th>3.1</th>
                                <td><a href="<?=url('Gst/Gstr3_detail/outward')?>">Outward Supplies and inward supplies
                                        liable to Reverse charge</a></td>
                                ...
                                <td><?=@$gstr3['outward']['cess'] +@$gstr3['outward']['sgst'] + @$gstr3['outward']['cgst'] + @$gstr3['outward']['igst']  ?>
                                </td>
                            </tr>
                            ...
                            <tr class="sub-main1">
                                ...
                                <td><?=@$gstr3['nill']['taxable_amount'] ?></td>
                                <td><?=@$gstr3['nill']['igst'] ?></td>
                                <td><?=@$gstr3['nill']['cgst'] ?></td>
                                <td><?=@$gstr3['nill']['sgst'] ?></td>
                                <td><?=@$gstr3['nill']['cess'] ?></td>
                                <td><?=@$gstr3['nill']['cess'] +@$gstr3['nill']['sgst'] + @$gstr3['nill']['cgst'] + @$gstr3['nill']['igst']  ?>
                                </td>
                                </td>
                            </tr>
                            <tr class="sub-main1">
                            ...
                            <tr class="main2" id="main2" onclick="return main(this)">
                                <th>3.2</th>
                                <td><a href="<?=url('Gst/Gstr3_detail/unregister')?>">Of the Supplies Shown in 3.1(a)
                                        above,detail of inter-state Supplied maid to unregister persons,composition
                                        taxable person and UIN holders</a></td>
                                <th><?=@$gstr3['gst_type_wise']['unregister']['taxable_amount'] +  @$gstr3['gst_type_wise']['composition']['taxable_amount']?>
                                </th>
                                <th><?=@$gstr3['gst_type_wise']['unregister']['igst'] +  @$gstr3['gst_type_wise']['composition']['igst']?>
                                </th>
                                <th><?=@$gstr3['gst_type_wise']['unregister']['cgst'] +  @$gstr3['gst_type_wise']['composition']['cgst']?>
                                </th>
                                <th><?=@$gstr3['gst_type_wise']['unregister']['sgst'] +  @$gstr3['gst_type_wise']['composition']['sgst']?>
                                </th>
                                <th><?=@$gstr3['gst_type_wise']['unregister']['cess'] +  @$gstr3['gst_type_wise']['composition']['cess']?>
                                </th>
                                <th><?=@$gstr3['gst_type_wise']['unregister']['cess'] + @$gstr3['gst_type_wise']['unregister']['sgst'] + @$gstr3['gst_type_wise']['unregister']['cgst'] + @$gstr3['gst_type_wise']['unregister']['igst'] +  @$gstr3['gst_type_wise']['composition']['cess'] + @$gstr3['gst_type_wise']['composition']['igst'] + @$gstr3['gst_type_wise']['composition']['cgst'] +@$gstr3['gst_type_wise']['composition']['sgst']?>
                                </th>
                            ...
                            <tr class="sub-main2">
                                ...
                                <th><?=@$gstr3['gst_type_wise']['unregister']['cess'] + @$gstr3['gst_type_wise']['unregister']['sgst'] + @$gstr3['gst_type_wise']['unregister']['cgst'] + @$gstr3['gst_type_wise']['unregister']['igst'] ?>
                                </th>
                            ...
                            <tr class="sub-main2">
                                ...
                                <th><?=@$gstr3['gst_type_wise']['composition']['cess'] + @$gstr3['gst_type_wise']['composition']['sgst'] + @$gstr3['gst_type_wise']['composition']['cgst'] + @$gstr3['gst_type_wise']['composition']['igst'] ?>
                                </th>
                                </td>
                            </tr>
                            <tr class="sub-main2">
                            ...
                            <tr class="main3" id="main3" onclick="return main(this)">
                                <th>4</th>
                                <td><a href="<?=url('Gst/Gstr3_detail/eligable_itc')?>">Eligible ITC</a></td>
                                <th></th>
                                <th><?=@$gstr3['eligable_itc']['igst'] + @$gstr3['import_good']['tot_gst']?></th>
                                <th><?=@$gstr3['eligable_itc']['cgst']?></th>
                                <th><?=@$gstr3['eligable_itc']['sgst']?></th>

                            </tr>
                            <tr class="sub-main3" id="sub31" onclick="return main(this)">
                                <th></th>
                                <td><b>(A)</b> ITC Available (Whether in full or part)</td>
                            ...
                            <tr class="sub-sub31">
                                <th></th>
                                <td><a
                                        href="<?=url('gst/import_goods_invoice_wise?from='.$gstr3['start_date'].'&to='.$gstr3['end_date'])?>">1.
                                        Import of goods</a></td>
                                <th></th>
                                <th><?=@$gstr3['import_good']['tot_gst']?></th>
                                <th></th>
                                <th< /th>
                            ...
                            <tr class="sub-sub31">
                                <th></th>
                                <td>3. Inward supplies liable to reserve charge(other than 1 & 2 above)</td>
                                <th></th>
                                <th></th>
                                <th></th>
                                <th></th>
                            ...
                            <tr class="sub-main3">
                                <th></th>
                                <td><b>(C)</b> Net ITC Available (A) - (B)</td>

                            </tr>

                            <tr class="sub-main3" id="sub34" onclick="return main(this)">
                                <th></th>
                                <td><b>(D)</b> Ineligible ITC</td>
                            ...
                            <tr class="main4" id="main4" onclick="return main(this)">
                                <th>5</th>
                                <td><a href="<?=url('Gst/Gstr3_detail/nill')?>">Value of exempt,nil rated and non-GST
                                        inward supplies</a></td>
                                <th><?=@$gstr3['nill']['exempt'] + @$gstr3['nill']['non_gst'] ?> </th>
