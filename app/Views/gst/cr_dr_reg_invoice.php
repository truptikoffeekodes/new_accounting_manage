...
<div class="page-header">
    ...
    <div class="btn btn-list">
        ...
        <a href="<?=url('gst/cr_dr_invoice_xls_export?from='.$start_date.'&to='.$end_date.'&type='.@$type)?>"
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <?php if($type == 'sales'){ ?>
            <form method="get" action = "<?=url('Gst/cr_dr_reg_invoice')?>">
            <?php }else{ ?>
                <form method="get" action = "<?=url('Gst/cr_dr_reg_invoice')?>">
                <?php } ?>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id=""
                        ...
                        <tbody>
                            ...
                            <?php 
                            if($type == 'sales'){
                                $result = $sale_return_Reg;
                            }else{
                                $result = $ac_return_Reg;
                            }
