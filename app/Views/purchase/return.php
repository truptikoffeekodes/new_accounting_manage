...
<?= $this->section('content') ?>
 ...
 <!-- Page Header -->
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5"> Purchase Return </h2>
            <ol class="breadcrumb">
        ...
        <div class="btn btn-list">
            <a href="<?=url('Transaction/create_Purchasereturn')?>"   class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Add New</a>
        </div>
    </div>
                ...
                <div class="card-header card-header-divider">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="p_return" data-module="Transaction" data-filter_data=''>
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Account</th>
