...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Purchase Return Sr No :</span>
            <?= isset($p_return['return_no']) ? @$p_return['return_no'] : $current_id; ?></h2>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    <div class="row col-md-12 form-group">
                                        <label class="form-label col-md-4">Account: </label>
                                        <div class="input-group col-md-8" style="padding:0px;">
                                            ...
                                            <input type="hidden" name="tds_per" id="tds_per" value="<?= @$p_return['tds_per']; ?>">
                                            <input type="hidden" name="tds_limit" id="tds_limit" value="<?= @$p_return['tds_limit']; ?>">
                                            <input type="hidden" name="acc_state" id="acc_state" value="<?= @$p_return['acc_state']; ?>">
                                            <input type="hidden" name="gl_group" value="<?= @$p_return['gl_group']; ?>">
                                    ...
                                    <div class="row col-md-12 form-group">
                                        ...
                                        <input readonly class="form-control col-md-8" type="text" name="gst_no" id="gst_no" value="<?= @$p_return['gst_no']; ?>">
                                    </div>
                                    <div class="row col-md-12 form-group">
                                        <label class="form-label col-md-4">Due Days: <span class="tx-danger"></span></label>
                                        <input class="form-control col-md-8" type="text" name="due_days" onkeypress="return isDesimalNumberKey(event)" value="<?= @$p_return['due_days']; ?>">
                                    </div>
                                    <div class="row col-md-12 form-group">
                                        <label class="form-label col-md-4">Due Date: <span class="tx-danger"></span></label>
                                        <input class="form-control col-md-8 fc-datepicker" name="due_date" placeholder="YYYY-MM-DD" value="<?= user_date(@$p_return['due_date']); ?>" type="text">
                                    </div>
                                    <div class="row col-md-12 form-group">
                                        <label class="form-label col-md-4">Shiped to: <span class="tx-danger"></span></label>
                                    ...
                                    <div class="row col-md-12 form-group">
                                        <label class="form-label col-md-4">Item Name or Code: <span class="tx-danger">*</span></label>
                                        <div class="input-group col-md-8" style="padding:0px;">
                                    ...
                                    <div class="row col-md-12 form-group">
                                        <label class="form-label col-md-4">Particular Name: <span class="tx-danger"></span></label>
                                        <div class="input-group col-md-8" style="padding:0px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" value="<?= @$p_return['fix_brokrage'] ?>" id="fix_brokrage" name="brokrage">
                                        </div>
                                    </div>
                                    <div class="col-md-2 form-group">
                                    ...
                                    <div class="col-md-3 form-group">
                                        <label class="rdiobox"><input checked name="brokerage_type" <?= @$p_return['brokrage_type'] == "fix" ? 'checked' : ''  ?> value="fix" type="radio" onchange="calculate()">
                                            <span>Fix</span></label>

                                        <label class="rdiobox"><input name="brokerage_type" <?= @$p_return['brokrage_type'] == "item_wise" ? 'checked' : ''  ?> value="item_wise" type="radio" onchange="calculate()"> <span>Item
                                                Wise</span></label>
                                    </div>
                                    ...
                                    <div class="col-lg-10 form-group">
                                        <input class="form-control other" name="other" value="<?= @$p_return['other'] ?>" placeholder="Enter Other Detail" type="text">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group">
                                        <input class="form-control lr" name="lr_no" onkeypress="return isDesimalNumberKey(event)" value="<?= @$p_return['lr_no'] ?>" type="text">
                                    </div>
                                    <div class="col-md-2 form-group">
                                        <label class="form-label ">LR Date.: <span class="tx-danger"></span></label>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <input class="form-control fc-datepicker lr_data" placeholder="YYYY-MM-DD" type="text" name="lr_date" value="<?= @$p_return['lr_date'] ?>">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group">
                                        <input class="form-control" name="weight" value="<?= @$p_return['weight']; ?>" placeholder="0.00" placeholder="Enter Weight" type="text">
                                    </div>
                                    <div class="col-md-2 form-group">
                                        <label class="form-label">Freight.: </label>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <input class="form-control" name="freight" value="<?= @$p_return['freight']; ?>" placeholder="00" type="text">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group">
                                        <div class="input-group">
                                            ...
                                            <select class="select2 trans_mode" id="transport_mode" name="transport_mode">
                                                ...
                                                <option <?= (@$p_return['transport_mode'] == "Rail") ? 'selected' : '' ?> value="Rail">Rail</option>
                                                <option <?= (@$p_return['transport_mode'] == "Road") ? 'selected' : ''  ?> value="Road">Road</option>
                                                <option <?= (@$p_return['transport_mode'] == "Air") ? 'selected' : ''  ?> value="Air">Air</option>
                                                <option <?= (@$p_return['transport_mode'] == "Ship") ? 'selected' : ''  ?> value="Air">Ship</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        ?>
                                                <tr class="item_row">
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><input class="form-control input-sm" value="<?= $row['hsn'] ?>" name="hsn[]" readonly onchange="calculate()" type="text"></td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered mg-b-0">
                                            ...
                                            <tr>
                                                    ...
                                                    <td class="wd-100">
                                                        <div class="input-group-sm">
                                                            <select class="select2" id="discount_acc" name="discount_acc">
                                                                <?php if (@$p_return['discount_acc']) { ?>
                                                                    <option value="<?= @$p_return['discount_acc'] ?>">
                                                                        <?= @$p_return['discount_acc_name'] ?>
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <td class="wd-300">
                                                        <div class="input-group">
                                                            <input class="form-control discount" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="discount" type="text" value="<?= @$p_return['discount']; ?>">
                                                            <div class="input-group-prepend">
                                                                <select class="select2 disc_type" name="disc_type" onchange="calculate()">
                                                                    <option <?= (@$p_return['disc_type'] == 'Fixed' ? 'selected' : '') ?> value="Fixed">Fixed Amount</option>
                                                                    <option <?= (@$p_return['disc_type'] == '%' ? 'selected' : '') ?> value="%">Per(%) Amount</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2"><input name="taxable" value="<?= @$p_return['taxable'] ?>" class="form-control input-sm" type="text" readonly>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="igst" style="display:<?php if (!empty($taxes)) {
                                                    ...
                                                    <th>
                                                        <div class="input-group-sm">
                                                            <select class="select2" id="igst_acc" name="igst_acc">
                                                                <?php if (@$p_return['igst_acc']) { ?>
                                                                    <option value="<?= @$p_return['igst_acc'] ?>">
                                                                        <?= @$p_return['igst_acc_name'] ?>
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group-sm">
                                                            <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tot_igst" type="text" value="<?= @$p_return['tot_igst']; ?>">
                                                        </div>
                                                    </th>
                                                ...
                                                <tr id="sgst" style="display:<?php if (!empty($taxes)) {
                                                    ...
                                                    <th>
                                                        <div class="input-group-sm">
                                                            <select class="select2" id="sgst_acc" name="sgst_acc">
                                                                <?php if (@$p_return['sgst_acc']) { ?>
                                                                    <option value="<?= @$p_return['sgst_acc'] ?>">
                                                                        <?= @$p_return['sgst_acc_name'] ?>
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group-sm">
                                                            <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tot_sgst" type="text" value="<?= @$p_return['tot_sgst']; ?>">
                                                ...
                                                <tr id="cgst" style="display:<?php if (!empty($taxes)) {
                                                    ...
                                                    <th>
                                                        <div class="input-group-sm">
                                                            <select class="select2" id="cgst_acc" name="cgst_acc">
                                                                <?php if (@$p_return['cgst_acc']) { ?>
                                                                    <option value="<?= @$p_return['cgst_acc'] ?>">
                                                                        <?= @$p_return['cgst_acc_name'] ?>
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group-sm">
                                                            <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tot_cgst" type="text" value="<?= @$p_return['tot_cgst']; ?>">
                                                ...
                                                <tr id="tds" style="display:<?php if (!empty($taxes)) {
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group-sm">
                                                            <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tds_amt" type="text" value="<?= @$p_return['tds_amt']; ?>">
                                                ...
                                                <tr id="cess" style="display:<?php if (!empty($taxes)) {
                                                    ...
                                                    <th class="wd-300">
                                                        <div class="input-group">
                                                            <input class="form-control" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="cess" type="text" value="<?= @$p_return['cess']; ?>">
                                                            <div class="input-group-prepend">
                                                                <select class="select2" name="cess_type" onchange="calculate()">
                                                                    <option <?= (@$p_return['cess_type'] == 'Fixed' ? 'selected' : '') ?> value="Fixed">Fixed Amount</option>
                                                                    <option <?= (@$p_return['cess_type'] == '%' ? 'selected' : '') ?> value="%">Per(%) Amount</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </th>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="input-group-sm">
                                                            <select class="select2" id="round_acc" name="round">
                                                                <?php if (@$p_return['round_acc']) { ?>
                                                                    <option value="<?= @$p_return['round_acc'] ?>">
                                                                        <?= @$p_return['round_acc_name'] ?>
                                                                    </option>
                                                    ...
                                                    <td><input class="form-control input-sm" onchange="calculate()" value="<?= @$p_return['round_diff'] ?>" name="round_diff" type="text"></td>
                                                ...
                                                <tr>
                                                    <td>Net Amount</td>
                                                    <td colspan="2"><input class="form-control input-sm net_amt" name="net_amount" type="text" value="<?= @$p_return['net_amount']; ?>" readonly></td>
                                                </tr>
                                            </thead>
                                        </table>
...
<script>
    ...
    function calculate() {
        ...
        for (var i = 0; i < pid.length; i++) {
            ...
            var indexx = $(".item_row").find(".hidden_added_amt").val(divide_amt);
    ...
    $(document).ready(function() {
        ...
        $('.ajax-form-submit-return').on('submit', function(e) {
            $('#save_data_return').prop('abled', true);
