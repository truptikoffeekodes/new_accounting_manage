...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Purchase Challan Sr No :</span>
            <?= isset($purchasechallan['challan_no']) ? $purchasechallan['challan_no'] : $current_id; ?></h2>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card custom-card">
                    <div class="card-header card-header-divider">
                        <div class="card-body">
                            <form action="<?= url('purchase/add_purchasechallan') ?>" class="ajax-form-submit-challan" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-4 form-group">
                                        <label class="form-label">Voucher Type : </label>
                                        <select class="form-control" id="voucher_type" name='voucher_type'>
                                            <?php if (@$purchasechallan['voucher_type']) { ?>
                                                <option value="<?= @$purchasechallan['voucher_type'] ?>">
                                                    <?= @$purchasechallan['voucher_name'] ?>
                                                </option>
                                            <?php } else { ?>
                                    ...
                                    <div class="col-lg-4 form-group">
                                        ...
                                        <input class="form-control" readonly name="challan_no" type="text" value="<?= @$purchasechallan['challan_no'] ? $purchasechallan['challan_no'] : $current_id; ?>">
                                    </div>

                                    <div class="col-lg-4 form-group">
                                        <label class="form-labestl">Challan Date: <span class="tx-danger">*</span></label>
                                        <input class="form-control fc-datepicker" name="challan_date" value="<?= @$purchasechallan['challan_date'] ? $purchasechallan['challan_date'] : date('Y-m-d'); ?>" placeholder="MM/DD/YYYY" type="text" id="" required>
                                    ...
                                    <div class="col-lg-5 form-group">
                                        <div class="row">
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div class="input-group" style="width:auto;">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            <a data-toggle="modal" href="<?= url('Master/add_account/sundry_creditor') ?>" data-target="#fm_model" data-title="Enter Account"><i style="font-size:20px;" class="fe fe-plus-circle"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <input type="hidden" name="tds_per" id="tds_per" value="<?= @$purchasechallan['tds_per']; ?>">
                                                ...
                                                <input type="hidden" name="gl_group" value="<?= @$purchasechallan['gl_group']; ?>">

                                            </div>

                                            <div class="row col-md-12 form-group">
                                                <label class="form-label col-md-4">GST No.: <span class="tx-danger"></span></label>
                                                <input readonly class="form-control col-md-8" type="text" name="gst_no" id="gst_no" value="<?= @$purchasechallan['gst_no']; ?>">
                                            </div>
                                            ...
                                            <div class="row col-md-12 form-group">
                                                <label class="form-label col-md-4">Suppl. invoice : <span class="tx-danger"></span></label>
                                                <input class="form-control col-md-8" name="supply_inv" value="<?= @$purchasechallan['supply_inv']; ?>" type="text" formnovalidate>
                                            </div>

                                            <div class="row col-md-12 form-group">
                                                <label class="form-label col-md-12">Item Name or Code: <span class="tx-danger">*</span></label>
                                            </div>
                                            ...
                                            <div class="row col-md-12 form-group">
                                                <label class="form-label col-md-12">Particular Name: <span class="tx-danger">*</span></label>
                                            </div>
                                    ...
                                    <div class="col-lg-7 form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <label class="form-label">Suppl. Challan No.: <span class="tx-danger"></span></label>
                                            </div>
                                            <div class="col-md-8 form-group">
                                                <input class="form-control" name="sup_chl_no" value="<?= @$purchasechallan['sup_chl_no'] ?>" placeholder="Supplier Challan No" type="text">
                                            </div>
                                            ...
                                            <div class="col-md-4 form-group">
                                                <div class="input-group">
                                                    <input class="form-control" name="other" value="<?= @$purchasechallan['other'] ?>" placeholder="Enter Other Detail" type="text">
                                                </div>
                                            </div>
                                            <div class="col-md-2 form-group">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <input class="form-control" name="lr_no" onkeypress="return isDesimalNumberKey(event)" value="<?= @$purchasechallan['lr_no'] ?>" type="text">
                                            </div>
                                            <div class="col-md-2 form-group">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <input class="form-control fc-datepicker" placeholder="DD/MM/YYYY" type="text" name="lr_date" value="<?= @$lr_date ?>">
                                            </div>
                                            ...
                                            <div class="col-md-4 form-group">
                                                <div class="input-group">
                                                    <select class="form-control select2" id="transport_mode" name="transport_mode">
                                                        <option value="">None</option>
                                                        <option <?= (@$purchasechallan['transport_mode'] == "Rail" ? 'selected' : '') ?> value="Rail">Rail</option>
                                                        <option <?= (@$purchasechallan['transport_mode'] == "Road" ? 'selected' : '') ?> value="Road">Road</option>
                                                        <option <?= (@$purchasechallan['transport_mode'] == "Air" ? 'selected' : '') ?> value="Air">Air</option>
                                                        <option <?= (@$purchasechallan['transport_mode'] == "Ship" ? 'selected' : '') ?> value="Air">Ship</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 form-group">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            <a data-toggle="modal" href="<?= url('Master/add_vehicle') ?>" data-target="#fm_model" data-title="Enter vehicle"><i style="font-size:20px;" class="fe fe-plus-circle"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <tbody class="tbody">
                                                ...
                                                ?>
                                                        <tr class="item_row">
                                                            ...
                                                            ?>
                                                            <td><input class="form-control input-sm" value="<?= $row['rate'] ?>" name="price[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" type="text">
                                                            </td>
                                                ...
                                                <table class="table table-bordered mg-b-0">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group">
                                                                    <input class="form-control" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="discount" type="text" value="<?= @$purchasechallan['discount']; ?>">
                                                                    <div class="input-group-prepend">
                                                                        <select class="select2" name="disc_type" onchange="calculate()">
                                                                            <option <?= (@$purchasechallan['disc_type'] == 'Fixed' ? 'selected' : '') ?> value="Fixed">Fixed Amount</option>
                                                                            <option <?= (@$purchasechallan['disc_type'] == '%' ? 'selected' : '') ?> value="%">Per(%) Amount</option>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group">
                                                                    <input class="form-control" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="amty" type="text" value="<?= @$purchasechallan['amty']; ?>">
                                                                    <div class="input-group-prepend">
                                                                        <select class="select2" name="amty_type" onchange="calculate()">
                                                                            <option <?= (@$purchasechallan['amty_type'] == 'Fixed' ? 'selected' : '') ?> value="Fixed">Fixed Amount</option>
                                                                            <option <?= (@$purchasechallan['amty_type'] == '%' ? 'selected' : '') ?> value="%">Per(%) Amount</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2"><input name="taxable" value="<?= @$purchasechallan['taxable'] ?>" class="form-control input-sm" type="text" readonly>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="igst" style="display:<?php if (!empty($taxes)) {
                                                            ...
                                                            <th>
                                                                <div class="input-group-sm">
                                                                    <select class="select2" id="igst_acc" name="igst_acc">
                                                                        <?php if (@$purchasechallan['igst_acc']) { ?>
                                                                            <option value="<?= @$purchasechallan['igst_acc'] ?>">
                                                                                <?= @$purchasechallan['igst_acc_name'] ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group-sm">
                                                                    <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tot_igst" type="text" value="<?= @$purchasechallan['tot_igst']; ?>">
                                                                </div>
                                                            </th>
                                                        ...
                                                        <tr id="sgst" style="display:<?php if (!empty($taxes)) {
                                                            ...
                                                            <th>
                                                                <div class="input-group-sm">
                                                                    <select class="select2" id="sgst_acc" name="sgst_acc">
                                                                        <?php if (@$purchasechallan['sgst_acc']) { ?>
                                                                            <option value="<?= @$purchasechallan['sgst_acc'] ?>">
                                                                                <?= @$purchasechallan['sgst_acc_name'] ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group-sm">
                                                                    <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tot_sgst" type="text" value="<?= @$purchasechallan['tot_sgst']; ?>">
                                                        ...
                                                        <tr id="cgst" style="display:<?php if (!empty($taxes)) {
                                                            ...
                                                            <th>
                                                                <div class="input-group-sm">
                                                                    <select class="select2" id="cgst_acc" name="cgst_acc">
                                                                        <?php if (@$purchasechallan['cgst_acc']) { ?>
                                                                            <option value="<?= @$purchasechallan['cgst_acc'] ?>">
                                                                                <?= @$purchasechallan['cgst_acc_name'] ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group-sm">
                                                                    <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tot_cgst" type="text" value="<?= @$purchasechallan['tot_cgst']; ?>">
                                                        ...
                                                        <tr id="tds" style="display:<?php if (!empty($taxes)) {
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group-sm">
                                                                    <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tds_amt" type="text" value="<?= @$purchasechallan['tds_amt']; ?>">
                                                        ...
                                                        <tr id="cess" style="display:<?php if (!empty($taxes)) {
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group">
                                                                    <input class="form-control" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="cess" type="text" value="<?= @$purchasechallan['cess']; ?>">
                                                                    <div class="input-group-prepend">
                                                                        <select class="select2" name="cess_type" onchange="calculate()">
                                                                            <option <?= (@$purchasechallan['cess_type'] == 'Fixed' ? 'selected' : '') ?> value="Fixed">Fixed Amount</option>
                                                                            <option <?= (@$purchasechallan['cess_type'] == '%' ? 'selected' : '') ?> value="%">Per(%) Amount</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                        ...
                                                        <tr>
                                                            <th>
                                                                <div class="input-group-sm">
                                                                    <select class="select2" id="round" name="round">
                                                                        <?php if (@$purchasechallan['round']) { ?>
                                                                            <option value="<?= @$purchasechallan['round'] ?>">
                                                                                <?= @$purchasechallan['round_name'] ?>
                                                                            </option>
                                                                        <?php } else { ?>
                                                            ...
                                                            <th><input class="form-control input-sm" onchange="calculate()" value="<?= @$purchasechallan['round_diff'] ?>" name="round_diff" type="text"></th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.ajax-form-submit-challan').on('submit', function(e) {
            $('#save_data_challan').prop('disable', true);
        ...
        $('#account').on('select2:select', function(e) {
            ...
            //console.log(data.data.gl_group);
