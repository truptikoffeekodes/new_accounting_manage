...
<?= $this->section('content') ?>
 ...
 <div class="page-header">
        ...
        <div class="btn btn-list">
            <a href="<?= url('Purchase/add_purchasechallan') ?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>
        </div>
    </div>
    <!-- End Page Header -->
    <div class="row">
                ...
                <div class="card-header card-header-divider">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="purchasechallan" data-module="TransactionController" data-filter_data=''>
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Document</th>
