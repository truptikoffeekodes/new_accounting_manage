...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a data-toggle="modal" href="<?= url('Testing/add_shortcut_key') ?>" data-target="#fm_model" data-title="Add Shortcut Key" class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>
            ...
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="shortcut_list" data-module="Testing" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Key Character</th>
