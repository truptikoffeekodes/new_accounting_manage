                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 form-group">
                                            ...
                                            <input class="form-control" readonly type="text"
                                                value="<?=@$jvparticular['detail']['id'] ? $jvparticular['detail']['id'] : $current_id;?>">
                                            <input name="jv_id"
                                                value="<?=@$jvparticular['detail']['id'] ? $jvparticular['detail']['id']: $current_id;?>"
                                                type="hidden">
                                        </div>
                                        ...
                                        <div class="col-lg-4  form-group">
                                            ...
                                            <input class="form-control fc-datepicker" name="date"
                                                value="<?=@$jvparticular['detail']['date'] ? user_date($jvparticular['detail']['date']) : user_date(date('Y-m-d'));?>"
                                                placeholder="MM/DD/YYYY" type="text" required>
                                            <input name="id" value="<?=@$jvparticular['detail']['id']?>" type="hidden">
                                        </div>

                                        <div class="col-lg-4  form-group">
                                            <label class="form-label">Narration:</label>
                                            <input class="form-control" name="narration"
                                                value="<?=@$jvparticular['detail']['narration'];?>" placeholder="Enter Narration" type="text">
                                        </div>
                                    </div>
                                    <div class="tbody">
                                        <?php
                                        if (isset($jvparticular['item'])) {
                                            for ($i = 0; $i < count($jvparticular['item']); $i++) { ?>
                                        <div class="row jv_parti">
                                            ...
                                            <div class="col-lg-2 form-group">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control select2" name="dr_cr[]" required>
                                                        ...
                                                        <option
                                                            <?=(@$jvparticular['item'][$i]['dr_cr'] == "dr" ? 'selected' : '')?>
                                                            value="dr">DR</option>
                                                        <option
                                                            <?=(@$jvparticular['item'][$i]['dr_cr'] == "cr" ? 'selected' : '')?>
                                                            value="cr">CR</option>
                                                    </select>
                                                </div>
                                                <input name="item_id[]"
                                                value="<?=@$jvparticular['item'][$i]['item_id'] ? $jvparticular['item'][$i]['item_id']: '';?>"
                                                type="hidden">
                                            </div>
                                            ...
                                            <div class="col-lg-2 form-group">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control particular" name="particular[]">
                                                        <?php if (@$jvparticular['item'][$i]['particular_name']) {?>
                                                        <option selected value="<?=@$jvparticular['item'][$i]['particular']?>">
                                                            <?=@$jvparticular['item'][$i]['particular_name']?>
                                                        </option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-2 form-group">
                                                <label class="form-label">Amount: <span
                                                        class="tx-danger">*</span></label>
                                                <input class="form-control" name="amount[]"  onchange="calculate()" type="text" required
                                                    placeholder="Enter Amount"
                                                    value="<?=@$jvparticular['item'][$i]['amount']?>">
                                            </div>
                                            ...
                                            <div class="col-lg-2 form-group">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control adjustment" onchange="afterload(this)"
                                                        ...
                                                        <option value="">None</option>
                                                        <option
                                                            <?=(@$jvparticular['item'][$i]['method'] == "Advanced" ? 'selected' : '')?>
                                                            value="Advanced">Advanced</option>
                                                        <option
                                                            <?=(@$jvparticular['item'][$i]['method'] == "agains_reference" ? 'selected' : '')?>
                                                            value="agains_reference">Agains Reference</option>
                                                        <option
                                                            <?=(@$jvparticular['item'][$i]['method'] == "new_reference" ? 'selected' : '')?>
                                                            value="new_reference">New References</option>
                                                        <option
                                                            <?=(@$jvparticular['item'][$i]['method'] == "on_account" ? 'selected' : '')?>
                                            ...
                                            <div class="col-lg-3 form-group invoice_div"
                                                style=<?php echo !empty($jvparticular['item'][$i]['invoice']) ? '"display:block;"' : '"display:none;" disabled'; ?>>
                                                <label class=" form-label">Select Invoice : <span
                                                        class="tx-danger"></span></label>
                                                <div class="input-group">
                                                    <select class="form-control invoices"
                                                        <?=!empty($jvparticular['item'][$i]['invoice']) ? '' : 'disabled ';?>
                                                        name="invoice[]" >
                                                        <?php if (@$jvparticular['item'][$i]['invoice_name']) {?>
                                                        <option selected value="<?=@$jvparticular['item'][$i]['invoice']?>">
                                                            <?=@$jvparticular['item'][$i]['invoice_name']?>
                                                        </option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                                <input type="hidden" name="invoice_tb[]" id="invoice_tb"
                                                    value="<?=@$jvparticular['item'][$i]['invoice_tb']?>">
                                            </div>

                                            <div class="col-lg-2 form-group advance_for"
                                                style="display:<?php echo (@$jvparticular['item'][$i]['advance_for'] != 0) ? 'block;' : 'none;'; ?>">
                                                <label class=" form-label">Advance For : <span
                                                        class="tx-danger"></span></label>
                                                <div class="input-group">
                                                    <select class="form-control advance_ac" name="advance_for[]">
                                                        <?php if (@$jvparticular['item'][$i]['advance_for']) {?>
                                                        <option selected value="<?=@$jvparticular['item'][$i]['advance_for']?>">
                                                            <?=@$jvparticular['item'][$i]['advance_name']?>
                                                        </option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row jv_parti">
                                            ...
                                            <div class="col-lg-2 form-group">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control select2" onchange="calculate()"
                                                        ...
                                                        <option value="">None</option>
                                                        <option selected
                                                            <?=(@$jvparticular['item']['dr_cr'] == "dr" ? 'selected' : '')?>
                                                            value="dr">DR</option>
                                                    </select>
                                                    <input name="item_id[]"
                                                value="<?=@$jvparticular['item']['item_id'] ? $jvparticular['item']['item_id']: '';?>"
                                                type="hidden">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2 form-group">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control particular" name="particular[]">
                                                        <?php if (@$jvparticular['item']['particular_name']) {?>
                                                        <option value="<?=@$jvparticular['item']['particular']?>">
                                                            <?=@$jvparticular['item']['particular_name']?>
                                                        </option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-2 form-group">
                                                ...
                                                <input class="form-control" name="amount[]" onchange="calculate()"
                                                    ...
                                                    value="<?=@$jvparticular['item']['amount']?>">
                                            </div>
                                            ...
                                            <div class="col-lg-2 form-group">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control adjustment" onchange="afterload(this)"
                                                        ...
                                                        <option value="">None</option>
                                                        <option
                                                            <?=(@$jvparticular['item']['method'] == "Advanced" ? 'selected' : '')?>
                                                            value="Advanced">Advanced</option>
                                                        <option
                                                            <?=(@$jvparticular['item']['method'] == "agains_reference" ? 'selected' : '')?>
                                                            value="agains_reference">Agains Reference</option>
                                                        <option
                                                            <?=(@$jvparticular['item']['method'] == "new_reference" ? 'selected' : '')?>
                                                            value="new_reference">New References</option>
                                                        <option
                                                            <?=(@$jvparticular['item']['method'] == "on_account" ? 'selected' : '')?>
                                                            value="on_account">On Account</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 form-group invoice_div"
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control invoices" name="invoice[]">
                                                        <?php if (@$jvparticular['item']['invoice_name']) {?>
                                                        <option selected value="<?=@$jvparticular['item']['invoice']?>">
                                                            <?=@$jvparticular['item']['invoice_name']?>
                                                        </option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-2 form-group advance_for"
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control advance_ac" name="advance_for[]">
                                                        <?php if (@$jvparticular['item']['advance_for']) {?>
                                                        <option selected value="<?=@$jvparticular['item']['advance_for']?>">
                                                            <?=@$jvparticular['item']['advance_name']?>
                                                        </option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-1 form-group tax"
                                                style="display:<?php echo isset($jvparticular['item']['tax']) ? 'block;' : 'none;'; ?>">
                                                <label class="form-label">Tax(%) : <span
                                                        class="tx-danger"></span></label>
                                                <div class="input-group">
                                                    <input class="form-control" name="tax[]" type="text"
                                                        placeholder="Enter TAX" value="<?=@$jvparticular['item']['tax']?>">
                                                </div>
                                            </div>
                                        </div>
                                        <?php }?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <label class="custom-switch">
                                                <input type="checkbox" name="stat_adj" onchange="check_stat()"
                                                    ...
                                                    <?=(@$jvparticular['detail']['stat_adj'] == "1" ? 'checked' : '')?>
                                                    value="<?=@$jvparticular['detail']['stat_adj']?>">
                                    ...
                                    <div class="row stat_div"
                                        style="display:<?=(@$jvparticular['detail']['stat_adj'] == 1) ? 'flex;' : 'none;'?>">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control select2" name="duty_tax">
                                                    <option
                                                        <?=(@$jvparticular['detail']['duty_tax'] == "Gst" ? 'selected' : '')?>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control select2" name="adjust">
                                                    <option <?=(@$jvparticular['detail']['adjust'] == "1" ? 'selected' : '')?>
                                                        value="1">Decrease of Tax Liability</option>
                                                    <option <?=(@$jvparticular['detail']['adjust'] == "2" ? 'selected' : '')?>
                                                        value="2">Increase of Tax Liability</option>
                                                    <option <?=(@$jvparticular['detail']['adjust'] == "3" ? 'selected' : '')?>
                                                        value="3">Increase of Input Tax Credit</option>
                                                    <option <?=(@$jvparticular['detail']['adjust'] == "4" ? 'selected' : '')?>
                                                        value="4">Increase of Tax Liability & Input Tax Credit</option>
                                                    <option <?=(@$jvparticular['detail']['adjust'] == "5" ? 'selected' : '')?>
                                                        value="5">Refund</option>
                                                    <option <?=(@$jvparticular['detail']['adjust'] == "6" ? 'selected' : '')?>
                                                        value="6">Reversal Of Input Tax Credit</option>
                                                    <option <?=(@$jvparticular['detail']['adjust'] == "7" ? 'selected' : '')?>
                                        ...
                                        <div class="col-md-12 form-group decrease_tax" style="display:<?=(@$jvparticular[0]['adjust'] == 1) ? 'flex;' : 'none;'?>">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control select2" name="addi_detail">
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "1" ? 'selected' : '')?>
                                                        value="1">Adjustment Againts Credit</option>
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "2" ? 'selected' : '')?>
                                                        value="2">Cancellation Of Advance Payment Under Reverse charge</option>
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "3" ? 'selected' : '')?>
                                                        value="3">Cancellation Of Advance Receipt</option>
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "4" ? 'selected' : '')?>
                                                        value="4">Cancellation Of Advance Receipt for Export/SEZ Sales</option>
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "5" ? 'selected' : '')?>
                                                        value="5">Purchase Againts Advance Receipt</option>
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "5" ? 'selected' : '')?>
                                                        value="5">Purchase Againts Advance Receipt</option>
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "6" ? 'selected' : '')?>
                                        ...
                                        <div class="col-md-12 form-group increase_credit" style="display:<?=(@$jvparticular[0]['adjust'] == 3) ? 'flex;' : 'none;'?>>
                                            ...
                                            <div class="input-group">
                                                <select class="form-control select2" name="addi_detail">
                                                    ...
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "7" ? 'selected' : '')?>
                                                        value="7">Purchase Under Reverse Charge</option>
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "8" ? 'selected' : '')?>
                                                        value="8">Re-Claim Of Reversal ITC </option>
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "8" ? 'selected' : '')?>
                                                        value="8">Re-Claim Of Reversal ITC -Rule 42(2)(b) </option>    
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "9" ? 'selected' : '')?>
                                                        value="9">TCS Adjustment</option>
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "10" ? 'selected' : '')?>
                                                        value="10">TDS Adjustment</option>
                                                    <option <?=(@$jvparticular['detail']['addi_detail'] == "11" ? 'selected' : '')?>
                                        ...
                                        <div class="col-md-12 form-group tax_credit" style="display:<?=(@$jvparticular['detail']['adjust'] == 8) ? 'flex;' : 'none ;'?>">
                                            <label class="form-label">Additional Detail: <span
                                                    class="tx-danger"></span></label>
                                            <div class="input-group">
                                                <select class="form-control select2" name="addi_detail">
                                        ...
                                        <div class="col-md-12 form-group refund" style="display:<?=(@$jvparticular['detail']['adjust'] == 5) ? 'flex;' : 'none ;'?>">
                                            <label class="form-label">Additional Detail: <span
                                                    class="tx-danger"></span></label>
                                            <div class="input-group">
                                                <select class="form-control select2" name="addi_detail">
                                        ...
                                        <div class="col-md-12 form-group reversal_credit" style="display:<?=(@$jvparticular['detail']['adjust'] == 6) ? 'flex;' : 'none ;'?>">
                                            <label class="form-label">Additional Detail: <span
                                                    class="tx-danger"></span></label>
                                            <div class="input-group">
                                                <select class="form-control select2" name="addi_detail">
                                        ...
                                        <div class="col-md-12 form-group reversal_liability" style="display:<?=(@$jvparticular['detail']['adjust'] == 7) ? 'flex;' : 'none ;'?>">
                                            <label class="form-label">Additional Detail: <span
                                                    class="tx-danger"></span></label>
                                            <div class="input-group">
                                                <select class="form-control select2" name="addi_detail">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <label class="custom-switch">
                                                <input type="checkbox" name="gst_detail" onchange="check_gst_detail()"
                                                    class="custom-switch-input"
                                                    <?=(@$jvparticular['detail']['gst_detail'] == "1" ? 'checked' : '')?>
                                                    value="<?=@$jvparticular['detail']['gst_detail']?>">
                                                <span class="custom-switch-indicator"></span>
                                    ...
                                    <div class="row gst_detail_div"
                                        style="display:<?=(@$jvparticular['detail']['gst_detail'] == 1) ? 'flex;' : 'none;'?>">
                                        <div class="col-md-6 form-group">
                                            <label class="form-label">Select Account : <span
                                                    class="tx-danger"></span></label>
                                            <div class="input-group">
                                                <select class="form-control gst_parti" name="gst_parti">
                                                    <?php if (@$jvparticular['detail']['gst_parti']) {?>
                                                    <option selected value="<?=@$jvparticular['detail']['gst_parti']?>">
                                                        <?=@$jvparticular['detail']['gst_parti_name']?>
                                                    </option>
                                                    <?php }?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 form-group bank_tras_div" style="display:<?=!empty(@$jvparticular['detail']['gst_parti']) ? 'block;' : 'none;' ?>">
                                            <label class="form-label">Select Bank Trans : <span
                                                    class="tx-danger"></span></label>
                                            <div class="input-group">
                                                <select class="form-control bank_tras" name="bank_tras">
                                                    <?php if (@$jvparticular['detail']['bank_tras']) {?>
                                                    <option selected value="<?=@$jvparticular['detail']['bank_tras']?>">
                                                        <?=@$jvparticular['detail']['bank_tras_name']?>
                                                    </option>
                                                    <?php }?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label class="form-label">Place of Supply: <span
                                                    class="tx-danger"></span></label>
                                            <div class="input-group">
                                                <input class="form-control" name="supply" value="<?=@$jvparticular['detail']['supply']?>"  placeholder = "Place of Supply">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control select2" name="registration">
                                                    <option <?=(@$jvparticular['detail']['registration'] == "Regular" ? 'selected' : '')?>
                                                        value="Regular">Regular</option>
                                                    <option <?=(@$jvparticular['detail']['registration'] == "Unregister" ? 'selected' : '')?>
                                                        value="Unregister">Unregister</option>
                                                    <option <?=(@$jvparticular['detail']['registration'] == "Composition" ? 'selected' : '')?>
                                                        value="Composition">Composition</option>
                                                    <option <?=(@$jvparticular['detail']['registration'] == "Unknown" ? 'selected' : '')?>
                                                        value="Unknown">Unknown</option>
                                                    <option <?=(@$jvparticular['detail']['registration'] == "Consumer" ? 'selected' : '')?>
                                                        value="Consumer">Consumer</option>
                                                    <option <?=(@$jvparticular['detail']['registration'] == "Other" ? 'selected' : '')?>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control select2" name="party_type">
                                                    <option <?=(@$jvparticular['detail']['party_type'] == "1" ? 'selected' : '')?>
                                                        value="1">Not Applicable</option>
                                                    <option <?=(@$jvparticular['detail']['party_type'] == "2" ? 'selected' : '')?>
                                                        value="2">Deemed Export</option>
                                                    <option <?=(@$jvparticular['detail']['party_type'] == "3" ? 'selected' : '')?>
                                                        value="3">Embassy/UN Body</option>
                                                    <option <?=(@$jvparticular['detail']['party_type'] == "4" ? 'selected' : '')?>
                                                        value="3">SEZ</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label class="form-label">GST: <span
                                                    class="tx-danger"></span></label>
                                            <div class="input-group">
                                                <input class="form-control" name="gst" value="<?=@$jvparticular['detail']['gst']?>"  placeholder = "Place of Supply">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
function calculate() {
    ...
    for (var i = 0; i < amount.length; i++) {
        if (dr_cr[i] == 'dr') {
            dr_total += parseFloat(amount[i].toFixed(2));
        }
        if (dr_cr[i] == 'cr') {
            cr_total += parseFloat(amount[i].toFixed(2));
        }
    }

    tot_diff = parseFloat(dr_total.toFixed(2)) - parseFloat(cr_total.toFixed(2));

    console.log(parseFloat(dr_total.toFixed(2)))
    console.log(parseFloat(cr_total.toFixed(2)))
    console.log(parseFloat(tot_diff.toFixed(2)))

    $('#tot_dr').html(dr_total.toFixed(2));
    $('#diff').html(tot_diff.toFixed(2));
    $('#tot_cr').html(cr_total.toFixed(2));
...
function addinput() {
    ...
    html +=
        '<div class= "remove"><a class="tx-danger btnDelete" data-id="2" onclick="delete_row(this)" title="0"><i class="fa fa-times tx-danger"></i></a></div><input class="form-control" name="item_id[]" type="hidden"  placeholder="Enter TAX" value="">';
