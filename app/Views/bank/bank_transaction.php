...
<div class="page-header">
    ...
    <div class="btn btn-list">
        ...
        <a href="<?=url('bank/add_banktrans')?>" data-title="Add Bank Transaction" class="btn ripple btn-primary"><i
                class="fe fe-external-link"></i> Add Bank Transaction</a>

        <a href="<?=url('bank/add_contratrans')?>" data-title="Add Bank Transaction" class="btn ripple btn-secondary"><i
                class="fe fe-external-link"></i> Add Contra Transaction</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <div class="row align-items-center">
                <div class="col-md-3">
                    <div class="form-group mb-lg-0">
                        ...
                        <div class="input-group">
                            ...
                            </div><input class="form-control dateMask" name="from" id="from" placeholder="DD-MM-YYYY"
                                type="text">
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group mb-lg-0">
                        ...
                        <div class="input-group">
                            ...
                            </div><input class="form-control dateMask" name="to" id="to" placeholder="DD-MM-YYYY"
                                type="text">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group mb-lg-0">
                        ...
                        <div class="input-group">
                            <select class="form-control" id="particular" name='parti'></select>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-right mt-3 ">
                <button type="submit" id="SearchButton" class="btn btn-primary">Apply</button>
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="post" action="<?=url('bank/excel_upload')?>" enctype="multipart/form-data">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="row">

                            <div class="col-lg-12 form-group">
                                <label class="form-label">Select Excel: <span class="tx-danger"></span></label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input class="custom-file-input"  name="excel" type="file"> <label
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="banktrans" data-module="Bank" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Mode</th>
