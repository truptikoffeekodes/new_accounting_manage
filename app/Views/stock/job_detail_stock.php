...
<div class="responsive-background">
    <div class="navbar-collapse collapse show" id="navbarSupportedContent" style="">
        <form method="post" action ="<?=url('Stock/job_voucher_detail/').$item_id?>">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($stock as $row) {
                                        if ($row['voucher_type'] == 'Job Issue') {
                                            $url = 'Milling/Add_jobwork/';
                                        } else if ($row['voucher_type'] == 'Job Received') {
                                            $url = 'Milling/Add_rec_jobwork/';
                                        } else if ($row['voucher_type'] == 'Job Return') {
                                            $url = 'Milling/Add_return_jobwork/';
                                        } else {
                                        }
                                ?>
                                <tr>
                                    ...
                                    <?php if ($row['voucher_type'] == 'Job Issue') {
                                    ...
                                    <td></td>
                                    <td></td>
                                    <?php } else if ($row['voucher_type'] == 'Job Received' || $row['voucher_type'] == 'Job Return') {
                                    $outward_pcs += $row['pcs'];
