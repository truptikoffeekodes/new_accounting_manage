...
<div class="responsive-background">
    <div class="navbar-collapse collapse show" id="navbarSupportedContent" style="">
        <form method="post" action ="<?=url('Stock/finish_voucher_detail/').$item_id?>">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-hover voucher" id="table_list_data">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($stock as $row) {
                                        if ($row['voucher_type'] == 'Finish Challan') {
                                            $url = 'Milling/Add_grey_challan/';
                                        } else if ($row['voucher_type'] == 'Mill Received') {
                                            $url = 'Milling/add_rec_mill/';
                                        } else if ($row['voucher_type'] == 'Job Issue') {
                                            $url = 'Milling/Add_jobwork/';
                                        } else if ($row['voucher_type'] == 'Finish Return') {
                                ...
                                <tr>
                                    ...
                                    <?php if ($row['voucher_type'] == 'Finish Challan' || $row['voucher_type'] == 'Mill Received') {
                                    ...
                                    <td></td>
                                    <td></td>
                                    <?php } else if ($row['voucher_type'] == 'Finish Return' || $row['voucher_type'] == 'Job Issue') {
                                    $outward_pcs += $row['pcs'];
                            ...
                            <tfoot>
                                    ...
                                    <th><?=$outward_pcs?></th>
                                    <th><?=$outward_meter?></th>
                                    <th><?=((float) $inward_pcs - (float) $outward_pcs)?>/<?=((float) $inward_meter - (float) $outward_meter)?></th>
                            </tfoot>
                        </table>
                    </div>
                </div>
