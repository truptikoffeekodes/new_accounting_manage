...
<div class="responsive-background">
    <div class="navbar-collapse collapse show" id="navbarSupportedContent" style="">
        <form method="post" action ="<?=url('Stock/mill_voucher_detail/').$item_id?>">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($stock as $row) {
                                        if ($row['voucher_type'] == 'Mill Issue') {
                                ...
                                <tr>
                                    ...
                                    <?php if ($row['voucher_type'] == 'Mill Issue') {
                                    ...
                                    <td></td>
                                    <td></td>
                                    <?php } else if ($row['voucher_type'] == 'Mill Received' || $row['voucher_type'] == 'Mill Return') {
                                    $outward_pcs += $row['pcs'];
