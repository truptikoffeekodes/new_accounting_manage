...
<div class="page-header">
    ...
    <div class="btn btn-list">
        ...
        <a href="<?=url('Addbook/Sales_gst_register_xls?from='.$start_date.'&to='.$end_date)?>"  class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Excel Export</a>
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            ...
            <form method="post" action="<?=url('Addbook/Sales_gst_register')?>">
                <div class="row">
                    <div class="col-md-4">
