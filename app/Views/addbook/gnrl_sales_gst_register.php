...
<div class="container">
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">General Sales GST Register Book</h2>
            <ol class="breadcrumb">
        ...
        <div class="btn btn-list">
            ...
            <a href="<?=url('Addbook/Gnrl_sales_gst_register_xls?from='.$start_date.'&to='.$end_date)?>"  class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Excel Export</a>
    ...
    <div class="responsive-background">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="advanced-search">
                ...
                <form method="post" action="<?=url('Addbook/Gnrl_sales_gst_register')?>">
                    <div class="row">
                        <div class="col-md-4">
