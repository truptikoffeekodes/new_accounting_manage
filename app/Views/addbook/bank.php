    ...
    <div class="responsive-background">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            //  $c = $uri->getSegment(3);
             //print_r($c);exit;
                ?>
                <form method="post" action="<?=url('Addbook/bank')?>">
                            ...
                            <div class="table-responsive">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered table-fw-widget">
                                        <tr>
                                            <td>
                                                <span style="size:20px;"><b><?=@$acc_name;?></b></span>
                                                </br>
                                                <?php
                                                ...
                                                <h5 style="float:right;">Opening Balance : <?=@$opening_bal['opening_bal'] ?><?=@$opening_bal['opening_type'] == 'Credit' ? ' CR' : ' DB'?> </h5>
                                            </td>
                                        </tr>
                                ...
                                <table class="table mg-b-0">
                                    ...
                                    <tbody>
                                       ...
                                       // echo "jkvndfk";
                                        ...
                                        if(!empty($opening_bal['opening_bal']))
                                        {
                                            $opening_bal = $opening_bal['opening_bal'];
                                        }
                                        else
                                        {
                                            $opening_bal = 0;
                                                ...
                                                $closing=0;
                                                if(@$opening_bal['opening_type'] == 'Credit')
                                                {
                                                    $closing = $closing - @$opening_bal['opening_bal']; 
                                                }else{
                                                    $closing = $closing + @$opening_bal['opening_bal']; 
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td><?=@$closing < 0 ? ($closing * -1).' CR' : $closing.' DB'?></td>
                                        </tr>
                                        <?php
                                                    }
                                                }
                                        ...
                                        <tr>
                                            <?php
                                                                $credit_total=@$total['bankcredit_total'];
                                                                $debit_total=@$total['bankdebit_total'];
                                            ...
                                            <td></td>
                                            <td>Total</td>
                                            <td><b><?=@$credit_total;?> DB</b></td>
                                            <td><b><?=@$debit_total;?> CR</b></td>
                                            
                                            <td><b><?=@$closing < 0 ? $closing * -1 .' CR' : $closing .' DB'  ;?></b>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
