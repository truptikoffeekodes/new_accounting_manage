...
<div class="container">
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Journal Book</h2>
            <ol class="breadcrumb">
    ...
    <div class="responsive-background">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            //  //print_r($c);exit;
                ?>
                <form method="post" action="<?=url('Addbook/journal')?>">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table mg-b-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <?php
                                                                $credit_total=@$total['journalcredit_total'];
                                                                $debit_total=@$total['journaldebit_total'];
