...
<div class="container">
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Sales Register Book</h2>
            <ol class="breadcrumb">
        ...
        <div class="btn btn-list">
            ...
            <a href="<?=url('Addbook/Sales_register_xls?from='.$start_date.'&to='.$end_date.'&ac_id='.@$account_id)?>"  class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Excel Export</a>
    ...
    <div class="responsive-background">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="advanced-search">
                ...
                <form method="post" action="<?=url('Addbook/Sales_register')?>">
                    <div class="row">
                        <div class="col-md-4">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table main-table-reference mt-0 mb-0 text-center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="<?=url('Addbook/salesItem_voucher_wise?month=4&year='.@$sales[4]['year'])?>">April</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a href="<?=url('Addbook/salesItem_voucher_wise?month=5&year='.@$sales[5]['year'])?>">May</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="<?=url('Addbook/salesItem_voucher_wise?month=6&year='.@$sales[6]['year'])?>">June</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="<?=url('Addbook/salesItem_voucher_wise?month=7&year='.@$sales[7]['year'])?>">July</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="<?=url('Addbook/salesItem_voucher_wise?month=8&year='.@$sales[8]['year'])?>">Auguest</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="<?=url('Addbook/salesItem_voucher_wise?month=9&year='.@$sales[9]['year'])?>">September</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="<?=url('Addbook/salesItem_voucher_wise?month=10&year='.@$sales[10]['year'])?>">October</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="<?=url('Addbook/salesItem_voucher_wise?month=11&year='.@$sales[11]['year'])?>">November</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="<?=url('Addbook/salesItem_voucher_wise?month=12&year='.@$sales[12]['year'])?>">December</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="<?=url('Addbook/salesItem_voucher_wise?month=1&year='.@$sales[1]['year'])?>">January</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="<?=url('Addbook/salesItem_voucher_wise?month=2&year='.@$sales[2]['year'])?>">February</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><a
                                                            href="<?=url('Addbook/salesItem_voucher_wise?month=3&year='.@$sales[3]['year'])?>">March</a>
                                                    </td>
