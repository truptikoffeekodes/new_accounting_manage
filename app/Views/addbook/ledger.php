...
<div class="container">
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Ledger Book</h2>
            <ol class="breadcrumb">
        ...
        <div class="btn btn-list">
            ...
            <a href="<?=url('Addbook/ledger_xls_export?'.'account_id='.@$account_id.'&from='.@$start_date.'&to='.@$end_date)?>"
    ...
    <div class="responsive-background">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="advanced-search">
                <form method="post" action="<?=url('Addbook/ledger')?>">
                            ...
                            <div class="row">
                                <div class="col-lg-12 form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control select2" id="party_account" onchange=""
                                            name="account_id">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-lg-0">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control fc-datepicker" id="" name="to"
                                                placeholder="DD-MM-YYYY" type="text">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                    ...
                                    <table class="table table-hover table-bordered table-fw-widget">
                                        <tr>
                                            <td>
                                                ...
                                                <span style="size:20px;"><b><?=@$invoice_data['ac_name'];?></b></span>
                                                </br>
                                                <?php 
                                                if(!empty($invoice_data['start_date']))
                                                {
                                                ?>

                                                <b><?=user_date(@$invoice_data['start_date']); ?></b> to
                                                <b><?=user_date(@$invoice_data['end_date']); ?></b>
                                                <!-- <span style="size:20px;float:right;"><b>Openining Balance:   <?=@$old_data;?></b></span>
                                                 -->
                                                <?php
                                                }
                                                ?>
                                ...
                                <table class="table mg-b-0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                                //echo '<pre>';print_r($invoice_data['data']);exit;
                                                if(!empty($invoice_data['data']))
                                                {
                                                    if(!empty($invoice_data['data']))
                                                    {
                                                        // $credit =0;
                                                        // $debit =0;
                                                        foreach($invoice_data['data'] as $row)
                                                        {
                                        ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                if($row['type'] == 'sale_invoice')
                                                {
                                            ?>
                                            <td><a href="<?=url('sales/add_salesinvoice/'.@$row['id'])?>"><?=@$row['account_name'];?>
                                            </td>
                                            <?php 
                                                }
                                                if($row['type'] == 'sale_general')
                                                {
                                                    // if($row['v_type'] == 'general')
                                                    // {
                                            ?>
                                            <td><a href="<?=url('sales/add_ACinvoice/general/'.@$row['id'])?>"><?=@$row['account_name'];?>
                                            </td>
                                            <?php 
                                                    }
                                                  
                                                    if($row['type'] == 'sale_general_return')
                                                    {
                                                   
                                            ?>
                                            <td><a href="<?=url('sales/add_ACinvoice/return/'.@$row['id'])?>"><?=@$row['account_name'];?>
                                            </td>
                                            <?php
                                                     }
                                                ...
                                                {
                                            ?>
                                            <td><a href="<?=url('purchase/add_purchaseinvoice/'.@$row['id'])?>"><?=@$row['account_name'];?>
                                            </td>
                                            <?php 
                                                }
                                                if($row['type'] == 'purchase_general')
                                                {
                                                    // if($row['v_type'] == 'general')
                                                    // {
                                            ?>
                                            <td><a href="<?=url('Purchase/add_general_pur/general/'.@$row['id'])?>"><?=@$row['account_name'];?>
                                            </td>
                                            <?php 
                                                    }
                                                    if($row['type'] == 'purchase_general_return')
                                                    {
                                                   
                                            ?>
                                            <td><a href="<?=url('Purchase/add_general_pur/return/'.@$row['id'])?>"><?=@$row['account_name'];?>
                                            </td>
                                            <?php
                                                     }
                                                
                                                if($row['type'] == 'Payment' OR $row['type'] == 'Receipt')
                                                {
                                            ?>
                                            <td><a href="<?=url('Bank/add_banktrans/'.@$row['id'])?>"><?=@$row['account_name'];?>
                                            </td>
                                            <?php 
                                                }
                                                ...
                                                {
                                            ?>
                                            <td><a href="<?=url('Purchase/add_purchasereturn/'.@$row['id'])?>"><?=@$row['account_name'];?>
                                            </td>
                                            <?php 
                                                }
                                                ...
                                                {
                                            ?>
                                            <td><a href="<?=url('sales/add_salesreturn/'.@$row['id'])?>"><?=@$row['account_name'];?>
                                            </td>
                                            <?php 
                                                }
                                                if($row['type'] == 'cr' OR $row['type'] == 'dr')
                                                {
                                            ?>
                                            <td><a href="<?=url('Bank/add_jvparticular/'.@$row['jv_id'])?>"><?=@$row['account_name'];?>
                                            </td>
                                            <?php 
                                                }
                                     ...
                                     // print_r($credit);exit;
                                      ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><b><?=number_format(@$closing,2,'.',"") ?></b></td>
                                            <td></td>
                                            <?php
                                                }
                                                else
