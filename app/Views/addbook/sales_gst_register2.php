...
<div class="page-header">
    <div>
        <h2 class="main-content-title tx-24 mg-b-5">Sales GST Register Book</h2>
        <ol class="breadcrumb">
    ...
    <div class="btn btn-list">
        ...
        <a href="<?=url('Addbook/Sales_gst_register2_xls?from='.$start_date.'&to='.$end_date)?>"  class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Excel Export</a>
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            ...
            <form method="post" action="<?=url('Addbook/Sales_gst_register2')?>">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-lg-0">
                            <div class="input-group">
                                ...
                                <input class="form-control fc-datepicker" id="dateMask" name="from" placeholder="YYYY-MM-DD"
                                    type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered table-fw-widget">
                                <tr>
                                    <td>
                                        <span style="size:20px;"><b>Addbook</b></span>
                                        </br>
                                        <?php
                        ...
                        <table class="table dataTable border table-hover table-fw-widget sale_gst   ">
                            <thead>
                                <tr>
                                    <th rowspan="2">ID</th>
                            ...
                            <tbody>
                                    ...
                                    if (!empty($sale)) {
                                        ...
                                        foreach ($sale as $row) {
                                            ...
                                            for ($i = 0; $i < count($row['item']); $i++) {
                                                ...
                                                $total_gst += ($final_sub * ($row['item'][$i]['igst'] / 100));
                                ...
                                <tr>
                                    ...
                                    <th><?=number_format(@$total_gst, 2);?></th>
                                    <th colspan="9"></th>
