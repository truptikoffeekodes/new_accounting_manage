...
<div class="container">
    ...
    <div class="responsive-background">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            //  //print_r($c);exit;
                ?>
                <form method="get" action="<?=url('Addbook/View_filter')?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control select2" id="" onchange="" name="account_id">
                                ...
                                <div class="col-lg-12 form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control select2" id="type" onchange="" name="type">
                                            <option value="">None</option>
                                            <?php 
                                                if($type=='sales' OR $type=='purchase'){
                                            ?>
                                            <option <?= ( @$type == "sales" ? 'selected' : '' ) ?> value="sales">
                                                Sales</option>
                                            <option <?= ( @$type == "purchase" ? 'selected' : '' ) ?> value="purchase">
                                                Purchase</option>
                                            <?php
                                            }else if($type=='creditnote' OR $type=='debitnote'){

                                            ?>
                                            <option <?= ( @$type == "creditnote" ? 'selected' : '' ) ?>
                                                value="creditnote">
                                                Credit Note</option>
                                            <option <?= ( @$type == "debitnote" ? 'selected' : '' ) ?>
                                                value="debitnote">Debit Note</option>
                                            <?php
                                            }else if($type=='payment' OR $type=='receipt'){
                                            ?>
                                            <option <?= ( @$type == "payment" ? 'selected' : '' ) ?> value="payment">
                                                Payment</option>
                                            <option <?= ( @$type == "receipt" ? 'selected' : '' ) ?> value="receipt">
                                                Receipt</option>
                                            <?php
                                            }else if($type=='cash' OR $type=='bank'){
                                            ?>
                                            <option <?= ( @$type == "cash" ? 'selected' : '' ) ?> value="cash">
                                                Cash</option>
                                            <option <?= ( @$type == "bank" ? 'selected' : '' ) ?> value="bank">Bank
                                            </option>
                                            <?php
                                            }else if($type == "journal"){
                                             ?>
                                            <option <?= ( @$type == "journal" ? 'selected' : '' ) ?> value="journal">
                                                Journal</option>
                                            <?php
                                ...
                                ?>
                                <div class="col-lg-12 form-group">
                                    <label class="form-label">Payment Mode: <span class="tx-danger"></span></label>
                                    <div class="input-group">
                                ...
                                <?php }
                                if($type=='payment' OR $type=='receipt')
                                {
                                ?>
                                <div class="col-lg-12 form-group">
                                ...
                                <?php } 
                                if($type=='journal' OR $type=='receipt')
                                {
                                ?>
                                <div class="col-lg-12 form-group">
                                    <label class="form-label">Payment Type: <span class="tx-danger"></span></label>
                                ...
                                <table class="table mg-b-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Name</th>
                                            <?php
                                                if($type=='receipts' OR $type=='payment')
                                                {
                                            ?>
                                            <th>Payment Type</th>
                                            <?php
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                                ...
                                                if(!empty($purchaseinvoice_general))
                                                {
                                        ...
                                        <?php
                                                ...
                                                if(!empty($purchasegeneral_return))
                                                {
                                                   // echo '<pre>';print_r($sales_return);
                                        ...
                                        <?php
                                                ...
                                                if(!empty($ledger))
                                                {
                                                   //echo '<pre>'; print_r($ledger['sales_invoice']);exit;
                                                    if(!empty($ledger['sales_invoice']))
                                                {
                                                   // echo '<pre>';print_r($sales_invoice);
                                        ...
                                        <?php
                                                ...
                                                if(!empty($ledger['salesinvoice_general']))
                                                {
                                                    //echo '<pre>';print_r($salesinvoice_general);
                                        ...
                                        <?php
                                                    ...
                                                    if(!empty($ledger['purchase_invoice']))
                                                    {
                                                    // echo '<pre>';print_r($sales_return);
                                        ...
                                        <?php
                                                ...
                                                if(!empty($ledger['purchaseinvoice_general']))
                                                {
                                        ...
                                        <?php
                                                ...
                                                if(!empty($ledger['salesgeneral_return']))
                                                {
                                                   // echo '<pre>';print_r($sales_return);
                                        ...
                                        <?php
                                                ...
                                                if(!empty($ledger['purchase_return']))
                                                {
                                                   // echo '<pre>';print_r($sales_return);
                                        ...
                                        <?php
                                                ...
                                                if(!empty($ledger['purchasegeneral_return']))
                                                {
                                                   // echo '<pre>';print_r($sales_return);
                                        ...
                                        <tr>
                                            <!-- <table class="table mg-b-0" border="1">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <?php
                                                                $credit_total= @$total['salesinvoice_total'] + @$total['sgeneralinvoive_total'] + @$total['purchaseinvoice_total'] + @$total['pgeneralinvoive_total']; + @$total['receipt_total'];
                                                                $debit_total= @$total['salesreturn_total'] + @$total['sgeneralreturn_total'] + @$total['purchasreturn_total'] + @$total['pgeneralreturn_total'] + @$total['payment_total'];
                                            ...
                                            <?php
                                                $debit_total=@$total['salesinvoice_total'] + @$total['salesinvoice_general_total'] + @$total['purchasreturn_total'] + @$total['purchasereturn_general_total'] + @$total['payment_total'] + @$total['cashdebit_total'] + @$total['bankdebit_total'] + @$total['journaldebit_total']
                                                            +@$ledger['total']['salesinvoice_total'] + @$ledger['total']['salesinvoice_general_total'] +@$ledger['total']['purchasreturn_total'] + @$ledger['total']['purchasereturn_general_total'] + @$ledger['total']['payment_total'] + @$ledger['total']['cashdebit_total'] + @$ledger['total']['bankdebit_total'] + @$ledger['total']['journaldebit_total'];
                                                $credit_total=@$total['purchaseinvoice_total'] + @$total['purchaseinvoive_general_total'] + @$total['salesreturn_total'] + @$total['salesreturn_general_total'] + @$total['receipt_total'] + @$total['cashcredit_total'] + @$total['bankcredit_total'] + @$total['journalcredit_total']
                                                            + @$ledger['total']['purchaseinvoice_total'] + @$ledger['total']['purchaseinvoive_general_total'] + @$ledger['total']['salesreturn_total'] + @$ledger['total']['salesreturn_general_total'] + @$ledger['total']['receipt_total'] + @$ledger['total']['cashcredit_total'] + @$ledger['total']['bankcredit_total'] + @$ledger['total']['journalcredit_total'];
                                            ?>
                                            <td></td>
                                            <td></td>
                                            <td>Total</td>
                                            <td></td>
                                            <?php
                                             if($type=='sales' OR $type=='debitnote' OR $type=='payment')
                                             {
                                            ?>
                                            <td><?=@$debit_total;?></td>
                                            <?php
