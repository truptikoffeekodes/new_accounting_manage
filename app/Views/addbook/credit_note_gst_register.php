...
<div class="container">
    ...
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Credit Note GST Register Book</h2>
            <ol class="breadcrumb">
        ...
        <div class="btn btn-list">
            ...
            <a href="<?=url('Addbook/Creditnote_gst_register_xls?from='.$start_date.'&to='.$end_date)?>"  class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Excel Export</a>
    ...
    <div class="responsive-background">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="advanced-search">
                ...
                <form method="post" action="<?=url('Addbook/Creditnote_gst_register')?>">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="table-responsive">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered table-fw-widget">
                                    <tr>
                                        <td>
                                            <span style="size:20px;"><b>Credit Note Gst Register</b></span>
                                            </br>
                                            <?php
                                    ...
                                    <?php } ?>
                                        ...
                                        <?php
                                            for ($i = 1; $i < count($row['item']); $i++) {
                                                    $sub = $row['item'][$i]['qty'] * $row['item'][$i]['rate'];
                                                    // print_r($row['item'][$i]['qty'] );
                                                    // print_r($row['item'][$i]['rate'][$i]);
                                                    // print_r($sub);exit;
                                                    if ($row['discount'] > 0) {
                                                        $discount_amt = $sub * $disc_avg_per;
                                                        $final_sub = $sub - $discount_amt;
