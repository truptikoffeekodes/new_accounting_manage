...
<div class="page-header">
    ...
    <div class="btn btn-list">
        ...
        <a href="<?=url('Addbook/Purchase_gst_register_xls?from='.$start_date.'&to='.$end_date)?>"  class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Excel Export</a>
