                        ...
                        <section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 form-group" id="name_hide"
                                    ...
                                    <label class="form-label"><b>Company Name </b><span class="tx-danger">*</span></label>
                            ...
                            <div id="gl_hide">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 form-group">
                                        ...
                                        <input class="form-control" name="gst_add" 
                                            value="<?=@$account_view['gst_add'];?>" placeholder="Enter Shipping Address"
                                            type="text">
                                    </div>
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <input class="form-control" name="ship_pin" 
                                            value="<?=@$account_view['ship_pin'];?>" placeholder="Enter PIN" type="text"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 form-group" id="gstno_div"
                                    ...
                                    <input class="form-control" name="gst" value="<?=@$account_view['gst'];?>" minlength="15" maxlength="15" style="text-transform: uppercase;"
                                        placeholder="Enter GST No" type="text" id="gst_number">
                                ...
                                <div class="col-lg-4 form-group taxability" id="taxability_div"
                                    ...
                                    <select class="form-control select2" id="taxability" name="taxability">
                                        ...
                                        <option <?=(@$account_view['taxability'] == "Nill" ? 'selected' : 'selecetd')?>
                                            value="Nill">Nill</option>
                                        <option <?=(@$account_view['taxability'] == "Taxable" ? 'selected' : '')?>
                                            value="Taxable">Taxable</option>
                                        <option <?=(@$account_view['taxability'] == "Exempt" ? 'selected' : '')?>
                            ...
                            <div class="row ">
                                <div class="col-lg-6 form-group bank">
                                    <label class="form-label"><b>Transaction Bank:</b>
                                        <a data-toggle="modal" href="<?=url('master/add_account/bank')?>"
                                            data-target="#fm_model" data-title="Add Account Details ">
                                            <i class="btn btn-secondary btn-sm mb-1" style="float:right"><i
                                                    class="fa fa-plus"></i></i></a>
                                    </label>
                                    <div class="input-group">
                                    ...
                                    <input type="hidden" name="trans_bank_ac" id="trans_bank_ac"
                                        value="<?=@$account_view['trans_bank_ac'];?>">
                                    <input type="hidden" name="trans_bank_ifsc" id="trans_bank_ifsc"
                                        value="<?=@$account_view['trans_bank_ifsc'];?>">
                                    <input type="hidden" name="trans_bank_holder" id="trans_bank_holder"
                                        value="<?=@$account_view['trans_bank_holder'];?>">
                                    <input type="hidden" name="trans_bank_name" id="trans_bank_name"
                                        value="<?=@$account_view['trans_bank_name'];?>">
                                </div>
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <input class="form-control" name="bankifsc"
                                        value="<?=@$account_view['bank_ifsc'];?>" placeholder="Enter Bank IFSC" onkeyup="this.value = this.value.toUpperCase();"
                                        type="text">
                                </div>
