...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?= url('Trading/get_income_account_data') ?>">
                ...
                <div class="table-responsive">
                    <table class="table table-striped mg-b-0">
                        ...
                        <?php
                            ...
                            <tr>
                                <th scope="row">1</th>
                                <td><a href="<?= url('Trading/generalSales_monthly_AcWise?from=' . $from . '&to=' . $to . '&id=' . $id . '&type=' . @$type) ?>">General Sales</a></td>
                            ...
                            <tr>
                                <th scope="row">2</th>
                                <td><a href="<?= url('Trading/bank_cash_monthly_AcWise?from=' . $from . '&to=' . $to . '&id=' . $id . '&type=' . @$type) ?>">Bank/Cash Transaction </a></td>
                            ...
                            <tr>
                                <th scope="row">3</th>
                                <td><a href="<?= url('Trading/jv_monthly_AcWise?from=' . $from . '&to=' . $to . '&id=' . $id . '&type=' . @$type) ?>">Journal Voucher</a></td>
