...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?= url('Trading/generalSales_monthly_AcWise') ?>">
                        ...
                        <div class="table-responsive">
                            <table class="table main-table-reference mt-0 mb-0 text-center">
                                ...
                                <tbody>
                                    <?php $closing = 0; ?>
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=4&year=' . @$generalSale[4]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">April</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=5&year=' . @$generalSale[5]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">May</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=6&year=' . @$generalSale[6]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">June</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=7&year=' . @$generalSale[7]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">July</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=8&year=' . @$generalSale[8]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">August</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=9&year=' . @$generalSale[9]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">September</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=10&year=' . @$generalSale[10]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">October</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=11&year=' . @$generalSale[11]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">November</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=12&year=' . @$generalSale[12]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">December</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=1&year=' . @$generalSale[1]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">January</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=2&year=' . @$generalSale[2]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">February</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/generalSales_voucher_wise?month=3&year=' . @$generalSale[3]['year'] . '&id=' . $ac_id . '&type=' . @$type) ?>">March</a></td>
