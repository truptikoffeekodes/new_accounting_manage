                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="table-responsive">
                            <table class="table main-table-reference mt-0 mb-0 text-center">
                                ...
                                <?php $closing = 0; ?>
                                    <tr>
                                        <td><a href="<?=url('Trading/jv_voucher_wise?month=4&year='.@$jv[4]['year'].'&id='.$ac_id.'&type='.$type)?>">April</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Trading/jv_voucher_wise?month=5&year='.@$jv[5]['year'].'&id='.$ac_id.'&type='.$type)?>">May</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Trading/jv_voucher_wise?month=6&year='.@$jv[6]['year'].'&id='.$ac_id.'&type='.$type)?>">June</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Trading/jv_voucher_wise?month=8&year='.@$jv[8]['year'].'&id='.$ac_id)?>">August</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Trading/jv_voucher_wise?month=9&year='.@$jv[9]['year'].'&id='.$ac_id.'&type='.$type)?>">September</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Trading/jv_voucher_wise?month=10&year='.@$jv[10]['year'].'&id='.$ac_id.'&type='.$type)?>">October</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Trading/jv_voucher_wise?month=11&year='.@$jv[11]['year'].'&id='.$ac_id.'&type='.$type)?>">November</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Trading/jv_voucher_wise?month=12&year='.@$jv[12]['year'].'&id='.$ac_id.'&type='.$type)?>">December</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Trading/jv_voucher_wise?month=1&year='.@$jv[1]['year'].'&id='.$ac_id.'&type='.$type)?>">January</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Trading/jv_voucher_wise?month=2&year='.@$jv[2]['year'].'&id='.$ac_id.'&type='.$type)?>">February</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Trading/jv_voucher_wise?month=3&year='.@$jv[3]['year'].'&id='.$ac_id.'&type='.$type)?>">March</a></td>
