...
<div class="page-header">
    <div>
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><?= $ac_name ?></a></li>
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?= url('Trading/bank_cash_monthly_AcWise') ?>">
                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="table-responsive">
                            <table class="table main-table-reference mt-0 mb-0 text-center">
                                ...
                                <tbody>
                                    <?php $closing = 0;
                                    //echo '<pre>';Print_r($bankcash);exit;

                                    ?>
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=4&year=' . @$bankcash[4]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">April</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=5&year=' . @$bankcash[5]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">May</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=6&year=' . @$bankcash[6]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">June</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=7&year=' . @$bankcash[7]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">July</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=8&year=' . @$bankcash[8]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">August</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=9&year=' . @$bankcash[9]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">September</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=10&year=' . @$bankcash[10]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">October</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=11&year=' . @$bankcash[11]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">November</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=12&year=' . @$bankcash[12]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">December</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=1&year=' . @$bankcash[1]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">January</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=2&year=' . @$bankcash[2]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">February</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/bank_cash_voucher_wise?month=3&year=' . @$bankcash[3]['year'] . '&id=' . $ac_id . '&type=' . $type) ?>">March</a></td>
