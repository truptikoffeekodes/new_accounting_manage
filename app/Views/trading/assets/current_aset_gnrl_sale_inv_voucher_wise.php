...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?=url('Balancesheet/currentassets_gnrl_sale_voucher_Acwise')?>">
                ...
                <div class="table-responsive">
                    <table class="table main-table-reference mt-0 mb-0 text-center my_table">
                        ...
                        <tbody>
                            ...
                            $credit = 0;
                            if(!empty($currentassets_salesinvoice))
                            {
                                foreach(@$currentassets_salesinvoice as $row){ ?> 
                                <tr>
                                    <td><?=user_date($row['date'])?></td>
                                    <td><a href ="<?=url('Sales/add_ACinvoice/general/'.$row['id'])?>"><?=$row['party_name']?></a></td>
                                    <td> General Sales Invoice Voucher </td>
                                    <td><?=$row['id']?></td>
