                ...
                <div class="table-responsive">
                    <table class="table main-table-reference mt-0 mb-0 text-center">
                        ...
                        <tbody>
                            <?php
                                $total = 0;
                                foreach($bl['current_assets'] as $key => $value) { ?>
                            <tr>
                                <td><b><?=@$value['name']?></b></td>
                                <td></td>
                                <td><b><?=@$bl['current_assets_total']?></b><br>
                            ...
                            <tr>
                                <td><a href="<?=url('Balancesheet/get_currentassets_account_data?from='.$date['from'].'&to='.$date['to'].'&id='.$ac_value['account_id'])?>"><?=$ac_key ?></a>
                                </td>
                                <td><?=number_format(@$ac_value['total'],2) ?></td>
                                <td> </td>
                            </tr>
                            <?php 
                                    }    
