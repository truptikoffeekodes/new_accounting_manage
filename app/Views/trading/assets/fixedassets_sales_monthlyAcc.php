...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?=url('Balancesheet/fixedassets_salesinvoice_monthly_AcWise')?>">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered table-fw-widget">
                        <tr>
                            <td>
                                <span style="size:20px;"><b>Income Voucher</b></span>
                                </br>
                                <?php
                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="table-responsive">
                            <table class="table main-table-reference mt-0 mb-0 text-center">
                                ...
                                <?php $closing = 0;?>
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=4&year='.@$generalSale[4]['year'].'&id='.$ac_id)?>">April</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=5&year='.@$generalSale[5]['year'].'&id='.$ac_id)?>">May</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=6&year='.@$generalSale[6]['year'].'&id='.$ac_id)?>">June</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=7&year='.@$generalSale[7]['year'].'&id='.$ac_id)?>">July</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=8&year='.@$generalSale[8]['year'].'&id='.$ac_id)?>">August</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=9&year='.@$generalSale[9]['year'].'&id='.$ac_id)?>">September</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=10&year='.@$generalSale[10]['year'].'&id='.$ac_id)?>">October</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=11&year='.@$generalSale[11]['year'].'&id='.$ac_id)?>">November</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=12&year='.@$generalSale[12]['year'].'&id='.$ac_id)?>">December</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=1&year='.@$generalSale[1]['year'].'&id='.$ac_id)?>">January</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=2&year='.@$generalSale[2]['year'].'&id='.$ac_id)?>">February</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_Sales_voucher_wise?month=3&year='.@$generalSale[3]['year'].'&id='.$ac_id)?>">March</a></td>
