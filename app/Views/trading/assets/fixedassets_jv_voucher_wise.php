...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?=url('Balancesheet/fixedassets_jv_voucher_wise')?>">
                ...
                <div class="table-responsive">
                    <table class="table main-table-reference mt-0 mb-0 text-center my_table">
                        ...
                        <tbody>
                            ...
                            $debit = 0;
                            $credit = 0;
                            if(!empty($fixedassets_jv)){
                                foreach(@$fixedassets_jv as $row){ ?> 
                                <tr>
                                    ...
                                    <td><?= $row['dr_cr'] == 'dr' ? $row['taxable'] :$row['taxable'] ?></td>
                                </tr>
                        ...
                        <tfooter>
                            <tr>
                                ...
                                <th colspan="3"><?=$closing = $debit + $credit?></th>
