...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?=url('Balancesheet/currentassets_contra_voucher_Perwise')?>">
                ...
                <div class="table-responsive">
                    <table class="table main-table-reference mt-0 mb-0 text-center my_table">
                        ...
                        <tbody>
                            ...
                            // $debit = 0;
                            // $credit = 0;
                            if(!empty($currentassets_contratrans)){
                                foreach(@$currentassets_contratrans as $row){ ?> 
                                <tr>
