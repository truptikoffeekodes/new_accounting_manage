...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?=url('Trading/currentassets_millsalesreturn_voucher_Acwise')?>">
                ...
                <div class="table-responsive">
                    <table class="table main-table-reference mt-0 mb-0 text-center">
                        ...
                        <tbody>
                            ...
                            $debit = 0;
                            if(!empty($currentassets_millsalesreturn))
                            {
                                foreach(@$currentassets_millsalesreturn as $row){ ?> 
                                <tr>
                                    <td><?=user_date($row['date'])?></td>
                                    <td><a href ="<?=url('Milling/add_Mill_SaleReturn/'.$row['id'])?>"><?=$row['party_name']?></a></td>
                                    <td> <?=$row['mode']?> Sales Return </td>
                                    <td><?=$row['id']?></td>
