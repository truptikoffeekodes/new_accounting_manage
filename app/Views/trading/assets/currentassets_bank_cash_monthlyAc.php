...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?=url('Balancesheet/currentassets_banktrans_monthly_AcWise')?>">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered table-fw-widget">
                        <tr>
                            <td>
                                <span style="size:20px;"><b>Bank/Cash Voucher</b></span>
                                </br>
                                <?php
                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="table-responsive">
                            <table class="table main-table-reference mt-0 mb-0 text-center">
                                ...
                                <?php $closing = 0;?>
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=4&year='.@$bankcash[4]['year'].'&id='.$ac_id)?>">April</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=5&year='.@$bankcash[5]['year'].'&id='.$ac_id)?>">May</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=6&year='.@$bankcash[6]['year'].'&id='.$ac_id)?>">June</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=7&year='.@$bankcash[7]['year'].'&id='.$ac_id)?>">July</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=8&year='.@$bankcash[8]['year'].'&id='.$ac_id)?>">August</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=9&year='.@$bankcash[9]['year'].'&id='.$ac_id)?>">September</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=10&year='.@$bankcash[10]['year'].'&id='.$ac_id)?>">October</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=11&year='.@$bankcash[11]['year'].'&id='.$ac_id)?>">November</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=12&year='.@$bankcash[12]['year'].'&id='.$ac_id)?>">December</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=1&year='.@$bankcash[1]['year'].'&id='.$ac_id)?>">January</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=2&year='.@$bankcash[2]['year'].'&id='.$ac_id)?>">February</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/currentassets_bankcash_voucher_Acwise?month=3&year='.@$bankcash[3]['year'].'&id='.$ac_id)?>">March</a></td>
