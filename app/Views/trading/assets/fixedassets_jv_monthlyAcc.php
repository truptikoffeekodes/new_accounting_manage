...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?=url('Balancesheet/fixedassets_jv_monthly')?>">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover table-bordered table-fw-widget">
                        <tr>
                            <td>
                                <span style="size:20px;"><b>JV Voucher</b></span>
                                </br>
                                <?php
                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="table-responsive">
                            <table class="table main-table-reference mt-0 mb-0 text-center">
                                ...
                                <?php $closing = 0;?>
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_jv_voucher_wise?month=4&year='.@$jv[4]['year'].'&id='.$ac_id)?>">April</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_jv_voucher_wise?month=5&year='.@$jv[5]['year'].'&id='.$ac_id)?>">May</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_jv_voucher_wise?month=6&year='.@$jv[6]['year'].'&id='.$ac_id)?>">June</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_jv_voucher_wise?month=7&year='.@$jv[7]['year'].'&id='.$ac_id)?>">July</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_jv_voucher_wise?month=8&year='.@$jv[8]['year'].'&id='.$ac_id)?>">August</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_jv_voucher_wise?month=9&year='.@$jv[9]['year'].'&id='.$ac_id)?>">September</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_jv_voucher_wise?month=10&year='.@$jv[10]['year'].'&id='.$ac_id)?>">October</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_jv_voucher_wise?month=11&year='.@$jv[11]['year'].'&id='.$ac_id)?>">November</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_jv_voucher_wise?month=12&year='.@$jv[12]['year'].'&id='.$ac_id)?>">December</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_jv_voucher_wise?month=1&year='.@$jv[1]['year'].'&id='.$ac_id)?>">January</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedtassets_jv_voucher_wise?month=2&year='.@$jv[2]['year'].'&id='.$ac_id)?>">February</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/fixedassets_jv_voucher_wise?month=3&year='.@$jv[3]['year'].'&id='.$ac_id)?>">March</a></td>
