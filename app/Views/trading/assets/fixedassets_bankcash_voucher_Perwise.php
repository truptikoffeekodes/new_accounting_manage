...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?=url('Balancesheet/fixedassets_bankcash_voucher_Perwise')?>">
                ...
                <div class="table-responsive">
                    <table class="table main-table-reference mt-0 mb-0 text-center my_table">
                        ...
                        <tbody>
                            ...
                            $debit = 0;
                            $credit = 0;
                            if(!empty($fixedassets_banktrans)){
                                foreach(@$fixedassets_banktrans as $row){ ?> 
                                <tr>
                                    ...
                                    <td></td>
                                    <?php } ?>
                                    <td><?=($row['mode'] != 'Receipt') ? $row['taxable'] : $row['taxable'] ?></td>
                                </tr>
                                <?php 
                                    if($row['mode']=="Receipt"){ 
                                        $debit -= $row['taxable'];
