...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?=url('Balancesheet/currentassets_contra_voucher_Acwise')?>">
                ...
                <div class="table-responsive">
                    <table class="table main-table-reference mt-0 mb-0 text-center my_table">
                        ...
                        <tbody>
                            ...
                            // $debit = 0;
                            // $credit = 0;
                            if(!empty($currentassets_ac_contratrans)){
                                foreach(@$currentassets_ac_contratrans as $row){ ?> 
                                <tr>
                                    <td><?=user_date($row['date'])?></td>
                                   
                                    <td><a href ="<?=url('bank/add_contratrans/'.$row['id'])?>"><?=$row['party_name']?></a></td>
