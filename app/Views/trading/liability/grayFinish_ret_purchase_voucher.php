...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?=url('Trading/gray_finish_ret_voucher_wise')?>">
                        ...
                        <tbody>
                            ...
                            if(!empty($purchase_ret)){
                                ...
                                <tr>
                                    ...
                                    <td><a href ="<?=url('Milling/Add_retGrayFinish/'.$row['id'])?>"><?=$row['party_name']?></a></td>
                                    <td> <b><?=$row['mode']?> Purchase Return</b></td>
                                    <td><?=$row['id']?></td>
                                    <td><?='-'.$row['taxable']?></td>
