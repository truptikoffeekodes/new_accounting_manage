                ...
                <div class="table-responsive">
                    <table class="table main-table-reference mt-0 mb-0 text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="<?=url('Trading/get_loan_account_data?from='.$date['from'].'&to='.$date['to'].'&id='.$ac_value['account_id'])?>"><?=$ac_key ?></a>
                                </td>
                                <td><?=$ac_value['total'] ?>
                            ...
                            ?>
                            <tr>
                                <td><a href = "<?=url('Trading/get_loan_sub_grp?'.'id='.$sub_key.'&name='.$sub_value['name'].'&from='.$date['from'].'&to='.$date['to'])?>"><?=$sub_value['name']?></a>
                                </td>
                                <td><?=$total ?>
