...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?=url('Balancesheet/generalPurchase_monthly')?>">
                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="table-responsive">
                            <table class="table main-table-reference mt-0 mb-0 text-center">
                                ...
                                <?php $closing = 0;?>
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=4&year='.@$generalPurchase[4]['year'].'&id='.$ac_id.'&type='.$type)?>">April</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=5&year='.@$generalPurchase[5]['year'].'&id='.$ac_id.'&type='.$type)?>">May</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=6&year='.@$generalPurchase[6]['year'].'&id='.$ac_id.'&type='.$type)?>">June</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=7&year='.@$generalPurchase[7]['year'].'&id='.$ac_id.'&type='.$type)?>">July</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=8&year='.@$generalPurchase[8]['year'].'&id='.$ac_id.'&type='.$type)?>">August</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=9&year='.@$generalPurchase[9]['year'].'&id='.$ac_id.'&type='.$type)?>">September</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=10&year='.@$generalPurchase[10]['year'].'&id='.$ac_id.'&type='.$type)?>">October</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=11&year='.@$generalPurchase[11]['year'].'&id='.$ac_id.'&type='.$type)?>">November</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=12&year='.@$generalPurchase[12]['year'].'&id='.$ac_id.'&type='.$type)?>">December</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=1&year='.@$generalPurchase[1]['year'].'&id='.$ac_id.'&type='.$type)?>">January</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=2&year='.@$generalPurchase[2]['year'].'&id='.$ac_id.'&type='.$type)?>">February</a></td>
                                    ...
                                    <tr>
                                        <td><a href="<?=url('Balancesheet/generalPurchase_voucher_wise_liability?month=3&year='.@$generalPurchase[3]['year'].'&id='.$ac_id.'&type='.$type)?>">March</a></td>
                                ...
                                <tfooter>
                                    <tr>
                                        <th><h4>Total</h4></th>
                                        <th><h4><?=number_format($debit,2)?></h4></th>
                                        <th><h4><?=number_format($credit,2)?></h4></th>
