...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="get" action="<?= url('Profitloss/get_expence_sub_grp') ?>">
                ...
                <div class="table-responsive">
                    <table class="table main-table-reference mt-0 mb-0 text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="<?=url('Trading/get_expence_account_data?from='.$date['from'].'&to='.$date['to'].'&id='.$ac_value['account_id'].'&type=trading')?>"><?=$ac_key ?></a>
                                </td>
                            ...
                            ?>
                            <tr>
                                <td><a href="<?=url('Profitloss/get_expence_sub_grp?id='.$sub_key.'&name='.$sub_value['name'].'&from='.$date['from'].'&to='.$date['to'].'&type=trading')?>"><?=$sub_value['name']?></a>
                                </td>
