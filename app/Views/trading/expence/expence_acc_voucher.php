                    ...
                    <table class="table table-striped mg-b-0">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        <th scope="row">1</th>
                                        <td><a href="<?= url('Trading/generalpurchase_monthly_AcWise?from=' . $from . '&to=' . $to . '&id=' . $id . '&type=' . $type) ?>">General purchase</a></td>
                            ...
                            if (isset($bank_trans['total'])) {
                                ...
                                ?>
                                    <tr>
                                        <th scope="row">2</th>
                                        <td><a href="<?= url('Trading/purchase_bank_cash_monthly_AcWise?from=' . $from . '&to=' . $to . '&id=' . $id . '&type=' . $type) ?>">Bank/Cash Transaction </a></td>
                            ...
                            if (isset($jv_parti['total'])) {
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <th scope="row">3</th>
                                        <td><a href="<?= url('Trading/purchase_jv_monthly_AcWise?from=' . $from . '&to=' . $to . '&id=' . $id . '&type=' . $type) ?>">Journal Voucher</a></td>
                            ...
                            if (isset($general_sales['total'])) {
                                ...
                                ?>
                                        <tr>
                                            <th scope="row">4</th>
                                            <td><a href="<?= url('Profitloss/pl_generalSales_monthly_AcWise?from=' . $from . '&to=' . $to . '&id=' . $id . '&type=' . $type) ?>">General Sales</a></td>
