...
<div class="page-header">
    ...
    <div class="btn btn-list">
        ...
        <a href="<?= url('Balancesheet/Balancesheet_xls?from=' . $start_date . '&to=' . $end_date) ?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Excel Export</a>
...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="post" action="<?= url('Balancesheet') ?>">
                                        ...
                                        <table class="table">
                                            ...
                                            foreach ($bl['capital'] as $key => $value) { ?>
                                                ...
                                                if (!empty($value['account'])) {
                                                    foreach (@$value['account'] as $ac_key => $ac_value) { ?>
                                                        <tr>
                                                            <td><a href="<?= url('Balancesheet/get_capital_account_data?from=' . $trading['from'] . '&to=' . $trading['to'] . '&id=' . $ac_value['account_id']) ?>"><?= $ac_key ?></a>
                                                            </td>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><a href="<?= url('Balancesheet/get_capital_sub_grp?' . 'id=' . $sub_key . '&name=' . $sub_value['name'] . '&from=' . $trading['from'] . '&to=' . $trading['to']) ?>"><?= $sub_value['name'] ?></a>
                                                            </td>
                                            ...
                                            foreach ($bl['loan'] as $key => $value) { ?>
                                                ...
                                                if (!empty($value['account'])) {
                                                    foreach (@$value['account'] as $ac_key => $ac_value) { ?>
                                                        <tr>
                                                            <td><a href="<?= url('Balancesheet/get_loan_account_data?from=' . $trading['from'] . '&to=' . $trading['to'] . '&id=' . $ac_value['account_id']) ?>"><?= $ac_key ?>
                                                            </td>
                                                            <td><?= number_format($ac_value['total'], 2) ?>
                                                            </td>
                                                            <td> </td>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><a href="<?= url('Balancesheet/get_loan_sub_grp?' . 'id=' . $sub_key . '&name=' . $sub_value['name'] . '&from=' . $trading['from'] . '&to=' . $trading['to']) ?>"><?= $sub_value['name'] ?></a>
                                                            </td>
                                                            <td><?= number_format($total, 2) ?>
                                                            </td>
                                                            <td> </td>
                                            ...
                                            foreach ($bl['current_lib'] as $key => $value) { ?>
                                                ...
                                                if (!empty($value['account'])) {
                                                    foreach (@$value['account'] as $ac_key => $ac_value) { ?>
                                                        <tr>
                                                            <td><a href="<?= url('Balancesheet/get_current_lib_account_data?from=' . $trading['from'] . '&to=' . $trading['to'] . '&id=' . $ac_value['account_id']) ?>"><?= $ac_key ?></a>
                                                            </td>
                                                            <td><?= number_format($ac_value['total'], 2) ?>
                                                            </td>
                                                            <td> </td>
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            <td><a href="<?= url('Balancesheet/get_current_lib_sub_grp?' . 'id=' . $sub_key . '&name=' . $sub_value['name'] . '&from=' . $trading['from'] . '&to=' . $trading['to']) ?>"><?= $sub_value['name'] ?></a>
                                                            </td>
                                        ...
                                        <table class="table">
                                            ...
                                            foreach ($bl['fixedassets'] as $key => $value) { ?>
                                                ...
                                                if (!empty($value['account'])) {
                                                    foreach (@$value['account'] as $ac_key => $ac_value) { ?>
                                                        <tr>
                                                            <td><a href="<?= url('Balancesheet/get_fixedassets_account_data?from=' . $trading['from'] . '&to=' . $trading['to'] . '&id=' . $ac_value['account_id']) ?>"><?= $ac_key ?></a>
                                                            </td>
                                                            <td><?= number_format($ac_value['total'], 2) ?>
                                                            </td>
                                                            <td> </td>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><a href="<?= url('Balancesheet/get_fixed_assets_sub_grp?' . 'id=' . $sub_key . '&name=' . $sub_value['name'] . '&from=' . $trading['from'] . '&to=' . $trading['to']) ?>"><?= $sub_value['name'] ?></a>
                                                            </td>
                                                            <td><?= number_format($total, 2) ?>
                                                            </td>
                                                            <td> </td>
                                            ...
                                            foreach ($bl['currentassets'] as $key => $value) { ?>
                                                ...
                                                if (!empty($value['account'])) {
                                                    foreach (@$value['account'] as $ac_key => $ac_value) { ?>
                                                        <tr>
                                                            <td><a href="<?= url('Balancesheet/get_currentassets_account_data?from=' . $trading['from'] . '&to=' . $trading['to'] . '&id=' . $ac_value['account_id']) ?>"><?= $ac_key ?></a>
                                                            </td>
                                                            <td><?= number_format($ac_value['total'], 2) ?>
                                                            </td>
                                                            <td> </td>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><a href="<?= url('Balancesheet/get_current_assets_sub_grp?' . 'id=' . $sub_key . '&name=' . $sub_value['name'] . '&from=' . $trading['from'] . '&to=' . $trading['to']) ?>"><?= $sub_value['name'] ?></a>
                                                            </td>
                                                            <td><?= number_format($total, 2) ?>
                                                            </td>
                                                            <td> </td>
