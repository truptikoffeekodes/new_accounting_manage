...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="post" action="<?= url('Trading/purchaseReturnItem_monthly') ?>">
                        ...
                        <div class="table-responsive">
                            <table class="table main-table-reference mt-0 mb-0 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=4&year=' . @$purchase[4]['year']) ?>">April</a></td>
                                        <td><?= isset($purchase[4]['total']) ? $purchase[4]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=5&year=' . @$purchase[5]['year']) ?>">May</a></td>
                                        <td><?= isset($purchase[5]['total'])  ? $purchase[5]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=6&year=' . @$purchase[6]['year']) ?>">June</a></td>
                                        <td><?= isset($purchase[6]['total'])  ? $purchase[6]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=7&year=' . @$purchase[7]['year']) ?>">July</a></td>
                                        <td><?= isset($purchase[7]['total']) ? $purchase[7]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=8&year=' . @$purchase[8]['year']) ?>">August</a></td>
                                        <td><?= isset($purchase[8]['total']) ? $purchase[8]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=9&year=' . @$purchase[9]['year']) ?>">September</a></td>
                                        <td><?= isset($purchase[9]['total']) ? $purchase[9]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=10&year=' . @$purchase[10]['year']) ?>">October</a></td>
                                        <td><?= isset($purchase[10]['total']) ? $purchase[10]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=11&year=' . @$purchase[11]['year']) ?>">November</a></td>
                                        <td><?= isset($purchase[11]['total']) ? $purchase[11]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=12&year=' . @$purchase[12]['year']) ?>">December</a></td>
                                        <td><?= isset($purchase[12]['total']) ? $purchase[12]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=1&year=' . @$purchase[1]['year']) ?>">January</a></td>
                                        <td><?= isset($purchase[1]['total']) ? $purchase[1]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=2&year=' . @$purchase[2]['year']) ?>">February</a></td>
                                        <td><?= isset($purchase[2]['total']) ? $purchase[2]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/purchaseReturnItem_voucher_wise?month=3&year=' . @$purchase[3]['year']) ?>">March</a></td>
