...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="post" action="<?= url('Trading/salesReturnItem_monthly') ?>">
                        ...
                        <div class="table-responsive">
                            <table class="table main-table-reference mt-0 mb-0 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=4&year=' . @$sales[4]['year']) ?>">April</a></td>
                                        <td><?= isset($sales[4]['total']) ? $sales[4]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=5&year=' . @$sales[5]['year']) ?>">May</a></td>
                                        <td><?= isset($sales[5]['total'])  ? $sales[5]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=6&year=' . @$sales[6]['year']) ?>">June</a></td>
                                        <td><?= isset($sales[6]['total'])  ? $sales[6]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=7&year=' . @$sales[7]['year']) ?>">July</a></td>
                                        <td><?= isset($sales[7]['total']) ? $sales[7]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=8&year=' . @$sales[8]['year']) ?>">August</a></td>
                                        <td><?= isset($sales[8]['total']) ? $sales[8]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=9&year=' . @$sales[9]['year']) ?>">September</a></td>
                                        <td><?= isset($sales[9]['total']) ? $sales[9]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=10&year=' . @$sales[10]['year']) ?>">October</a></td>
                                        <td><?= isset($sales[10]['total']) ? $sales[10]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=11&year=' . @$sales[11]['year']) ?>">November</a></td>
                                        <td><?= isset($sales[11]['total']) ? $sales[11]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=12&year=' . @$sales[12]['year']) ?>">December</a></td>
                                        <td><?= isset($sales[12]['total']) ? $sales[12]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=1&year=' . @$sales[1]['year']) ?>">January</a></td>
                                        <td><?= isset($sales[1]['total']) ? $sales[1]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=2&year=' . @$sales[2]['year']) ?>">February</a></td>
                                        <td><?= isset($sales[2]['total']) ? $sales[2]['total'] : 0; ?></td>
                                    </tr>

                                    <tr>
                                        <td><a href="<?= url('Trading/salesReturnItem_voucher_wise?month=3&year=' . @$sales[3]['year']) ?>">March</a></td>
