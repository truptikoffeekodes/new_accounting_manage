...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="post" action="<?= url('Trading/sales_voucher') ?>">
                ...
                <div class="table-responsive">
                    <table class="table table-striped mg-b-0">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td><a href="<?= url('Trading/salesItem_monthly?from=' . $date['from'] . '&to=' . $date['to']) ?>">Sales Item</a></td>
                                <td><?= number_format(@$sales['sale_total_rate'], 2) ?></td>
                                <td><?= number_format(@$sales['sale_total_rate'], 2) ?></td>
                            </tr>
                            <!-- <tr>
                                <th scope="row">2</th>
                                <td><a href="<?= url('Trading/SalesGray_monthly?from=' . $date['from'] . '&to=' . $date['to']) ?>">Gray Issue</a></td>
                                <td><?= number_format(@$sales['sale_Gray_total_rate'], 2) ?></td>
                                <td><?= number_format(@$sales['sale_Gray_total_rate'] + @$sales['sale_total_rate'], 2) ?></td>
                            </tr>
                            <tr>
                                <th scope="row">3</th>
                                <td><a href="<?= url('Trading/salesFinish_monthly?from=' . $date['from'] . '&to=' . $date['to']) ?>">Finish Issue</a></td>
                                <td><?= number_format(@$sales['sale_Finish_total_rate'], 2) ?></td>
                                <td><?= number_format(@$sales['sale_Finish_total_rate'] + @$sales['sale_total_rate'] + @$sales['sale_Gray_total_rate'], 2) ?></td>
                            </tr> -->
