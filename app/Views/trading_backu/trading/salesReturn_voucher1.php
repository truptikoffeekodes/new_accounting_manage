...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="post" action="<?= url('Trading/salesReturn_voucher') ?>">
                ...
                <div class="table-responsive">
                    <table class="table table-striped mg-b-0">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td><a href="<?= url('Trading/salesReturnItem_monthly?from=' . $date['from'] . '&to=' . $date['to']) ?>">Sales Return Item</a></td>
                                <td><?= @$sales['saleret_total_rate'] ?></td>
                                <td><?= @$sales['saleret_total_rate'] ?></td>
                            </tr>
