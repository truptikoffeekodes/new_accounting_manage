                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
                                                    <div class="pagination-list" id="pagination_link">
                                                        <ul class="pagination justify-content-center">
                                                            ...
                                                            if ($page > 1) {
                                                            ?>
                                                                <li class="page-item"><a class="page-link" href="<?= url('Trading/salesItem_voucher_wise?month='.@$month.'&year='.@$year.'&page='.($page - 1)) ?>" data-ci-pagination-page="<?= $page - 1 ?>">PREV</a>
                                                                </li>
                                                            <?php
                                                            }
                                                            if ($page > 9) {
                                                            ?>
                                                                <li class="page-item"><a class="page-link" href="<?= url('Trading/salesItem_voucher_wise?month='.@$month.'&year='.@$year.'&page='.($page - 1)) ?>" data-ci-pagination-page="1">1</a></li>
                                                                <li class="blank">...</li>
                                                            <?php
                                                            }
                                                            if ($page - 2 > 0) {
                                                            ?>
                                                                <li class="page-item"><a class="page-link" href="<?= url('Trading/salesItem_voucher_wise?month='.@$month.'&year='.@$year.'&page='.($page - 2)) ?>" data-ci-pagination-page="<?= ($page - 2) ?>"><?= ($page - 2) ?></a>
                                                                </li>
                                                            <?php
                                                            }
                                                            if ($page - 1 > 0) {
                                                            ?>
                                                                <li class="page-item"><a class="page-link" href="<?= url('Trading/salesItem_voucher_wise?month='.@$month.'&year='.@$year.'&page='.($page - 1)) ?>" data-ci-pagination-page="<?= ($page - 1) ?>"><?= ($page - 1) ?></a>
                                                                </li>
                                                            <?php
                                                            }
                                                            ?>
                                                            <li class="page-item"><a class="page-link current" href="<?= url('Trading/salesItem_voucher_wise?month='.@$month.'&year='.@$year.'&page='.($page)) ?>" data-ci-pagination-page="<?= ($page) ?>"><?= $page ?></a>
                                                            </li>
                                                            <?php
                                                            ...
                                                            ?>
                                                                ...
                                                                <li><a class="page-link" href="<?= url('Trading/salesItem_voucher_wise?month='.@$month.'&year='.@$year.'&page='. ($number_of_page)) ?>" data-ci-pagination-page="<?= ($number_of_page) ?>"><?= $number_of_page ?></a>
                                                                </li>
                                                            <?php
                                                            }
                                                            if ($page < $number_of_page) {
                                                            ?>
                                                                <li class="page-item"><a class="page-link" href="<?= url('Trading/salesItem_voucher_wise?month='.@$month.'&year='.@$year.'&page='. ($page + 1)) ?>" data-ci-pagination-page="<?= ($page + 1) ?>">Next</a>
                                                                </li>
                                                            <?php
                                                            }
                                                            ?>
