...
<div class="responsive-background">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="advanced-search">
            <form method="post" action="<?=url('Trading/pl_dashboard')?>" autocomplete = "off">
                                        ...
                                        <table class="table">
                                            ...
                                            <?php if(!empty($value['sub_categories'])) {
                                                        foreach(@$value['sub_categories'] as $sub_key => $sub_value){
                                                            ...
                                                            ?>
                                                          <tr>
                                                                <td><a href = "<?=url('Trading/get_expence_sub_grp?'.'id='.$sub_key.'&name='.$sub_value['name'].'&from='.$trading['from'].'&to='.$trading['to'].'&type=pl')?>"><?=$sub_value['name']?></a></td>
                                        ...
                                        <table class="table">
                                            ...
                                            <?php if(!empty($value['sub_categories'])) {
                                                        foreach(@$value['sub_categories'] as $sub_key => $sub_value){
                                                            ...
                                                            ?>
                                                          <tr>
                                                                <td><a href = "<?=url('trading/get_income_sub_grp?id='.$sub_key.'&name='.$sub_value['name'].'&from='.$trading['from'].'&to='.$trading['to'].'&type=pl')?>"><?=$sub_value['name']?></a></td>
                                                                <td><?=number_format($total,2) ?>
                                                                </td>
                                                                <td> </td>
                                                            </tr>
