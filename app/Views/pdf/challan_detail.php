...
<body>
    ...
    <table class="center" border="1">
        ...
        <tr>
            ...
            <td colspan="2">
                Challan No &ensp; : &ensp;<?=@$challan['challan_no']?>
                <br> Challan Date &ensp; : &ensp;<?=@$challan['challan_date']?>
        ...
        <tr>
            ...
            <td colspan="9">CHALLAN NO &ensp;-&ensp;<?=@$challan['challan_no']?>
                <br>DATE &ensp;-&ensp; <?=@$challan_detail['challan_date']?>
            </td>
        </tr>
        <tr>
        ...
        <?php
                     if ($challan['disc_type'] == '%') {
                        ...
                        $disc_avg_per = $challan['discount'] / $total;
                    }
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: right;"><b><?=@$challan['round_diff']?></b></td>
        </tr>
        <tr>
