...
<body>
    ...
    <table class="center" border="1">
        ...
        <tr>
            ...
            <td colspan="9">RETURN NO &ensp;-&ensp;<?=@$s_return['return_no']?>
                <br>DATE &ensp;-&ensp; <?=@$s_return['return_date']?>
            </td>
        </tr>
        <tr>
        ...
        <?php
                     if ($s_return['disc_type'] == '%') {
                        ...
                        $disc_avg_per = (float)$s_return['discount'] / $total;
                    }
                    ...
                    if ($s_return['amty'] > 0) {
                        if ($s_return['amty_type'] == '%') {
                            ...
                            $add_amt_per = (float)$s_return['amty'] / $total;
                        }
                    } else {
                        $add_amt_per = 0;
                    }
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: right;"><b><?=@$s_return['round_diff']?></b></td>
        </tr>
        <tr>
