...
<body>
    ...
    <table class="center" border="1">
        ...
        <tr>
            ...
            <td colspan="4">
                Challan No &ensp; : &ensp;<?=@$purchaseinvoice['challan_no']?>
                <br> Challan Date &ensp; : &ensp;<?=@$purchaseinvoice['challan_date']?>
                <br> Invoice No &ensp; : &ensp;<?=@$purchaseinvoice['invoice_no']?>
                <br> Invoice Date &ensp;: &ensp;<?=@$purchaseinvoice['invoice_date']?>
        ...
        <tr>
            ...
            <td colspan="9">CHALLAN NO &ensp;-&ensp;<?=@$purchaseinvoice['challan_no']?>
                <br>DATE &ensp;-&ensp; <?=@$purchaseinvoice['challan_date']?>
            </td>
        </tr>
        <tr>
        ...
        <?php
                     if ($purchaseinvoice['disc_type'] == '%') {
                        ...
                        $disc_avg_per = $purchaseinvoice['discount'] / $total;
                    }
