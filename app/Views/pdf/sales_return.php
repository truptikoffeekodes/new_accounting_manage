...
<body>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="3">Ship To : <?=@$delivery['name']?>
                    <br><?=@$account['gst_add']?>
                    <br><?=@$s_return['ship_city']?> &nbsp;<?=@$s_return['ship_pin']?>
                    <br><?=@$s_return['ship_state']?>
                    <br><?=@$s_return['ship_country']?>
            ...
            <tr>
                <td colspan="4">Broker :<?=@$s_return['broker_name']?></td>
                <td colspan="5">Transporter Name :<?=@$transport['name']?></td>
            </tr>
            <tr>
                <td colspan="3">
                    L.R.No :<?=@$s_return['lr_no']?>
                    <br>Transport :
                </td>
                <td colspan="3">L.R.Date : <?=@$s_return['lr_date']?>
                    <br>Transport Type : <?=@$s_return['transport_mode']?>
                </td>
    ...
    <table class="T-border2" style="width:100%">
        ...
        <tr>
            ...
            <td style="border-right: 1px solid black; border-top: 1px solid black;text-align: right;"> <b><?=@$s_return['round_diff']?></b><br>
            </td>
