...
<body>
    ...
    <table class="center" border="1">
        ...
        <tr>
            ...
            <td colspan="4">
                Return No &ensp; : &ensp;<?=@$p_return['return_no']?>
                <br> Return Date &ensp; : &ensp;<?=@$p_return['return_date']?>
        ...
        <tr>
            ...
            <td colspan="9">RETURN NO &ensp;-&ensp;<?=@$p_return['return_no']?>
                <br>DATE &ensp;-&ensp; <?=@$p_return['return_date']?>
            </td>
        </tr>
        <tr>
        ...
        <?php
                     if ($p_return['disc_type'] == '%') {
                        $discount_amount = ($total * ($p_return['discount'] / 100));
                        $disc_avg_per = $discount_amount / $total;
                    } else {
                        $disc_avg_per = $p_return['discount'] / $total;
                    }
                
                    if ($p_return['amty'] > 0) {
                        if ($p_return['amty_type'] == '%') {
                            $amty_amount = ($total * ($p_return['amty'] / 100));
                            $add_amt_per = $amty_amount / $total;
                        } else {
                            $add_amt_per = $p_return['amty'] / $total;
                        }
                    } else {
                        $add_amt_per = 0;
                    }
