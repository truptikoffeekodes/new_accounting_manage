    ...
    <table class="center" border="1">
        ...
        <tr>
            ...
            <td colspan="4">
                ...
                <br> Invoice No &ensp; : &ensp;<?=@$invoice['invoice_no']?>
                <br> Invoice Date &ensp;: &ensp;<?=@$invoice['invoice_date']?>
        ...
        <tr>
            ...
            <td colspan="7">INVOICE NO &ensp;-&ensp;<?=@$invoice['invoice_no']?>
                <br>DATE &ensp;-&ensp; <?=@$invoice['invoice_date']?>
            </td>
        </tr>
        <tr>
        ...
        <?php
                    ...
                    $grand_total = $total - $invoice['discount'] + $invoice['amty'] + @$invoice['tot_igst'];
            
                    ?>
        <tr>
            <td colspan="2"> Less: Discount </td>
            <td colspan="2" style="text-align: right;"><b>(-)<?=@$invoice['discount'];?></b></td>

        </tr>
        <tr>
            <td colspan="2"> Add: Amount : </td>
            <td colspan="2" style="text-align: right;"><b>(+)<?=@$invoice['amty']?></b></td>
        ...
        //foreach ($tax as $row) {
            ...
            if ($tax[0] == 'igst' && session('state') != @$invoice['acc_state']) {
            
        ?>
         <tr>
            <td rowspan="2" colspan="2"> Igst : </td>
            <td rowspan="2" colspan="2" style="text-align: right;"><?=@$invoice['tot_igst'];?></td>
        </tr>
        <?php
            }
            else
        ...
        ?>
         <tr>
            ...
            <td colspan="2" style="text-align: right;"><?=@$invoice['tot_cgst'];?></td>
        </tr>
        <tr>
            <td colspan="2"> Sgst : </td>
            <td colspan="2" style="text-align: right;"><?=@$invoice['tot_sgst'];?></td>
        </tr>
        <?php
            }
        ?>
