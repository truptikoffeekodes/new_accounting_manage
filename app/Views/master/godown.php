    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Godown</li>
            </ol>
        </div>
        <div class="btn btn-list">
            <<a data-toggle="modal" href="<?=url('Master/add_godown')?>" data-target="#fm_model" data-title="Add Godown" class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>            
        </div>
    </div>
    <!-- End Page Header -->
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="godown" data-module="Master" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
