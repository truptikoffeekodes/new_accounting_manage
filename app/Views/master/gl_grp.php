...
<?= $this->section('content') ?>
 ...
 <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5"> Master </h2>
            <ol class="breadcrumb">
        ...
        <a data-toggle="modal" href="<?= url('Master/add_glgrp') ?>" data-target="#fm_model" data-title="Add New GL Group " class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>
        </div>
    </div>
    <!-- End Page Header -->
    <div class="row">
                ...
                <div class="card-header card-header-divider">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="glgrp" data-module="master" data-filter_data=''>
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Code</th>
