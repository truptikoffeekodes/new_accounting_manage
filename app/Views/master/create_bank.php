    ...
    <div class="col-lg-12">
        <form action="<?= url('master/add_bank') ?>" class="ajax-form-submit" method="post"
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="name" style="text-transform: capitalize;" value="<?=@$bank['name']?>"  placeholder="Enter Bank Name" required=""
                    type="text">
            </div>
            
            <!-- <div class="form-group">
                <label class="form-label">IFSC: <span class="tx-danger">*</span></label>
                <input class="form-control" name="ifsc" oninput="this.value = this.value.toUpperCase()" style="text-transform: capitalize;" value="<?=@$bank['ifsc']?>"  placeholder="Enter IFSC" required=""
                    type="text">
            ...
            <!-- <div class="form-group">
                ...
                <input class="form-control" name="branch_name" oninput="this.value = this.value.toUpperCase()" value="<?=@$bank['branch_name']?>" placeholder="Enter Branch Name"
                     type="text">
            </div>
            <div class="form-group">
                <label class="form-label">AC No:<span class="tx-danger">*</span></label>
                <input class="form-control" name="ac_no" onkeypress="return isNumberKey(event)" value="<?=@$bank['ac_no']?>" placeholder="Enter Account Number"
                    required type="text">
            </div> -->
            <div class="form-group">
