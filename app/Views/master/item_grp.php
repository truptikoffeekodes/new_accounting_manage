...
<?= $this->section('content') ?>
 ...
 <!-- Page Header -->
    <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5"> Item </h2>
            <ol class="breadcrumb">
        ...
        <div class="btn btn-list">
            <a data-toggle="modal" data-target="#fm_model" data-title="Add Item Group" href="<?=url('Master/add_itemgrp')?>"   class="btn ripple btn-primary"><i class="fe fe-external-link"></i>Add New</a>
        </div>
    </div>
<!-- End Page Header -->
    <div class="row">
                ...
                <div class="card-header card-header-divider">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="itemgrp" data-module="master" data-filter_data=''>
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Code</th>
