...
<div class="row">
    ...
    <form action="<?=url('Master/add_tds')?>" class="ajax-form-submit" method="post"
            ...
            <div class="form-group">
                ...
                <input class="form-control" required placeholder="Enter Indv / HUF" value="<?=@$tds['indv']?>" name="indv" 
                    type="text">
            </div>
            <div class="form-group">
                <label class="form-label">Others: <span class="tx-danger">*</span></label>
                <input class="form-control" required placeholder="Enter Othes" value="<?=@$tds['others']?>" name="others" 
                    type="text">
            </div>
            <div class="form-group">
