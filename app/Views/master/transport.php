...
<div class="page-header">
    <div>
        <h2 class="main-content-title ">Transport</h2>
        <ol class="breadcrumb">
    ...
    <div class="btn btn-list">
        <a data-target="#fm_model" data-toggle="modal" data-title="Add Transport"
            href="<?=url('Master/add_transport')?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i>
            Add New </a>
    </div>
</div>
<!-- End Page Header -->
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="transport" data-module="Master" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
