...
<?= $this->section('content') ?>
    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Trasaction</a></li>
                <li class="breadcrumb-item active" aria-current="page"><?=$title?></li>
            </ol>
        </div>
        <div class="btn btn-list">
            <a  href="<?=url('master/add_bankreceipt')?>"  class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New </a>
        </div>
    </div>
    <!-- End Page Header -->
    <div class="row">
                ...
                <div class="card-header card-header-divider">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="bankreceipt" data-module="master" data-filter_data=''>
                                <thead>
                                    <tr>
                                    <th>Id</th>
