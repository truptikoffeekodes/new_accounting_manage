    ...
    <div class="col-lg-12">
        <div class="card custom-card">
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <form action="<?= url('Sales/add_salesreturn') ?>" class="ajax-form-submit-return" method="POST"
                        id="returnform">
                        <div class="row">
                            ...
                            <div class="col-lg-3 form-group">
                                ...
                                <input class="form-control" readonly type="text" name="return_no"
                                    value="<?= @$s_return['return_no'] ? $s_return['return_no'] : @$current_id; ?>">
                            </div>
                            ...
                            <div class="col-lg-3 form-group">
                                ...
                                <input class="form-control fc-datepicker" placeholder="YYYY-MM-DD" type="text"
                                    name="return_date"
                                    value="<?= @$s_return['return_date'] ? $s_return['return_date'] : date('Y-m-d'); ?>">
                            </div>
                            <div class="col-lg-3 form-group">
                                <label class="form-label">Supplier Invoice No:</label>
                                <input class="form-control" type="text" placeholder="Enter Supplier Invoice"
                                    name="supp_inv" value="<?= @$s_return['supp_inv'] ? $s_return['supp_inv'] : ''; ?>">
                            </div>
                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    <div class="row col-md-12 form-group">
                                        ...
                                        <input type="hidden" name="bank_holder"
                                            value="<?= @$s_return['bank_holder']; ?>">
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        <tr class="item_row">
                                            ...
                                            <?php
                                                    ...
                                                    {
                                                    ?>
                                            <td><input class="form-control input-sm" value="0" name="igst[]"
                                                    onchange="calculate()" onkeypress="return isDesimalNumberKey(event)"
                                                    onkeyup="calc_gst_per(this)" type="text" readonly>
                                                <input name="igst_amt[]" value="0" type="hidden">
                                            </td>

                                            <td><input class="form-control input-sm" value="0" name="cgst[]"
                                                    onchange="calculate()" onkeypress="return isDesimalNumberKey(event)"
                                                    type="text" readonly>
                                                <input name="cgst_amt[]" value="0" type="hidden">
                                            </td>

                                            <td><input class="form-control input-sm" value="0" name="sgst[]"
                                                    onchange="calculate()" onkeypress="return isDesimalNumberKey(event)"
                                                    type="text" readonly>
                                            ...
                                            <td><input class="form-control input-sm" value="<?= $row['item_disc'] ?>"
                                                    ...
                                                    class="itm_disc_amt"></b> <input type="hidden"
                                                    name="item_discount_hidden[]" class="hidden_discount"
                                                    value="<?= @$row['discount'] ?>">
                                            ...
                                            <td><input class="form-control input-sm" value="0" name="item_disc[]"
                                                ...
                                                <input type="hidden" name="item_discount_hidden[]"
                                                    class="hidden_discount" value="<?= @$row['discount'] ?>">
                                                <input type="hidden" name="item_added_amt_hidden[]"
                                                    class="hidden_added_amt" value="<?= $row['added_amt'] ?>">
                                            </td>
                                            <?php
                        ...
                        <div class="row mt-3">
                            <input class="btn btn-space btn-primary btn-product-submit" id="save_data_return"
...
$(document).ready(function() {
    ...
    $('#code').on('select2:select', function(e) {
        ...
        if (pids_item.includes(parseInt(suggestion.id)) == false) {
            ...
            if (suggestion.price.taxability == 'N/A') {
                tds +=
                    '<td><input class="form-control input-sm" value="0" name="igst[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" onkeyup="calc_gst_per(this)" type="text" readonly><input type="hidden" name="igst_amt[]" value="0"></td>';
                tds +=
                    '<td><input class="form-control input-sm" value="0" name="cgst[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" onkeyup="calc_gst_per(this)" type="text" readonly><input type="hidden" name="cgst_amt[]" value="0"></td>';
                tds +=
                    '<td><input class="form-control input-sm" value="0" name="sgst[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" onkeyup="calc_gst_per(this)" type="text" readonly><input type="hidden" name="sgst_amt[]" value="0"></td>';
    ...
    $('#code_new').on('select2:select', function(e) {
        ...
        if (pids_exp.includes(parseInt(suggestion.id)) == false) {
            ...
            tds += '<td><a class="tx-danger btnDelete" data-id="' + suggestion.id +
                '" title="0"><i class="fa fa-times tx-danger"></i></a></td>';
            tds += '<td colspan="4">' + suggestion.text + inp + taxability + expence + qty +
                item_disc +
                uom + hsn + '</td>';
            ...
            tds +=
                '<td><input type="hidden" name="item_discount_hidden[]" class="hidden_discount"><input type="hidden" name="item_added_amt_hidden[]" class="hidden_added_amt"></td>';
            tds +=
