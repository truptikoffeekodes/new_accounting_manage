                        ...
                        <div class="card-body">
                            <form action="<?= url('Sales/add_ACinvoice/') . (@$invoice['v_type'] ? @$invoice['v_type'] : $type) ?>" class="ajax-form-submit-sale" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 form-group" id="sales_return_div" style="display:<?= (@$invoice['v_type'] == "return") ? 'inline-grid;' : 'none;' ?>">
                                        <label class="form-label">Voucher Name : </label>
                                        <select class="form-control" id="sales_return" name='voucher_type'>
                                            <?php if (@$invoice['voucher_type']) { ?>
                                                <option value="<?= @$invoice['voucher_type'] ?>">
                                                    <?= @$invoice['voucher_name'] ?>
                                                </option>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered mg-b-0">
                                                    <thead>
                                                        ...
                                                        <th class="wd-300">
                                                            <div class="input-group">
                                                                <input class="form-control" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="discount" value="<?= @$invoice['discount'] ?>" type="text">
                                                                <div class="input-group-prepend">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group">
                                                                    <input class="form-control" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="amty" value="<?= @$invoice['amty'] ?>" type="text">
                                                                    <div class="input-group-prepend">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="2"><input name="taxable" value="<?= @$invoice['taxable'] ?>" class="form-control input-sm" type="text" readonly>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                            ...
                                                            <th colspan="2" class="wd-300">
                                                                <div class="input-group-sm">
                                                                    <select class="select2" id="tax" name="taxes[]" onchange="calculate()" multiple>
                                                                        <?php
                                                                        foreach ($tax as $row) {
                                                                            if ($row['name'] == 'igst' && session('state') != @$invoice['acc_state']) {
                                                                        ?>
                                                                            ...
                                                                            <?php } else if ($row['name'] == 'cgst' && session('state') == @$invoice['acc_state']) { ?>
                                                                            ...
                                                                            <?php } else if ($row['name'] == 'sgst' && session('state') == @$invoice['acc_state']) { ?>
                                                        ...
                                                        <tr id="tds" style="display:<?php if (!empty($taxes)) {
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group-sm">
                                                                    <input class="form-control" readonly onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="tds_amt" type="text" value="<?= @$invoice['tds_amt']; ?>">
                                                        ...
                                                        <tr id="cess" style="display:<?php if (!empty($taxes)) {
                                                            ...
                                                            <th class="wd-300">
                                                                <div class="input-group">
                                                                    <input class="form-control" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" name="cess" type="text" value="<?= @$invoice['cess']; ?>">
                                                                    <div class="input-group-prepend">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th><input class="form-control input-sm" name="round_diff" type="text" onchange="calculate()" value="<?= @$invoice['round_diff'] ?>"></th>
                                                            <td class="wd-90 cr_dr_round"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Net Amount</td>
                                                            <td colspan="2"><input class="form-control input-sm" name="net_amount" type="text" value="<?= @$invoice['net_amount']; ?>" readonly>
                                                            </td>
                                                        </tr>
                                                    </thead>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if (v_type == 'return') {
            ...
            $("#sales_return").attr("disabled","disabled")
        }
