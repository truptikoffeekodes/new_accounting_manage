...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a href="<?= url('sales/add_ACinvoice/general') ?>" class="btn ripple btn-primary"><i
                class="fe fe-external-link"></i>
            Add New General</a>
        <a href="<?= url('sales/add_ACinvoice/return') ?>" class="btn ripple btn-danger"><i
                class="fe fe-external-link"></i>
            Add New Return</a>
    </div>
            ...
            <div class="card-header card-header-divider">
                ...
                <div class="card-body tab-content h-100">
                    <div class="tab-pane active" id="general">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                                data-id="ac_invoice" data-module="sales" data-filter_data='general'>
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Voucher Type</th>
                    ...
                    <div class="tab-pane" id="return_div">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover" id="table_list_data1" data-id="ac_invoice"
                                data-module="sales" data-filter_data="return">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Voucher Type</th>
    ...
    $("#table_list_data1").DataTable({
        ...
        "ajax": {
            ...
            "url": PATH + "/" + $("#table_list_data1").data('module') + "/GetData/" + $("#table_list_data1")
                .data('id') + '?filter_data=' + $("#table_list_data1").data('filter_data')
        },
        "lengthMenu": [
            [10, 25, 50, 100, 200, 300, -1],
            [10, 25, 50, 100, 200, 300, "All"]
...
function editable_os(data_edit) {
    ...
    swal({
        ...
        if (result.value != undefined && result.value != '') {
            $.post(PATH + "/Sales/Action/Update", _data, function(data) {
