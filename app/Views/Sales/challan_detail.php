            ...
            <div class="card-header card-header-divider">
                ...
                <div class="row">
                        <div class="col-lg-2 form-group">
                            <h4><label class="form-label">Challan No: <b><?= @$challan['id']?></b> </label></h4>
                        </div>
                        <div class="col-lg-2 form-group">
                            <h4><label class="form-label"> Date: <b><?= @$challan['challan_date']?></b></label>
                            </h4>
                        </div>
                        <div class="col-lg-2 form-group">
                        ...
                        <div class="col-md-4 form-group">
                            <div class="row">
                                ...
                                <div class="col-md-8 form-group">
                                    <label
                                        class="form-label "><b><?=@$challan['account_name']; ?><?=@$challan['gst_no']; ?></b>
                                    </label>
                                </div>
                                ...
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['gst']; ?></b>
                                    </label>
                                </div>
                                <div class="col-md-3 form-group">
                                ...
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['broker_name']; ?></b> </label>
                                </div>
                                <div class="col-md-3 form-group">
                                    <label class="form-label">Other: </label>
                                </div>
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['other']; ?></b> </label>
                                </div>
                        ...
                        <div class="col-md-4 form-group">
                            <div class="row">
                                ...
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['party_bill']; ?></b> </label>
                                </div> -->
                                <div class="col-md-3 form-group">
                                    <label class="form-label">Weight: </label>
                                </div>
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['weight']; ?></b> </label>
                                </div>
                                ...
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['freight']; ?></b> </label>
                                </div>
                                <div class="col-md-3 form-group">
                                    <label class="form-label">Delievery Ac: </label>
                                </div>
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['delivery_name']; ?></b> </label>
                                </div>
                                <div class="col-md-3 form-group">
                                    <label class="form-label">LR No: </label>
                                </div>
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['lr_no']; ?></b> </label>
                                </div>
                                <div class="col-md-3 form-group">
                                    <label class="form-label">Vehicle: </label>
                                </div>
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['vehicle_name']; ?></b> </label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 form-group">
                            <div class="row">
                                ...
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['lr_date']; ?></b> </label>
                                </div>
                                ...
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['transport_name']; ?></b>
                                    </label>
                                </div>
                                <div class="col-md-3 form-group">
                                ...
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['transport_mode']; ?></b>
                                    </label>
                                </div>
                                ...
                                <div class="col-md-8 form-group">
                                    <label class="form-label "><b><?=@$challan['city_name']; ?></b> </label>
                                </div>
