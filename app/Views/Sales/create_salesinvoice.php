        ...
        $('#get_challan').on('select2:select', function(e) {
            ...
            for (i = 0; i < item.length; i++) {
                if (item[i]['is_expence'] == 0) {
                    //update trupti 10-12-2022
                    if (pids_item.includes(parseInt(item[i]['id'])) == false) {
                        $('.product_error').html('');
                        ...
                        tds +=
                            ...
                            item[i].item_disc + '" type="text" ><b class="itm_disc_amt"></b><input type="hidden" name="item_discount_hidden[]" class="hidden_itm_disc_amt" value="' + item[i].discount + '"><input type="hidden" value="' + item[i].divide_disc + '" name="item_per[]" class="item_per"><input type="hidden" name="divide_disc_amt[]" value="' + item[i].divide_disc_amt + '" class="divide_disc_amt"><input type="hidden" name="item_added_amt_hidden[]" class="hidden_added_amt" value="' + item[i].added_amt + '"></td>';
                    ...
                    //update trupti 10-12-2022
                    if (pids_exp.includes(parseInt(item[i]['id'])) == false) {
                        $('.product_error_new').html('');
                        ...
                        tds += '<td colspan="4">' + item[i].name + '(' + item[i].code + ')' + inp + taxability +
                            expence + qty + item_disc + uom + hsn + item_per + divide_disc_amt +
                            '</td>';
                        tds += '<td><input class="form-control input-sm" value="' + item[i].rate +
                            '" name="price[]" onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" value="0"   ="" type="text"></td>';
                        ...
                        tds +=
                            '<td><input type="hidden" name="item_discount_hidden[]" class="hidden_itm_disc_amt" value="' + item[i].discount + '"><input type="hidden" name="item_added_amt_hidden[]" class="hidden_added_amt" value="' + item[i].added_amt + '"></td>';
