...
<?= $this->section('content') ?>
 ...
 <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5"> Sales Challan </h2>
            <ol class="breadcrumb">
        ...
        <div class="btn btn-list">
            <a href="<?=url('Sales/add_challan')?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>
        </div>
</div>
<div class="row">
        <div class="col-lg-12">
                ...
                <div class="card-header card-header-divider">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="challan" data-module="Sales" data-filter_data=''>
                                <thead>
                                    <tr>
                                        <th>Challan Id</th>
                                        <th>Colorsoul ID</th>
...
<script type="text/javascript">
    ...
    function editable_os(data_edit) {
        ...
        var str = 'Do You Want to Cancle This Challan..!';
        var ot_title = $(data_edit).attr('title');
        var pkno = $(data_edit).data('pk');
        swal({
