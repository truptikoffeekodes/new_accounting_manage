...
<div class="responsive-background">
    <div class="navbar-collapse collapse show" id="navbarSupportedContent" style="">
        <form action ="<?=url('MillingReport/mill_issue_BrokerWise_report')?>" method="POST">
            <div class="advanced-search">
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-secondary" href="<?=url('MillingReport/mill_issue_BrokerWise_report')?>">Reset</a>
                </div>
            </div>
        </form>
    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table  table-hover table-fw-widget voucher">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?=user_date(@$row['challan_date'])?></td>
                                        <td><a href ="<?=url('Milling/Add_millSend/').$row['mill_id']?>"><?=@$row['mill_id']?></a></td>
                                        <td><?=@$row['mill_name']?></td>
                                        <td><?=@$row['name']?></td>
                                        <td><?=@$row['hsn']?></td>
