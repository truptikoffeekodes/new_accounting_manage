...
<div class="responsive-background">
    <div class="navbar-collapse collapse show" id="navbarSupportedContent" style="">
        <form action="<?=url('MillingReport/finish_issue_BrokerWise_report')?>" method="POST">
            <div class="advanced-search">
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-secondary" href="<?=url('MillingReport/finish_issue_BrokerWise_report')?>">Reset</a>
                </div>
            </div>
        </form>
    </div>
