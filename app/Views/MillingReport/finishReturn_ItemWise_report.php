...
<div class="responsive-background">
    <div class="navbar-collapse collapse show" id="navbarSupportedContent" style="">
        <form action="<?=url('MillingReport/finish_return_ItemWise_report')?>" method="POST">
            <div class="advanced-search">
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-secondary" href="<?=url('MillingReport/finish_return_ItemWise_report')?>">Reset</a>
                </div>
            </div>
        </form>
    </div>
                        ...
                        <div class="row">
                            <table class="col-6 table table-hover table-fw-widget voucher">
                                <thead>
                                    ...
                                    <tr>
                                    <tr>
                                        <td colspan="2"><b>HSN : </b></td>
                                        <td colspan="5"><?=$rw['hsn']?></td>
                                    <tr>
                                    <!-- <tr>
                                        <td colspan="2"><b>ID : </b></td>
                                        <td colspan="5"><?=@$rw['id']?></td>
                                    <tr> -->
                        ...
                        <table class="table  table-hover table-fw-widget voucher">
                            ...
                            <thead>
                                <tr style="border-top:1px solid #e1e6f1;">
                                    ...
                                    <th>SR. No.</th>
                                    <th style="width:12%;">Weaver A/C</th>
