...
<div class="responsive-background">
    <div class="navbar-collapse collapse show" id="navbarSupportedContent" style="">
        <form action ="<?=url('MillingReport/mill_received_BrokerWise_report')?>" method="POST">
            <div class="advanced-search">
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-secondary" href="<?=url('MillingReport/mill_received_BrokerWise_report')?>">Reset</a>
                </div>
            </div>
        </form>
    </div>
                        ...
                        <table class="table  table-hover table-fw-widget voucher">
                                ...
                                <thead>
                                    <tr style="border-top:1px solid #e1e6f1;">
                                        ...
                                        <th style="width:10%;">Mill A/c</th>
                                        <th style="width:14%;">Item</th>
                                        <th style="width:4%;">HSN</th>
                                        <th style="width:7%;">WAREHOUSE</th>
                                        <th style="width:4%;">TAKA</th>
                                        <th style="width:5%;">Meter</th>
                                        <th style="width:4%;">Shortage</th>
                                ...
                                <tbody>
                                    ...
                                    foreach($rw['data'] as $row){
                                        $total_pcs +=$row['rec_pcs'];     
                                        $total_meter +=$row['rec_meter'];     
                                        $total_cut +=$row['cut'];     
                                    ...
                                    <tr>
                                        ...
                                        <td><a href ="<?=url('Milling/add_rec_mill/').$row['mill_id']?>"><?=@$row['id']?></a></td>
                                        <td><?=@$row['mill_name']?> </td>
                                        <td><?=@$row['name']?> <br>(<b><?=@$row['screen_name']?></b>)</td>
                                        <td><?=@$row['hsn']?></td>
                                        ...
                                        <td><?=@$row['tot_igst']?><br>(<?=(float)$row['gst']?>%)</td>
                                        <td></td>
                                        <td></td>
                                        <td><?=@$row['tot_igst']?></td>
                                        ...
                                        <?php }else{ ?>
                                        <td></td>
                                        <td><?=(float)$row['tot_cgst'] ?><br>(<?=(float)$row['gst']/2?>%)</td>
                                        <td><?=(float)$row['tot_sgst']?><br>(<?=(float)$row['gst']/2?>%)</td>
