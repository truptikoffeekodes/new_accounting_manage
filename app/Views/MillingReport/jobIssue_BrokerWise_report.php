...
<div class="responsive-background">
    <div class="navbar-collapse collapse show" id="navbarSupportedContent" style="">
        <form action ="<?=url('MillingReport/job_issue_BrokerWise_report')?>" method="POST">
            <div class="advanced-search">
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-secondary" href="<?=url('MillingReport/job_issue_BrokerWise_report')?>">Reset</a>
                </div>
            </div>
        </form>
    </div>
                        ...
                        <table class="table  table-hover table-fw-widget voucher">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href ="<?=url('Milling/Add_jobwork/').$row['job_id']?>"><?=@$row['job_id']?></a></td>
