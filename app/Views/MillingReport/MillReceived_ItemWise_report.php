...
<div class="responsive-background">
    <div class="navbar-collapse collapse show" id="navbarSupportedContent" style="">
        <form action ="<?=url('MillingReport/mill_received_ItemWise_report')?>" method="POST">
            <div class="advanced-search">
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-secondary" href="<?=url('MillingReport/mill_received_ItemWise_report')?>">Reset</a>
                </div>
            </div>
        </form>
    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-hover table-fw-widget voucher">
                            <thead>
                                    <tr>
                                        <td><b>Item : </b><?=$rw['name']?></td>
                                        <td colspan="2"></td>
                                    <tr>
                                    <tr>
                                        <td><b>HSN : </b><?=$rw['hsn']?></td>
                                        <td colspan="2"></td>
                                    <tr>
                            </thead>
                        </table>
...
<?= $this->endSection() ?>MillReceived_ItemWise_report