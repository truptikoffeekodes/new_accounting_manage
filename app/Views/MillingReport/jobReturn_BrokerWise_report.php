...
<div class="responsive-background">
    <div class="navbar-collapse collapse show" id="navbarSupportedContent" style="">
        <form action ="<?=url('MillingReport/job_return_BrokerWise_report')?>" method="POST">
            ...
            <div class="row align-items-center mg-b-25">
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-secondary" href="<?=url('MillingReport/job_return_BrokerWise_report')?>">Reset</a>
                </div>
            </div>
        </form>
    </div>
