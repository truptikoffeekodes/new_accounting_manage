                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="sendJob_ItemWise" data-module="MillingReport" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th style="border:0px;"></th>
                                    <th style="border:0px;"></th>
                                    <th style="border:0px;"></th>
                                    <th colspan="3"><b><center>Jobwork Issue</center></b></th>
                                    <th colspan="2"><b><center>Jobwork Return</center></b></th>
                                    <th colspan="2"><b><center>Jobwork Received</center></b></th>
