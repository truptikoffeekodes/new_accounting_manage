...
<?= $this->section('content') ?>
 ...
 <div class="page-header">
        ...
        <div class="btn btn-list">
            <a href="<?=url('company/CreateCompany')?>"   class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>
        </div>
</div>
<div class="row">
    <div class="col-lg-12">
                ...
                <div class="card-header card-header-divider">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="company" data-module="Company" data-filter_data=''>
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Name</th>
