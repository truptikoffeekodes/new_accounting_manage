...
<div class="page-header">
    <div>
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Company Group</a></li>
            <li class="breadcrumb-item active" aria-current="page"><?=$title?></li>
        </ol>
    </div>
    <div class="btn btn-list">
        <a data-toggle="modal" data-target="#fm_model" href="<?=url('Company/create_companygrp')?>" data-title="Add Company Group" class="btn ripple btn-primary"><i
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="companygrp" data-module="Company" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Code</th>
