...
<?= $this->section('content') ?>
 ...
 <div class="page-header">
        ...
        <div class="btn btn-list">
            <a data-toggle="modal" href="<?=url('User/create_user')?>" data-target="#fm_model" data-title="Add User" class="btn ripple btn-primary"><i class="fe fe-external-link"></i> Add New</a>            
        </div>
</div>
<div class="row">
    <div class="col-lg-12">
                ...
                <div class="card-header card-header-divider">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="user" data-module="User" data-filter_data=''>
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>User Name</th>
...
<script type="text/javascript">
    ...
    function editable_os(data_edit) {
        ...
        var str = 'Do You Want to Block This User..!!';
        var ot_title = $(data_edit).attr('title');
        var pkno = $(data_edit).data('pk');
        var select_input = {
            "1": "Blocked",
        ...
        swal({
            ...
            if (result.value != undefined && result.value != '') {
                $.post(PATH + "/User/Action/Update", _data, function(data) {
                    ...
                    if (data.st == 'success') {
                        ...
                        swal("success!", "User Update successfully!", "success");
                    }
