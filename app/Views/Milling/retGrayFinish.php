...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a href="<?= url('Milling/Add_retGrayFinish') ?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i>
            Add New</a>
    </div>
</div>
<!-- End Page Header -->
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data"
                            data-id="retGrayFinish" data-module="Milling" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>SR No</th>
                ...
                if (data_val != undefined && data_val != '') {
                    $.post(PATH + "/" + $("#table_list_data").data('module') + "/Action/Update", _data, function(data) {
                        ...
                        if (data.st == 'success') {
                            ...
                            swal.fire("Error!", "Your file has been NOT Cancelled ", "error");
                        }
