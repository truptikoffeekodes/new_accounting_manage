...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a href="<?= url('Milling/Add_return_jobwork') ?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i>
            Add New</a>
    </div>
</div>
            ...
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget voucher" id="table_list_data"
                            data-id="return_jobwork" data-module="Milling" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>SR No</th>
                                    <th>Weaver Invoice</th>
                                    <th>Date</th>
                                    <th>Jobwrok / Party Name</th>
                                    <th>Item Name</th>
                                    <th>Total PCS</th>
                                    <th>Total Meter</th>
                                    <th>Price</th>
        ...
        if (result.value) {
            ...
            if (data_val != undefined && data_val != '') {
                $.post(PATH + "/" + $("#table_list_data").data('module') + "/Action/Update", _data, function(
                    ...
                    if (data.st == 'success') {
                        datatable_load('');
                        swal.fire("Cancled!", "Your imaginary file has been Cancled.", "success");
                        datatable_load('');
                    }
                });
            }
