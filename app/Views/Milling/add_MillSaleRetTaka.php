                ...
                <table class="table table-bordered mg-b-0">
                    ...
                    if(!empty($sale_taka))
                    {
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><input type="checkbox" class="checkItem" name="check[]" onclick = "calc_qty(this)" value="<?=@$sale_taka[$i]['taka_no']?>" <?=(@$sale_taka[$i]['is_return']==1) ? 'checked' : ''?> ></td>
