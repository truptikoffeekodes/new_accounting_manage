...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Gray/Finish Sale Challan Sr No
                :</span><?= isset($challan['id']) ? @$challan['id'] : $current_id; ?></h2>
    </div>
                    ...
                    <form action="<?= url('Milling/add_Mill_SaleChallan') ?>" class="ajax-form-submit" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <label class="rdiobox"><input <?=@$challan['item_type'] == 'gray' ? 'checked' : '' ?>
                                        name="item_type" type="radio" value="gray" required>
                                    <span>Gray</span></label>
                                <label class="rdiobox"><input <?=@$challan['item_type'] == 'finish' ? 'checked' : '' ?>
                                        name="item_type" type="radio" value="finish">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    <a data-toggle="modal" href="<?= url('Master/add_item') ?>"
