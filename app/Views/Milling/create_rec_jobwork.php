...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Jobwork Received Sr No :</span>
            <?=@$job['id'] ? @$job['id'] : @$current_id;?></h2>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
                    ...
                    <form action="<?=url('Milling/Add_rec_jobwork')?>" class="ajax-form-submit" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="row col-md-12 form-group">
                                <label class="form-label col-md-3">Jobwork Challan: <span
                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <textarea class="form-control" type="text" name="delivery_add"
                                            placeholder="Enter Delivery Address"
                                            value=""><?=@$job['delivery']?></textarea>
                                    </div>
                                ...
                                <table class="table table-bordered mg-b-0 product" id="product">
                                    <thead>
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <h6>
                                                    <center> Jobwork ISSUE</center>
                                                </h6>
                                            </td>
                                            <td colspan="2">
                                                <h6>
                                                    <center> Jobwork RETURN</center>
                                                </h6>
                                            </td>
                                            <td colspan="2">
                                                <h6>
                                            ...
                                            <th colspan="2">
                                                <h6>
                                                    <center> Jobwork Received</center>
                                                </h6>
                                            </th>
                                        ...
                                        <tr>
                                            ...
                                            <th style="width:70px;">Return PCS</th>
                                            <th style="width:70px;">Return MTR</th>
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        <tr class="<?=$row['pid']?>">
                                            ...
                                            <td><input class="form-control input-sm" value="<?=$row['return_pcs']?>"
                                                    name="return_pcs[]" readonly onchange="calculate()"
                                                    onkeypress="return isDesimalNumberKey(event)" type="text"></td>

                                            <td><input class="form-control input-sm" value="<?=$row['return_meter']?>"
                                                    name="return_meter[]" readonly onchange="calculate()"
                                                    onkeypress="return isDesimalNumberKey(event)" type="text"></td>
                                            ...
                                            <td><input class="form-control input-sm" value="<?=$row['pending']?>"
                                                    name="pending[]" onchange="calculate()"
                                                    onkeypress="return isDesimalNumberKey(event)" type="text"></td>
                                            ...
                                            <td><input class="form-control input-sm" value="<?=$row['remark']?>"
                                                    name="remark[]" onchange="calculate()" type="text">
                                            </td>
                                        </tr>
                                        <?php }
                                    }?>
...
function calculate() {
    ...
    for (var i = 0; i < sendJOB_pcs.length; i++) {
        if (recJOB_pcs[i] != 'undefine' && !isNaN(recJOB_pcs[i])) {
            ...
            if (pending_pcs < 0) {
                $('#save_data').prop('disabled', true);
                $('.error-msg').html('Enter PCS-METER are more than Remaining PCS-METER');
            } else {
                $('#save_data').prop('disabled', false);
                $('.error-msg').html('');
            }
...
$(document).ready(function() {
    ...
    $('#job_challan').on('select2:select', function(e) {
        ...
        var acc = '<option selected value="' + suggesion.job.account + '">' + suggesion.job
            .account_name + '</option>';
        ...
        var warehouse = '<option selected value="' + suggesion.job.warehouse + '">' + suggesion
            .job.warehouse_name + '</option>';
        ...
        for (i = 0; i < item.length; i++) {
            ...
            tds +=
                '<td><select name="type[]" id="type" value="0" onchange="calculate()">' + item[i]
                .uom_opt + '</select></td>';
            ...
            tds +=
                '<td><input class="form-control input-sm" readonly name="return_pcs[]" onchange="calculate()" value="' +
                item[i].return_pcs + '" type="text" ></td>';

            tds +=
                '<td><input class="form-control input-sm" readonly name="return_meter[]" onchange="calculate()" value="' +
                item[i].return_meter + '" type="text" ></td>';
