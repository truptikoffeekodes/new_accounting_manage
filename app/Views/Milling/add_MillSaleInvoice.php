...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Gray/Finish Sale Invoice Sr No :</span>
    ...
    <div class="col-lg-12">
        <div class="card custom-card">
            <div class="card-header card-header-divider">
                <form action="<?= url('Milling/add_Mill_SaleInvoice') ?>" class="ajax-form-submit" method="POST"
                    id="challanform">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <input class="form-control" type="text" readonly name="srno"
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <input class="form-control dateMask" placeholder="DD/MM/YYYY" type="text"
                                    id="challan_date" name="invoice_date"
                                    value="<?= @$challan['date'] ? $date : $today; ?>">
                            </div>

                            <div class="col-md-6 form-group">
                                <label class="form-label">Weaver Challan No: <span
                                        class="tx-danger">*</span></label>
                                <select class="form-control" id="get_challan" name='challan'>
                                    <?php if(@$challan['challan']) { ?>
                                    <option value="<?=@$challan['challan']?>">
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.st == 'success') {
                ...
                window.location = "<?=url('milling/mill_sale_invoice')?>";
            } else {
...
$(document).ready(function() {
    ...
    $("#get_challan").select2({
        ...
        ajax: {
            url: PATH + "Milling/Getdata/get_gray_finish_challan",
            type: "post",
            allowClear: true,
            dataType: 'json',
            delay: 250,
    ...
    $('#get_challan').on('select2:select', function(e) {
        ...
        for (i = 0; i < item.length; i++) {
            ...
            tds +=
                '<td><input class="form-control input-sm"  name="subtotal[]"  value="" required="" type="text" readonly></td>';
