                ...
                <div class="card-body">
                    <form action="<?= url('Milling/Add_returnMill') ?>" class="ajax-form-submit" method="POST"
                        ...
                        <div class="row">
                            ...
                            <input class="form-control col-md-9" type="hidden" name="srno" id="srno"
                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label class="form-label">Mill Party A/C: <span
                                                class="tx-danger">*</span></label>
                                    </div>
                                    <div class="col-md-8 form-group">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label class="form-label">Shiped to: </label>
                                    </div>
                                    <div class="col-md-8 form-group">
                                        <div class="input-group" style="width:auto;">
                                        ...
                                        <tr class="<?=$row['pid']?> item_row">
                                            ...
                                            <td><input class="form-control input-sm" value="<?=$row['ret_taka']?>"
                                                    ...
                                                    data-target="#fm_model" data-title="Edit Taka" class="modal-lg"><i
                                                        class="far fa-edit"></i></a><b class="pcs_uom"></b></td>
                                            <td>
...
$(document).ready(function() {
    ...
    $('#get_invoice').on('select2:select', function(e) {
        ...
        for (i = 0; i < item.length; i++) {
            ...
            tds +=
                '<td><input class="form-control input-sm" type="text" value=""  onkeypress="return isDesimalNumberKey(event)"  name="ret_meter[]" required><b class="other_uom"></b></td>';
