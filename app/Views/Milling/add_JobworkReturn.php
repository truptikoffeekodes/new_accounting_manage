...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Jobwork Return Sr No :</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label class="form-label">Jobwork / Party Name: <span
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        <tr class="<?=$row['pid']?>">
                                            ...
                                            <td><input class="form-control input-sm" value="<?=$row['ret_taka']?>"
                                                    name="ret_taka[]" required onchange="calculate()"
...
$(document).ready(function() {
    ...
    $('#job_challan').on('select2:select', function(e) {
        ...
        for (i = 0; i < item.length; i++) {
            ...
            tds +=
                '<td><input class="form-control input-sm" id="taka" value="" name="ret_taka[]" required onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" type="text"></td>';
