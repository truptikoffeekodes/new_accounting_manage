...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a href="<?= url('Milling/add_millSend') ?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i>
            Add New</a>
    </div>
</div>
<!-- End Page Header -->
            ...
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover voucher table-fw-widget" id="table_list_data"
                            data-id="mill_challan" data-module="Milling" data-filter_data=''>
                            <thead>
                                <tr>
