...
<div class="page-header">
    ...
    <div class="ml-auto pd-r-100">
        <h2 class="mb-1 font-weight-bold"><span>Gray/Finish Sale Return Sr No :</span>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <input class="form-control" type="text" name="srno" readonly
                                    value="<?= isset($challan['sr_no']) ? @$challan['sr_no'] : $current_id; ?>">
                            </div>
                            ...
                            <div class="col-lg-4 form-group">
                                ...
                                <input class="form-control dateMask" placeholder="DD/MM/YYYY" type="text" name="date"
                            ...
                            <div class="col-md-7 form-group">
                                ...
                                <select class="form-control" id="get_invoice" name='invoice_no'>
                                ...
                                <table class="table table-bordered mg-b-0 product" id="product">
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        <tr class="<?=$row['pid']?> item_row">
                                            ...
                                            <input type="hidden" name="ret_takaTb_ids[]"
                                                value="<?=@$row['saleTakatbID']?>">
                                            ...
                                            <td><input class="form-control input-sm" readonly
                                                    value="<?=@$row['meter']?>" name="meter[]" onchange="calculate()"
                                                    onkeypress="return isDesimalNumberKey(event)" required=""
                                                    type="text">
                                            </td>
...
$(document).ready(function() {
    ...
    $('#get_invoice').on('select2:select', function(e) {
        ...
        for (i = 0; i < item.length; i++) {
            ...
            tds +=
                '<td><input class="form-control input-sm" type="text" value=""onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" id="meter" name="ret_taka[]" required ><a data-toggle="modal" type="button" id="add_taka" href="<?=url('Milling/Add_MillSaleReturntaka/')?>' +
                suggesion.challan.challan + '/' + item[i].id +
                '" data-target="#fm_model" data-title="Add Taka" class=""><i class="far fa-edit"></i></a><b class="pcs_uom"></b></td>';

            tds +=
                '<td><input class="form-control input-sm" type="text" value=""onchange="calculate()" onkeypress="return isDesimalNumberKey(event)" id="meter" name="ret_meter[]" required ><b class="other_uom"></b></td>';
