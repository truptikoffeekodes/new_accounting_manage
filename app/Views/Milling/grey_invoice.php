...
<div class="page-header">
    ...
    <div class="btn btn-list">Sale Item Invoice
        <a href="<?= url('Milling/Add_grey') ?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i>
            Add New</a>
    </div>
</div>
<!-- End Page Header -->
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget voucher" id="table_list_data"
                            data-id="grey_invoice" data-module="Milling" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>SR No</th>
                                    <th>Weaver Challan_no</th>
                                    <th>Weaver Invoice NO</th>
                                    <th>Invoice Date</th>
                                    <th>Purchase Type</th>
                                    <th>Weaver Party Account</th>
                                    <th>Item Name</th>
                                    <th>Total Taka</th>
                                    <th>Total Meter</th>
                                    <th>Rate</th>
