...
<div class="page-header">
    ...
    <div class="btn btn-list">
        <a href="<?= url('Milling/add_rec_mill') ?>" class="btn ripple btn-primary"><i class="fe fe-external-link"></i>
            Add New</a>
    </div>
</div>
<!-- End Page Header -->
            ...
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget mill_rec" id="table_list_data"
                            data-id="mill_rec" data-module="Milling" data-filter_data=''>
                            <thead>
                                <tr>
                                    <th>SR No</th>
                                    <th>Mill Issue SR No</th>
